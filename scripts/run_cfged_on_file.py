...
if __name__ == "__main__":
    ...
    for decompiler in args.decs:
        ...
        if args.save_png:
            save_cfg_as_png(func_cfg, dec_dir_path / f"{decompiler}_{basename}_{function}.png")
