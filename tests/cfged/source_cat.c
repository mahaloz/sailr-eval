...
extern int _gl_cxxalias_dummy
                                                              ...
                                                              ;
extern int _gl_cxxalias_dummy;
extern int rpl_vprintf (const char *
__restrict__ 
format, va_list args) 
__attribute__ ((__format__ 
(__gnu_printf__, 1, 0)
  ...
  while (
            ...
            )
    {
      ...
      if (full_write (
       ...
       1
       , "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), dcgettext (((void *)0), \"write error\", 5)), assume (false))" ")"); int _gl_dummy; })) ? ((error (
       1
       , 
       (*__errno_location ())
       , 
...
main (int argc, char **argv)
{
 ...
 _Bool 
  ...
  if (fstat (
    ...
    ((!!sizeof (struct { _Static_assert (
   1
   , "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), dcgettext (((void *)0), \"standard output\", 5)), assume (false))" ")"); int _gl_dummy; })) ? ((error (
   1
   , 
   (*__errno_location ())
   , 
 ...
 _Bool 
  ...
  if (have_read_stdin && close (
    ...
    ((!!sizeof (struct { _Static_assert (
   1
   , "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), dcgettext (((void *)0), \"closing standard input\", 5)), assume (false))" ")"); int _gl_dummy; })) ? ((error (
   1
   , 
   (*__errno_location ())
   , 
