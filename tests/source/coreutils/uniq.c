...
enum countmode { count_occurrences, count_none };
...
static char const *const delimit_method_string[] = {"none", "prepend",
                                                    "separate", ((void *)0)

};

static enum delimit_method const delimit_method_map[] = {DM_NONE, DM_PREPEND,
                                                         DM_SEPARATE};
...
void usage(int status) {
  if (status != 0)
    ...
    printf(dcgettext(((void *)0), "Usage: %s [OPTION]... [INPUT [OUTPUT]]\n", 5)
    ...
    fputs_unlocked(
        ...
        ;
    fputs_unlocked(dcgettext(((void *)0),
                             "  -w, --check-chars=N   compare no more than N "
                             "characters in lines\n",
                             5),
                   stdout)
  ...
  default:
    ((!!sizeof(struct {
      _Static_assert(1, "verify_expr ("
                        "1"
                        ", "
                        "(error (1, 0, \"%s: %s\", opt, dcgettext (((void "
                        "*)0), msgid, 5)), assume (false))"
                        ")");
      int _gl_dummy;
    }))
         ? ((error(1, 0, "%s: %s", opt, dcgettext(((void *)0), msgid, 5)),
...
__attribute__((__pure__)) static char *
...
static void writeline(struct linebuffer const *line,
...
static void check_file(char const *infile, char const *outfile,
  ...
  if (output_unique && output_first_repeated && countmode == count_none) {
    ...
    while (!feof_unlocked(stdin)) {
      ...
      new_group =
          (!prevfield || different(thisfield, prevfield, thislen, prevlen));
      ...
      if (new_group || grouping != GM_NONE) {
        fwrite_unlocked(thisline->buffer, sizeof(char), thisline->length,
                        stdout);
        ...
        if (count_occurrences)
          ((!!sizeof(struct {
            _Static_assert(1, "verify_expr ("
                              "1"
                              ", "
                              "(error (1, 0, dcgettext (((void *)0), \"too "
                              "many repeated lines\", 5)), assume (false))"
                              ")");
            int _gl_dummy;
          }))
               ? ((error(1, 0,
                         dcgettext(((void *)0), "too many repeated lines", 5)),
                   ((0) ? (void)0 : __builtin_unreachable())))
               : ((error(1, 0,
                         dcgettext(((void *)0), "too many repeated lines", 5)),
                   ((0) ? (void)0 : __builtin_unreachable()))));
      ...
      if (delimit_groups != DM_NONE) {
        if (!match) {
          ...
          if ((delimit_groups == DM_PREPEND) ||
              (delimit_groups == DM_SEPARATE && !first_delimiter))
            putchar_unlocked(delimiter);
        }
      }
...
enum Skip_field_option_type { SFO_NONE, SFO_OBSOLETE, SFO_NEW };
...
int main(int argc, char **argv) {
  ...
  while (1) {
    ...
    if (optc == -1 || (posixly_correct && nfiles != 0) ||
        ((optc = getopt_long(argc, argv, "-0123456789Dcdf:is:uw:z", longopts,
                             ((void *)0))) == -1)) {
      if (argc <= optind)
        break;
      if (nfiles == 2) {
      ...
      case '9': {
        ...
        if (!((void)(&(skip_fields) == (size_t *)((void *)0)),
              ((!!sizeof(struct {
                _Static_assert(!(!((size_t)0 < (size_t)-1)),
                               "verify_expr ("
                               "! TYPE_SIGNED (size_t)"
                               ", "
                               "(((size_t) -1 / 10 < (skip_fields) || (size_t) "
                               "((skip_fields) * 10 + (optc - '0')) < "
                               "(skip_fields)) ? false : (((skip_fields) = "
                               "(skip_fields) * 10 + (optc - '0')), true))"
                               ")");
                int _gl_dummy;
              }))
                   ? ((((size_t)-1 / 10 < (skip_fields) ||
                        (size_t)((skip_fields)*10 + (optc - '0')) <
                            (skip_fields))
                           ? 0
      ...
      case 'D':
        ...
        if (optarg == ((void *)0))
          ...
          delimit_groups = ((delimit_method_map)[__xargmatch_internal(
              "--all-repeated", optarg, delimit_method_string,
              (void const *)(delimit_method_map), sizeof *(delimit_method_map),
              argmatch_die, 1)])
      ...
      case GROUP_OPTION:
        if (optarg == ((void *)0))
          ...
          grouping = ((grouping_method_map)[__xargmatch_internal(
              "--group", optarg, grouping_method_string,
              (void const *)(grouping_method_map),
              sizeof *(grouping_method_map), argmatch_die, 1)])
  ...
  if (grouping != GM_NONE && output_option_used) {
    error(0, 0,
          dcgettext(((void *)0),
                    "--group is mutually exclusive with -c/-d/-D/-u", 5));
    usage(1);
  }
  ...
  if (grouping != GM_NONE && countmode != count_none) {
    error(0, 0,
          ...
          dcgettext(((void *)0),
                    "grouping and printing repeat counts is meaningless", 5));
    usage(1);
  }
