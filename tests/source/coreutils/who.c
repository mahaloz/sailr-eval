...
static char const *idle_string(time_t when, time_t boottime) {
  ...
  if (boottime < when && now - 24 * 60 * 60 < when && when <= now) {
    ...
    if (seconds_idle < 60)
      ...
      ((void)sizeof((seconds_idle / (60 * 60) < 24) ? 1 : 0), __extension__({
         if (seconds_idle / (60 * 60) < 24)
           ;
         else
           __assert_fail("seconds_idle / (60 * 60) < 24", "src/who.c", 205,
                         __extension__ __PRETTY_FUNCTION__);
       }));
      sprintf(idle_hhmm, "%02d:%02d", seconds_idle / (60 * 60),
              (seconds_idle % (60 * 60)) / 60);
      return idle_hhmm;
    }
  }

  return dcgettext(((void *)0), " old ", 5);
}
...
static void print_user(const STRUCT_UTMP *utmp_ent, time_t boottime) {
  struct stat stats;
  time_t last_change;
  char mesg;
  char idlestr[6 + 1];
  ...
  print_line(sizeof((utmp_ent)->ut_user), ((utmp_ent)->ut_user), mesg,
             sizeof utmp_ent->ut_line, utmp_ent->ut_line, time_string(utmp_ent),
             idlestr, pidstr, hoststr ? hoststr : "", "");
}

static void print_boottime(const STRUCT_UTMP *utmp_ent) {
  print_line(-1, "", ' ', -1, dcgettext(((void *)0), "system boot", 5),
...
static char *make_id_equals_comment(STRUCT_UTMP const *utmp_ent) {
  ...
  char *comment =
      xmalloc(strlen(dcgettext(((void *)0), "id=", 5)) + utmpsize + 1);

  char *p = stpcpy(comment, dcgettext(((void *)0), "id=", 5));
...
static void print_deadprocs(const STRUCT_UTMP *utmp_ent) {
  ...
  if (!exitstr)
    exitstr =
        xmalloc(strlen(dcgettext(((void *)0), "term=", 5)) +
                (((((sizeof(((utmp_ent)->ut_exit.e_termination)) * 8) -
                    (!((__typeof__(((utmp_ent)->ut_exit.e_termination)))0 <
                       (__typeof__(((utmp_ent)->ut_exit.e_termination)))-1))) *
                       146 +
                   484) /
                  485) +
                 (!((__typeof__(((utmp_ent)->ut_exit.e_termination)))0 <
                    (__typeof__(((utmp_ent)->ut_exit.e_termination)))-1))) +
                1 + strlen(dcgettext(((void *)0), "exit=", 5)) +
                (((((sizeof(((utmp_ent)->ut_exit.e_exit)) * 8) -
                    (!((__typeof__(((utmp_ent)->ut_exit.e_exit)))0 <
                       (__typeof__(((utmp_ent)->ut_exit.e_exit)))-1))) *
                       146 +
                   484) /
                  485) +
                 (!((__typeof__(((utmp_ent)->ut_exit.e_exit)))0 <
                    (__typeof__(((utmp_ent)->ut_exit.e_exit)))-1))) +
                1);
  sprintf(exitstr, "%s%d %s%d", dcgettext(((void *)0), "term=", 5),
          ((utmp_ent)->ut_exit.e_termination),

          dcgettext(((void *)0), "exit=", 5), ((utmp_ent)->ut_exit.e_exit));
...
static void print_login(const STRUCT_UTMP *utmp_ent) {
  ...
  print_line(-1, dcgettext(((void *)0), "LOGIN", 5), ' ',
             sizeof utmp_ent->ut_line, utmp_ent->ut_line, time_string(utmp_ent),
             "", pidstr, comment, "");
  free(comment);
}
...
static void print_clockchange(const STRUCT_UTMP *utmp_ent) {
  ...
  print_line(-1, "", ' ', -1, dcgettext(((void *)0), "clock change", 5),
             time_string(utmp_ent), "", "", "", "");
}
...
static void print_runlevel(const STRUCT_UTMP *utmp_ent) {
  ...
  if (!runlevline)
    runlevline = xmalloc(strlen(dcgettext(((void *)0), "run-level", 5)) + 3);
  sprintf(runlevline, "%s %c", dcgettext(((void *)0), "run-level", 5), curr);

  if (!comment)
    comment = xmalloc(strlen(dcgettext(((void *)0), "last=", 5)) + 2);
  sprintf(comment, "%s%c", dcgettext(((void *)0), "last=", 5),
          (last == 'N') ? 'S' : last);
...
static void print_heading(void) {
  print_line(
      -1, dcgettext(((void *)0), "NAME", 5), ' ', -1,
      dcgettext(((void *)0), "LINE", 5), dcgettext(((void *)0), "TIME", 5),
      dcgettext(((void *)0), "IDLE", 5),

      dcgettext(((void *)0), "PID", 5), dcgettext(((void *)0), "COMMENT", 5),
      dcgettext(((void *)0), "EXIT", 5));
}

static void scan_entries(size_t n, const STRUCT_UTMP *utmp_buf) {
  char *ttyname_b = ((void *)0);
...
int main(int argc, char **argv) {
  ...
  while ((optc = getopt_long(argc, argv, "abdlmpqrstuwHT", longopts,
                             ((void *)0))) != -1) {
    switch (optc) {
    case 'a':
      need_boottime = 1;
    ...
    case GETOPT_VERSION_CHAR:
      version_etc(stdout, "who", "GNU coreutils", Version, ("Joseph Arceneaux"),
                  ("David MacKenzie"), ("Michael Stone"), (char *)((void *)0));
      exit(0);
      break;
      ;
