...
_Bool make_dir_parents(char *dir, struct savewd *wd,
                       int (*make_ancestor)(char const *, char const *, void *),
                       void *options, mode_t mode,
                       void (*announce)(char const *, void *), mode_t mode_bits,
                       uid_t owner, gid_t group,

                       _Bool preserve_existing);

struct mode_change *mode_compile(const char *) __attribute__((__malloc__))
__attribute__((__malloc__(free, 1)));
struct mode_change *mode_create_from_ref(const char *)
    __attribute__((__malloc__)) __attribute__((__malloc__(free, 1)));
mode_t mode_adjust(mode_t, _Bool, mode_t, struct mode_change const *, mode_t *);
...
inline void savewd_init(struct savewd *wd) { wd->state = INITIAL_STATE; }
...
inline int __attribute__((__pure__)) savewd_errno(struct savewd const *wd) {
...
static mode_t mode = ((0400 | 0200 | 0100) | (0400 >> 3) | (0100 >> 3) |
                      ((0400 >> 3) >> 3) | ((0100 >> 3) >> 3));

static mode_t dir_mode = ((0400 | 0200 | 0100) | (0400 >> 3) | (0100 >> 3) |
                          ((0400 >> 3) >> 3) | ((0100 >> 3) >> 3));

static mode_t dir_mode_bits =
...
enum { PRESERVE_CONTEXT_OPTION = 0x7f + 1, STRIP_PROGRAM_OPTION };
...
extra_mode(mode_t input) {
  mode_t mask = ((0400 | 0200 | 0100) | ((0400 | 0200 | 0100) >> 3) |
                 (((0400 | 0200 | 0100) >> 3) >> 3)) |
                0170000;
  return !!(input & ~mask);
}
...
need_copy(char const *src_name, char const *dest_name, int dest_dirfd,
          char const *dest_relname, const struct cp_options *x) {
  ...
  if (fstatat(dest_dirfd, dest_relname, &dest_sb, 0x100) != 0)
    return 1;

  if (!((((src_sb.st_mode)) & 0170000) == (0100000)) ||
  ...
  if (src_sb.st_size != dest_sb.st_size ||
      (dest_sb.st_mode & (04000 | 02000 | 01000 | (0400 | 0200 | 0100) |
                          ((0400 | 0200 | 0100) >> 3) |
                          (((0400 | 0200 | 0100) >> 3) >> 3))) != mode)
    return 1;
  ...
  if (selinux_enabled && x->preserve_security_context) {
    ...
    if (rpl_getfilecon(src_name, &file_scontext) == -1)
      return 1;

    if (rpl_getfilecon(dest_name, &to_scontext) == -1) {
  ...
  dest_fd = openat(dest_dirfd, dest_relname, 00 | 0);
  if (dest_fd < 0) {
    close(src_fd);
    return 1;
  }
...
static struct selabel_handle *get_labeling_handle(void) {
  static _Bool initialized;
  static struct selabel_handle *hnd;
  if (!initialized) {
    initialized = 1;
    hnd = selabel_open(0, ((void *)0), 0);
    if (!hnd)
      error(0, (*__errno_location()),
            dcgettext(((void *)0), "warning: security labeling handle failed",
                      5));
  }
  return hnd;
}

static void setdefaultfilecon(char const *file) {
  struct stat st;
  ...
  if (selabel_lookup(hnd, &scontext, file, st.st_mode) != 0) {
    if ((*__errno_location()) != 2 && !ignorable_ctx_err((*__errno_location())))
      error(0, (*__errno_location()),
            dcgettext(((void *)0), "warning: %s: context lookup failed", 5),
            quotearg_n_style_colon(0, shell_escape_quoting_style, file));
    return;
  }

  if (lsetfilecon(file, scontext) < 0 && (*__errno_location()) != 95)
    error(0, (*__errno_location()),

          dcgettext(((void *)0), "warning: %s: failed to change context to %s",
                    5),
          quotearg_n_style_colon(0, shell_escape_quoting_style, file),
          quote_n(1, scontext));
...
static void announce_mkdir(char const *dir, void *options) {
  ...
  if (x->verbose)
    prog_fprintf(stdout, dcgettext(((void *)0), "creating directory %s", 5),
...
static int make_ancestor(char const *dir, char const *component,
  ...
  if (x->set_security_context &&
      defaultcon(x->set_security_context, component, 0040000) < 0 &&
      !ignorable_ctx_err((*__errno_location())))
    error(0, (*__errno_location()),
          dcgettext(((void *)0),
                    "failed to set default creation context for %s", 5),
          quotearg_style(shell_escape_always_quoting_style, dir));

  int r = mkdir(component, ((0400 | 0200 | 0100) | (0400 >> 3) | (0100 >> 3) |
                            ((0400 >> 3) >> 3) | ((0100 >> 3) >> 3)));
  if (r == 0)
...
static int process_dir(char *dir, struct savewd *wd, void *options) {
  ...
  if (ret == 0 && x->set_security_context) {
    if (!restorecon(x->set_security_context, last_component(dir), 0) &&
        !ignorable_ctx_err((*__errno_location())))
      error(0, (*__errno_location()),
            dcgettext(((void *)0), "failed to restore context for %s", 5),
            quotearg_style(shell_escape_always_quoting_style, dir));
  }
...
copy_file(char const *from, char const *to, int to_dirfd,
  ...
  return copy(from, to, to_dirfd, to_relname, 0, x, &copy_into_self,
              ((void *)0));
}
...
change_attributes(char const *name, int dirfd, char const *relname) {
  ...
  if (!(owner_id == (uid_t)-1 && group_id == (gid_t)-1) &&
    ...
    error(0, (*__errno_location()),
          dcgettext(((void *)0), "cannot change ownership of %s", 5),
          quotearg_style(shell_escape_always_quoting_style, name));
  else if (chmodat(dirfd, relname, mode) != 0)
    error(0, (*__errno_location()),
          dcgettext(((void *)0), "cannot change permissions of %s", 5),
          quotearg_style(shell_escape_always_quoting_style, name));
  else
    ok = 1;
...
change_timestamps(struct stat const *src_sb, char const *dest, int dirfd,
  ...
  if (utimensat(dirfd, relname, timespec, 0)) {
    error(0, (*__errno_location()),
          dcgettext(((void *)0), "cannot set timestamps for %s", 5),
...
strip(char const *name) {
  ...
  case 0:
    ...
    ((!!sizeof(struct {
      _Static_assert(
          ...
          "1"
          ", "
          "(error (1, (*__errno_location ()), dcgettext (((void *)0), \"cannot "
          "run %s\", 5), quotearg_style (shell_escape_always_quoting_style, "
          "strip_program)), assume (false))"
          ")");
      int _gl_dummy;
    }))
         ? ((error(1, (*__errno_location()),
                   dcgettext(((void *)0), "cannot run %s", 5),
  ...
  default:
    if (waitpid(pid, &status, 0) < 0)
      error(0, (*__errno_location()),
            dcgettext(((void *)0), "waiting for strip", 5));
    else if (!(((status)&0x7f) == 0) || (((status)&0xff00) >> 8))
      error(0, 0,
            dcgettext(((void *)0), "strip process terminated abnormally", 5));
    else
      ok = 1;
    break;
  }
      ...
      if (xstrtoumax(owner_name, ((void *)0), 0, &tmp, "") != LONGINT_OK ||
        ...
        ((!!sizeof(struct {
          _Static_assert(1,
                         ...
                         "1"
                         ", "
                         "(error (1, 0, dcgettext (((void *)0), \"invalid user "
                         "%s\", 5), quote (owner_name)), assume (false))"
                         ")");
          int _gl_dummy;
        }))
             ? ((error(1, 0, dcgettext(((void *)0), "invalid user %s", 5),
                       quote(owner_name)),
                 ((0) ? (void)0 : __builtin_unreachable())))
             : ((error(1, 0, dcgettext(((void *)0), "invalid user %s", 5),
                       quote(owner_name)),
      ...
      if (xstrtoumax(group_name, ((void *)0), 0, &tmp, "") != LONGINT_OK ||
        ...
        ((!!sizeof(struct {
          _Static_assert(1,
                         ...
                         "group %s\", 5), quote (group_name)), assume (false))"
                         ")");
          int _gl_dummy;
        }))
             ? ((error(1, 0, dcgettext(((void *)0), "invalid group %s", 5),
                       quote(group_name)),
                 ((0) ? (void)0 : __builtin_unreachable())))
             : ((error(1, 0, dcgettext(((void *)0), "invalid group %s", 5),
                       quote(group_name)),
  ...
  if (status != 0)
    ...
    fputs_unlocked(
        dcgettext(
            ...
            "--compare       compare content of source and destination files, "
            "and\n                        if no change to content, ownership, "
            "and permissions,\n                        do not modify the "
            "destination at all\n  -d, --directory     treat all arguments as "
    ...
    fputs_unlocked(
        dcgettext(
            ...
            "--target-directory=DIRECTORY  copy all SOURCE arguments into "
            "DIRECTORY\n  -T, --no-target-directory  treat DEST as a normal "
            "file\n  -v, --verbose       print the name of each directory as "
            "it is created\n",
            5),
        stdout);
    fputs_unlocked(
        dcgettext(
            ...
            "directory to default type\n      --context[=CTX]     like -Z, or "
            "if CTX is specified then set the\n                            "
...
install_file_in_file(char const *from, char const *to, int to_dirfd,
  ...
  if (x->preserve_timestamps && stat(from, &from_sb) != 0) {
    error(0, (*__errno_location()), dcgettext(((void *)0), "cannot stat %s", 5),
        ...
        ((!!sizeof(struct {
          _Static_assert(
              1, "verify_expr ("
                 ...
                 "\"cannot unlink %s\", 5), quotearg_style "
                 "(shell_escape_always_quoting_style, to)), assume (false))"
                 ")");
          int _gl_dummy;
        }))
             ? ((error(1, (*__errno_location()),
                       dcgettext(((void *)0), "cannot unlink %s", 5),
...
install_file_in_file_parents(char const *from, char *to,
  ...
  return (mkancesdirs_safe_wd(from, to, (struct cp_options *)x, 0) &&
          install_file_in_file(from, to, -100, to, x));
}
...
install_file_in_dir(char const *from, char const *to_dir,
  ...
  if (!target_dirfd_valid(*target_dirfd) && (ret = mkdir_and_install) &&
      (ret = mkancesdirs_safe_wd(from, to, (struct cp_options *)x, 1))) {
    int fd = open(to_dir, O_PATHSEARCH | 0200000);
    if (fd < 0) {
      error(0, (*__errno_location()),
            dcgettext(((void *)0), "cannot open %s", 5),
            quotearg_style(shell_escape_always_quoting_style, to));
      ret = 0;
    } else
      *target_dirfd = fd;
...
int main(int argc, char **argv) {
  ...
  while ((optc = getopt_long(argc, argv, "bcCsDdg:m:o:pt:TvS:Z", long_options,
    ...
    case GETOPT_VERSION_CHAR:
      version_etc(stdout, "install", "GNU coreutils", Version,
    ...
    ((!!sizeof(struct {
      _Static_assert(
          1, "verify_expr ("
             "1"
             ", "
             "(error (1, 0, dcgettext (((void *)0), \"the strip option may not "
             "be used when installing a directory\", 5)), assume (false))"
             ")");
      int _gl_dummy;
    }))
         ? ((error(1, 0,
                   dcgettext(((void *)0),
                             "the strip option may not be used when installing "
                             "a directory",
                             5)),
             ((0) ? (void)0 : __builtin_unreachable())))
         : ((error(1, 0,
    ...
    ((!!sizeof(struct {
      _Static_assert(
          1, "verify_expr ("
             "1"
             ", "
             "(error (1, 0, dcgettext (((void *)0), \"target directory not "
             "allowed when installing a directory\", 5)), assume (false))"
             ")");
      int _gl_dummy;
    }))
         ? ((error(
  ...
  if (no_target_directory) {
    ...
    if (!(target_dirfd_valid(target_dirfd) ||
          (mkdir_and_install && (*__errno_location()) == 2)))
      ((!!sizeof(struct {
        _Static_assert(1, "verify_expr ("
                          "1"
                          ", "
                          "(error (1, (*__errno_location ()), dcgettext "
                          "(((void *)0), \"failed to access %s\", 5), "
                          "quotearg_style (shell_escape_always_quoting_style, "
        ...
        int _gl_dummy;
           ...
           ? ((error(1, (*__errno_location()),
                     dcgettext(((void *)0), "failed to access %s", 5),
                     quotearg_style(shell_escape_always_quoting_style,
                                    target_directory)),
               ((0) ? (void)0 : __builtin_unreachable())))
           : ((error(1, (*__errno_location()),
      ...
      ((!!sizeof(struct {
        _Static_assert(
            1, "verify_expr ("
               ...
               ", "
               "(error (1, (*__errno_location ()), dcgettext (((void *)0), "
               "\"target %s\", 5), quotearg_style "
               "(shell_escape_always_quoting_style, lastfile)), assume (false))"
               ")");
        int _gl_dummy;
      }))
           ? ((error(
                   1, (*__errno_location()),
                   dcgettext(((void *)0), "target %s", 5),
    ...
    if (!change)
      ((!!sizeof(struct {
        _Static_assert(1,
                       ...
                       "1"
                       ", "
                       "(error (1, 0, dcgettext (((void *)0), \"invalid mode "
                       "%s\", 5), quote (specified_mode)), assume (false))"
                       ")");
        int _gl_dummy;
      }))
           ? ((error(1, 0, dcgettext(((void *)0), "invalid mode %s", 5),
  ...
  if (dir_arg)
    ...
    if (!target_directory) {
      if (!(mkdir_and_install
                ...
                : install_file_in_file(file[0], file[1], -100, file[1], &x)))
        exit_status = 1;
    } else {
      int i;
      dest_info_init(&x);
      for (i = 0; i < n_files; i++)
        if (!install_file_in_dir(file[i], target_directory, &x,
                                 i == 0 && mkdir_and_install, &target_dirfd))
          exit_status = 1;
    }
  }
