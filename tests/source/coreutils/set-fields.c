...
static void add_range_pair(uintmax_t lo, uintmax_t hi) {
  if (n_frp == n_frp_allocated)
    frp = ((!!sizeof(struct {
      _Static_assert(sizeof *(frp) != 1,
                     "verify_expr ("
                     "sizeof *(frp) != 1"
                     ", "
                     "x2nrealloc (frp, &n_frp_allocated, sizeof *(frp))"
                     ")");
      int _gl_dummy;
    }))
               ? (x2nrealloc(frp, &n_frp_allocated, sizeof *(frp)))
  ...
  while (1) {
    if (*fieldstr == '-') {
      ...
      if (dash_found)
        do {
          error(0, 0,
                ((options & SETFLD_ERRMSG_USE_POS)
                     ? dcgettext(((void *)0), "invalid byte or character range",
                                 5)
                     : dcgettext(((void *)0), "invalid field range", 5)));
          usage(1);
        } while (0)
          ...
          error(
              ...
              ((options & SETFLD_ERRMSG_USE_POS)
                   ? dcgettext(((void *)0),
                               ...
                               5)
                   : dcgettext(((void *)0), "fields are numbered from 1", 5)));
          usage(1);
        } while (0)
      ...
      value = 0;
               ...
               ((*__ctype_b_loc())[(int)((to_uchar(*fieldstr)))] &
      ...
      if (dash_found) {
        ...
        if (!lhs_specified && !rhs_specified) {
          ...
          if (options & SETFLD_ALLOW_DASH)
            ...
            do {
              error(0, 0,
                    (dcgettext(((void *)0), "invalid range with no endpoint: -",
                               5)));
              usage(1);
            } while (0);
        }
        ...
        if (!rhs_specified) {
          ...
          if (value < initial)
            do {
              error(0, 0,
                    (dcgettext(((void *)0), "invalid decreasing range", 5)));
              usage(1);
            } while (0);
          ...
          do {
            error(0, 0,
                  ((options & SETFLD_ERRMSG_USE_POS)
                       ? dcgettext(
                             ((void *)0),
                             "byte/character positions are numbered from 1", 5)
                       : dcgettext(((void *)0), "fields are numbered from 1",
                                   5)));
            usage(1);
          } while (0)
      ...
      if (!((void)(&(value) == (uintmax_t *)((void *)0)),
            ((!!sizeof(struct {
              _Static_assert(
                  ...
                  ", "
                  "(((uintmax_t) -1 / 10 < (value) || (uintmax_t) ((value) * "
                  "10 + (*fieldstr - '0')) < (value)) ? false : (((value) = "
                  "(value) * 10 + (*fieldstr - '0')), true))"
                  ")");
              int _gl_dummy;
            }))
                 ? ((((uintmax_t)-1 / 10 < (value) ||
                      (uintmax_t)((value)*10 + (*fieldstr - '0')) < (value))
                         ? 0
                         : (((value) = (value)*10 + (*fieldstr - '0')), 1)))
                 : ((((uintmax_t)-1 / 10 < (value) ||
                      (uintmax_t)((value)*10 + (*fieldstr - '0')) < (value))
                         ? 0
                         : (((value) = (value)*10 + (*fieldstr - '0')),
                            1))))) ||
        ...
        error(0, 0,
              (options & SETFLD_ERRMSG_USE_POS)
                  ? dcgettext(((void *)0),
                              "byte/character offset %s is too large", 5)

                  : dcgettext(((void *)0), "field number %s is too large", 5),
              quote(bad_num));
        free(bad_num);
        usage(1);
      }
      ...
      error(
          0, 0,
          (options & SETFLD_ERRMSG_USE_POS)
              ? dcgettext(((void *)0), "invalid byte/character position %s", 5)

              : dcgettext(((void *)0), "invalid field value %s", 5),
          quote(fieldstr));
      usage(1);
    }
  }
  ...
  if (!n_frp)
    do {
      error(0, 0,
            ((options & SETFLD_ERRMSG_USE_POS)
                 ? dcgettext(((void *)0),
                             "missing list of byte/character positions", 5)
                 : dcgettext(((void *)0), "missing list of fields", 5)));
      usage(1);
    } while (0)
