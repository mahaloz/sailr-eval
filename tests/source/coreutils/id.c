...
_Bool print_group_list(char const *, uid_t, gid_t, gid_t, _Bool, char);
  ...
  if (status != 0)
    ...
    fputs_unlocked(
        dcgettext(
            ...
            " print all group IDs\n  -n, --name     print a name instead of a "
            "number, for -ugG\n  -r, --real     print the real ID instead of "
            "the effective ID, with -ugG\n  -u, --user     print only the "
            "effective user ID\n  -z, --zero     delimit entries with NUL "
        ...
        ((!!sizeof(struct {
          _Static_assert(
              1, "verify_expr ("
                 "1"
                 ", "
                 "(error (1, 0, dcgettext (((void *)0), \"--context (-Z) works "
                 "only on an SELinux-enabled kernel\", 5)), assume (false))"
                 ")");
          int _gl_dummy;
        }))
             ? ((error(1, 0,
                       dcgettext(((void *)0),
                                 "--context (-Z) works only on an "
    ...
    ((!!sizeof(struct {
      _Static_assert(
          1, "verify_expr ("
             "1"
             ", "
             "(error (1, 0, dcgettext (((void *)0), \"cannot print security "
             "context when user specified\", 5)), assume (false))"
             ")");
      int _gl_dummy;
    }))
         ? ((error(1, 0,
                   dcgettext(
                       ((void *)0),
                       "cannot print security context when user specified", 5)),
             ((0) ? (void)0 : __builtin_unreachable())))
         : ((error(1, 0,
                   dcgettext(
                       ((void *)0),
    ...
    ((!!sizeof(struct {
      _Static_assert(
          1, "verify_expr ("
             "1"
             ", "
             "(error (1, 0, dcgettext (((void *)0), \"cannot print "
             "\\\"only\\\" of more than one choice\", 5)), assume (false))"
             ")");
      int _gl_dummy;
    }))
         ? ((error(1, 0,
    ...
    ((!!sizeof(struct {
      _Static_assert(
          1, "verify_expr ("
             "1"
             ", "
             "(error (1, 0, dcgettext (((void *)0), \"cannot print only names "
             "or real IDs in default format\", 5)), assume (false))"
             ")");
      int _gl_dummy;
    }))
         ? ((error(1, 0,
  ...
  if (default_format && opt_zero)
    ((!!sizeof(struct {
      _Static_assert(1,
                     ...
                     "1"
                     ", "
                     "(error (1, 0, dcgettext (((void *)0), \"option --zero "
                     "not permitted in default format\", 5)), assume (false))"
                     ")");
      int _gl_dummy;
    }))
         ? ((error(1, 0,
    ...
    if ((selinux_enabled && getcon(&context) && just_context) ||
      ...
      ((!!sizeof(struct {
        _Static_assert(1, "verify_expr ("
                          "1"
                          ", "
                          "(error (1, 0, dcgettext (((void *)0), \"can't get "
                          "process context\", 5)), assume (false))"
                          ")");
        int _gl_dummy;
      }))
           ? ((error(1, 0,
                     dcgettext(((void *)0), "can't get process context", 5)),
               ((0) ? (void)0 : __builtin_unreachable())))
           : ((error(1, 0,
                     dcgettext(((void *)0), "can't get process context", 5)),
               ((0) ? (void)0 : __builtin_unreachable()))));
    ...
    for (; optind < n_ids; optind++) {
      ...
      if (pwd == ((void *)0)) {
        error(0, (*__errno_location()),
              dcgettext(((void *)0), "%s: no such user", 5), quote(spec));
        ok &= 0;
      } else {
        if (!pw_name)
        ...
        ((!!sizeof(struct {
          _Static_assert(
              1, "verify_expr ("
                 ...
                 "\"cannot get effective UID\", 5)), assume (false))"
                 ")");
          int _gl_dummy;
        }))
             ? ((error(1, (*__errno_location()),
                       dcgettext(((void *)0), "cannot get effective UID", 5)),
                 ((0) ? (void)0 : __builtin_unreachable())))
             : ((error(1, (*__errno_location()),
                       dcgettext(((void *)0), "cannot get effective UID", 5)),
                 ((0) ? (void)0 : __builtin_unreachable()))));
      ...
      if (ruid == NO_UID && (*__errno_location()))
        ((!!sizeof(struct {
          _Static_assert(1,
                         ...
                         "*)0), \"cannot get real UID\", 5)), assume (false))"
                         ")");
          int _gl_dummy;
        }))
             ? ((error(1, (*__errno_location()),
                       dcgettext(((void *)0), "cannot get real UID", 5)),
                 ((0) ? (void)0 : __builtin_unreachable())))
             : ((error(1, (*__errno_location()),
                       dcgettext(((void *)0), "cannot get real UID", 5)),
                 ((0) ? (void)0 : __builtin_unreachable()))));
        ...
        ((!!sizeof(struct {
          _Static_assert(
              1, "verify_expr ("
                 ...
                 ", "
                 "(error (1, (*__errno_location ()), dcgettext (((void *)0), "
                 "\"cannot get effective GID\", 5)), assume (false))"
                 ")");
          int _gl_dummy;
        }))
             ? ((error(1, (*__errno_location()),
                       dcgettext(((void *)0), "cannot get effective GID", 5)),
                 ((0) ? (void)0 : __builtin_unreachable())))
             : ((error(1, (*__errno_location()),
                       dcgettext(((void *)0), "cannot get effective GID", 5)),
                 ((0) ? (void)0 : __builtin_unreachable()))));
      ...
      if (rgid == NO_GID && (*__errno_location()))
        ((!!sizeof(struct {
          _Static_assert(1,
                         ...
                         ", "
                         "(error (1, (*__errno_location ()), dcgettext (((void "
                         "*)0), \"cannot get real GID\", 5)), assume (false))"
                         ")");
          int _gl_dummy;
        }))
             ? ((error(1, (*__errno_location()),
                       dcgettext(((void *)0), "cannot get real GID", 5)),
                 ((0) ? (void)0 : __builtin_unreachable())))
             : ((error(1, (*__errno_location()),
                       dcgettext(((void *)0), "cannot get real GID", 5)),
                 ((0) ? (void)0 : __builtin_unreachable()))));
...
static void print_user(uid_t uid) {
  ...
  if (use_name) {
    pwd = getpwuid(uid);
    if (pwd == ((void *)0)) {
      error(0, 0, dcgettext(((void *)0), "cannot find name for user ID %s", 5),
            uidtostr_ptr(&(uid)));
      ok &= 0;
    }
  }
...
static void print_full_info(char const *username) {
  ...
  printf(dcgettext(((void *)0), "uid=%s", 5), uidtostr_ptr(&(ruid)));
  pwd = getpwuid(ruid);
  if (pwd)
    printf("(%s)", pwd->pw_name);

  printf(dcgettext(((void *)0), " gid=%s", 5), gidtostr_ptr(&(rgid)));
  grp = getgrgid(rgid);
  if (grp)
    printf("(%s)", grp->gr_name);

  if (euid != ruid) {
    printf(dcgettext(((void *)0), " euid=%s", 5), uidtostr_ptr(&(euid)));
    pwd = getpwuid(euid);
    if (pwd)
      printf("(%s)", pwd->pw_name);
  }
  ...
  if (egid != rgid) {
    printf(dcgettext(((void *)0), " egid=%s", 5), gidtostr_ptr(&(egid)));
    grp = getgrgid(egid);
    if (grp)
      printf("(%s)", grp->gr_name);
  }

  {
    ...
    if (n_groups < 0) {
      if (username)
        error(0, (*__errno_location()),
              dcgettext(((void *)0), "failed to get groups for user %s", 5),
              quote(username));
      else
        error(0, (*__errno_location()),
              dcgettext(((void *)0),
                        "failed to get groups for the current process", 5));
      ok &= 0;
      return;
    }

    if (n_groups > 0)
      fputs_unlocked(dcgettext(((void *)0), " groups=", 5), stdout);
  ...
  if (context)
    printf(dcgettext(((void *)0), " context=%s", 5), context);
}
...
static void print_stuff(char const *pw_name) {
  if (just_user)
    ...
    ok &= print_group_list(pw_name, ruid, rgid, egid, use_name,
                           opt_zero ? '\0' : ' ');
