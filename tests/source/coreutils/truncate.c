  ...
  if (status != 0)
    ...
    fputs_unlocked(
        dcgettext(
            ...
            "larger than the specified size, the extra data is lost.\nIf a "
            "FILE is shorter, it is extended and the sparse extended part "
            "(hole)\nreads as zero bytes.\n",
            5),
        stdout)
    ...
    fputs_unlocked(
        ...
        ;
    fputs_unlocked(dcgettext(((void *)0),
                             "  -o, --io-blocks        treat SIZE as number of "
                             "IO blocks instead of bytes\n",
                             5),
                   stdout)
  ...
  if (rel_mode) {
    ...
    if (0 <= rsize)
      ...
      if (usable_st_size(&sb)) {
        ...
        if (fsize < 0) {
          ...
          error(0, 0,
                dcgettext(((void *)0),
                          "%s has unusable, apparently negative size", 5),
                quotearg_style(shell_escape_always_quoting_style, fname));
          return 0;
        }
      } else {
        ...
        if (fsize < 0) {
          error(0, (*__errno_location()),
                dcgettext(((void *)0), "cannot get the size of %s", 5),
                quotearg_style(shell_escape_always_quoting_style, fname));
          return 0;
        }
      }
    ...
    if (rel_mode == rm_min)
      ...
      if (__builtin_add_overflow(fsize, ssize, &nsize)) {
        error(0, 0,
              dcgettext(((void *)0), "overflow extending size of file %s", 5),
              quotearg_style(shell_escape_always_quoting_style, fname));
        return 0;
      }
    }
  ...
  if (ftruncate(fd, nsize) != 0) {
    ...
    error(0, (*__errno_location()),
          dcgettext(((void *)0),
                    ...
                    " bytes",
                    5),
          quotearg_style(shell_escape_always_quoting_style, fname), s);
    return 0;
  }
...
int main(int argc, char **argv) {
  ...
  while ((c = getopt_long(argc, argv, "cor:s:", longopts, ((void *)0))) != -1) {
    ...
    case 's':
      ...
      if (*optarg == '+' || *optarg == '-') {
        if (rel_mode) {
          error(0, 0,
                dcgettext(((void *)0), "multiple relative modifiers specified",
                          5));
      ...
      if ((rel_mode == rm_rup || rel_mode == rm_rdn) && size == 0)
        ((!!sizeof(struct {
          _Static_assert(1, "verify_expr ("
                            ...
                            "by zero\", 5)), assume (false))"
                            ")");
          int _gl_dummy;
        }))
             ? ((error(1, 0, dcgettext(((void *)0), "division by zero", 5)),
    ...
    case GETOPT_VERSION_CHAR:
      version_etc(stdout, "truncate", "GNU coreutils", Version,
  ...
  if (!ref_file && !got_size) {
    error(0, 0, dcgettext(((void *)0), "you must specify either %s or %s", 5),
  ...
  if (ref_file && got_size && !rel_mode) {
    error(0, 0,
          dcgettext(((void *)0), "you must specify a relative %s with %s", 5),
          quote_n(0, "--size"), quote_n(1, "--reference"));
    usage(1);
  }

  if (block_mode && !got_size) {
    error(0, 0, dcgettext(((void *)0), "%s was specified but %s was not", 5),
      ...
      ((!!sizeof(struct {
        _Static_assert(
            1, "verify_expr ("
               ...
               "\"cannot stat %s\", 5), quotearg_style "
      ...
      ((!!sizeof(struct {
        _Static_assert(
            1, "verify_expr ("
               ...
               ", "
               "(error (1, (*__errno_location ()), dcgettext (((void *)0), "
               "\"cannot get the size of %s\", 5), quotearg_style "
               "(shell_escape_always_quoting_style, ref_file)), assume (false))"
               ")");
        int _gl_dummy;
      }))
  ...
  int oflags = 01 | (no_create ? 0 : 0100) | 04000;
  ...
  for (char const *fname; (fname = *argv); argv++) {
    ...
    if (fd < 0) {
      ...
      if (!(no_create && (*__errno_location()) == 2)) {
        error(0, (*__errno_location()),
              dcgettext(((void *)0), "cannot open %s for writing", 5),
              quotearg_style(shell_escape_always_quoting_style, fname));
        errors = 1;
      }
    } else {
