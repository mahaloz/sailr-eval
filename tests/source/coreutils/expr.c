...
inline int mb_width_aux(wint_t wc) {
  int w = wcwidth(wc);

  return (w >= 0 ? w : iswcntrl(wc) ? 0 : 1);
}
inline void mb_copy(mbchar_t *new_mbc, const mbchar_t *old_mbc) {
...
inline void mbuiter_multi_next(struct mbuiter_multi *iter) {
  if (iter->next_done)
    return;
  if (iter->in_shift)
    goto with_shift;
  ...
  if (is_basic(*iter->cur.ptr)) {
    ...
    ((void)sizeof((mbsinit(&iter->state)) ? 1 : 0), __extension__({
       if (mbsinit(&iter->state))
         ;
       else
         __assert_fail("mbsinit (&iter->state)", "./lib/mbuiter.h", 143,
  ...
  with_shift:
    iter->cur.bytes = rpl_mbrtowc(
        &iter->cur.wc, iter->cur.ptr,
        strnlen1(iter->cur.ptr, (__ctype_get_mb_cur_max())), &iter->state);
    if (iter->cur.bytes == (size_t)-1) {
      ...
      if (iter->cur.bytes == 0) {
        ...
        ((void)sizeof((*iter->cur.ptr == '\0') ? 1 : 0), __extension__({
           if (*iter->cur.ptr == '\0')
             ;
           else
             __assert_fail("*iter->cur.ptr == '\\0'", "./lib/mbuiter.h", 171,
                           __extension__ __PRETTY_FUNCTION__);
         }));

        ((void)sizeof((iter->cur.wc == 0) ? 1 : 0), __extension__({
           if (iter->cur.wc == 0)
             ;
           else
             __assert_fail("iter->cur.wc == 0", "./lib/mbuiter.h", 172,
                           __extension__ __PRETTY_FUNCTION__);
         }));
      }
      iter->cur.wc_valid = 1;
...
inline void mbuiter_multi_reloc(struct mbuiter_multi *iter, ptrdiff_t ptrdiff) {
  iter->cur.ptr += ptrdiff;
}

inline void mbuiter_multi_copy(struct mbuiter_multi *new_iter,
                               const struct mbuiter_multi *old_iter) {
...
_Static_assert((18446744073709551615UL) <= (0x7fffffffffffffffL * 2UL + 1UL),
               "verify ("
               "SIZE_MAX <= ULONG_MAX"
               ")");
enum {
...
static char *mbs_logical_substr(char const *s, size_t pos, size_t len) {
  char *v, *vlim;
...
static size_t mbs_offset_to_chars(char const *s, size_t ofs) {
  mbui_iterator_t iter;
  size_t c = 0;
  for (((iter).cur.ptr = (s), (iter).in_shift = 0,
      memset(&(iter).state, '\0', sizeof(mbstate_t)), (iter).next_done = 0);
...
void usage(int status) {
  if (status != 0)
    ...
    printf(dcgettext(((void *)0), "Usage: %s EXPRESSION\n  or:  %s OPTION\n", 5)
    ...
    fputs_unlocked(
        dcgettext(
            ...
            "else lexicographical.\nPattern matches return the string matched "
            "between \\( and \\) or null; if\n\\( and \\) are not used, they "
...
int main(int argc, char **argv) {
  ...
  parse_long_options(argc, argv, "expr", "GNU coreutils", "9.1", usage,
                     ("Mike Parker"), ("James Youngman"), ("Paul Eggert"),
                     (char const *)((void *)0));
  ...
  if (!nomoreargs())
    ((!!sizeof(struct {
      _Static_assert(
          ...
          "EXPR_INVALID"
          ", "
          "(error (EXPR_INVALID, 0, dcgettext (((void *)0), \"syntax error: "
          "unexpected argument %s\", 5), quotearg_n_style (0, "
          "locale_quoting_style, *args)), assume (false))"
          ")");
      int _gl_dummy;
    }))
         ? ((error(EXPR_INVALID, 0,
                   dcgettext(((void *)0),
                             "syntax error: unexpected argument %s", 5),
...
static VALUE *int_value(unsigned long int i) {
...
toarith(VALUE *v) {
  ...
  case string: {
    ...
    if (!looks_like_integer(s))
      return 0;
    if (__gmpz_init_set_str(v->u.i, s, 10) != 0)
      ((!!sizeof(struct {
        _Static_assert(EXPR_FAILURE,
                       "verify_expr ("
                       "EXPR_FAILURE"
                       ", "
                       "(error (EXPR_FAILURE, 34, \"%s\", (s)), assume (false))"
                       ")");
        int _gl_dummy;
      }))
...
static void require_more_args(void) {
  if (nomoreargs())
    ((!!sizeof(struct {
      _Static_assert(
          EXPR_INVALID,
          ...
          ", "
          "(error (EXPR_INVALID, 0, dcgettext (((void *)0), \"syntax error: "
          "missing argument after %s\", 5), quotearg_n_style (0, "
          "locale_quoting_style, *(args - 1))), assume (false))"
          ")");
      int _gl_dummy;
    }))
         ? ((error(EXPR_INVALID, 0,
                   dcgettext(((void *)0),
                             "syntax error: missing argument after %s", 5),
  ...
  if (errmsg)
    ((!!sizeof(struct {
      _Static_assert(
          ...
          "EXPR_INVALID"
          ", "
          "(error (EXPR_INVALID, 0, \"%s\", (errmsg)), assume (false))"
          ")");
      int _gl_dummy;
    }))
  ...
  if (0 <= matchlen) {
    ...
    ((!!sizeof(struct {
      _Static_assert(
          ...
          "EXPR_FAILURE"
          ", "
          "(error (EXPR_FAILURE, (matchlen == -2 ? (*__errno_location ()) : "
          "75), dcgettext (((void *)0), \"error in regular expression "
          "matcher\", 5)), assume (false))"
          ")");
      int _gl_dummy;
    }))
         ? ((error(EXPR_FAILURE, (matchlen == -2 ? (*__errno_location()) : 75),
...
static VALUE *eval7(_Bool evaluate) {
    ...
    if (nomoreargs())
      ((!!sizeof(struct {
        _Static_assert(
            ...
            ", "
            "(error (EXPR_INVALID, 0, dcgettext (((void *)0), \"syntax error: "
            "expecting ')' after %s\", 5), quotearg_n_style (0, "
            "locale_quoting_style, *(args - 1))), assume (false))"
            ")");
        int _gl_dummy;
      }))
           ? ((error(EXPR_INVALID, 0,
                     dcgettext(((void *)0),
                               "syntax error: expecting ')' after %s", 5),
                     quotearg_n_style(0, locale_quoting_style, *(args - 1))),
               ((0) ? (void)0 : __builtin_unreachable())))
           : ((error(EXPR_INVALID, 0,
                     dcgettext(((void *)0),
    ...
    if (!nextarg(")"))
      ((!!sizeof(struct {
        _Static_assert(
            ...
            ", "
            "(error (EXPR_INVALID, 0, dcgettext (((void *)0), \"syntax error: "
            "expecting ')' instead of %s\", 5), quotearg_n_style (0, "
            "locale_quoting_style, *args)), assume (false))"
            ")");
        int _gl_dummy;
      }))
           ? ((error(EXPR_INVALID, 0,
                     dcgettext(((void *)0),
                               "syntax error: expecting ')' instead of %s", 5),
                     quotearg_n_style(0, locale_quoting_style, *args)),
               ((0) ? (void)0 : __builtin_unreachable())))
           : ((error(EXPR_INVALID, 0,
                     dcgettext(((void *)0),
  ...
  if (nextarg(")"))
    ((!!sizeof(struct {
      _Static_assert(EXPR_INVALID,
                     "verify_expr ("
                     "EXPR_INVALID"
                     ", "
                     "(error (EXPR_INVALID, 0, dcgettext (((void *)0), "
                     "\"syntax error: unexpected ')'\", 5)), assume (false))"
                     ")");
      int _gl_dummy;
    }))
         ? ((error(EXPR_INVALID, 0,
                   dcgettext(((void *)0), "syntax error: unexpected ')'", 5)),
             ((0) ? (void)0 : __builtin_unreachable())))
         : ((error(EXPR_INVALID, 0,
                   dcgettext(((void *)0), "syntax error: unexpected ')'", 5)),
             ((0) ? (void)0 : __builtin_unreachable()))));
    ...
    if (evaluate) {
      if (!toarith(l) || !toarith(r))
        ((!!sizeof(struct {
          _Static_assert(EXPR_INVALID,
                         ...
                         ", "
                         "(error (EXPR_INVALID, 0, dcgettext (((void *)0), "
                         "\"non-integer argument\", 5)), assume (false))"
                         ")");
          int _gl_dummy;
        }))
             ? ((error(EXPR_INVALID, 0,
                       dcgettext(((void *)0), "non-integer argument", 5)),
                 ((0) ? (void)0 : __builtin_unreachable())))
             : ((error(EXPR_INVALID, 0,
                       dcgettext(((void *)0), "non-integer argument", 5)),
                 ((0) ? (void)0 : __builtin_unreachable()))));
      if (fxn != multiply &&
          ((r->u.i)->_mp_size < 0 ? -1 : (r->u.i)->_mp_size > 0) == 0)
        ((!!sizeof(struct {
          _Static_assert(EXPR_INVALID,
                         "verify_expr ("
                         "EXPR_INVALID"
                         ", "
                         "(error (EXPR_INVALID, 0, dcgettext (((void *)0), "
                         "\"division by zero\", 5)), assume (false))"
                         ")");
          int _gl_dummy;
        }))
             ? ((error(EXPR_INVALID, 0,
                       dcgettext(((void *)0), "division by zero", 5)),
                 ((0) ? (void)0 : __builtin_unreachable())))
             : ((error(EXPR_INVALID, 0,
                       dcgettext(((void *)0), "division by zero", 5)),
                 ((0) ? (void)0 : __builtin_unreachable()))));
      ((fxn == multiply ? __gmpz_mul
        ...
        : fxn == divide ? __gmpz_tdiv_q
                        ...
                        : __gmpz_tdiv_r)(l->u.i, l->u.i, r->u.i));
    }
    freev(r);
  }
}
      ...
      if (looks_like_integer(l->u.s) && looks_like_integer(r->u.s))
        ...
        if ((*__errno_location())) {
          error(0, (*__errno_location()),
                dcgettext(((void *)0), "string comparison failed", 5));
          error(0, 0,
                dcgettext(((void *)0),
                          "set LC_ALL='C' to work around the problem", 5));
          ((!!sizeof(struct {
            _Static_assert(
                EXPR_INVALID,
                "verify_expr ("
                "EXPR_INVALID"
                ", "
                "(error (EXPR_INVALID, 0, dcgettext (((void *)0), \"the "
                "strings compared were %s and %s\", 5), quotearg_n_style (0, "
                "locale_quoting_style, l->u.s), quotearg_n_style (1, "
                "locale_quoting_style, r->u.s)), assume (false))"
                ")");
            int _gl_dummy;
          }))
               ? ((error(EXPR_INVALID, 0,
                         dcgettext(((void *)0),
                                   "the strings compared were %s and %s", 5),
