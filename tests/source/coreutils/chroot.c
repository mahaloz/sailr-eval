...
enum { GROUPS = (0x7f * 2 + 1) + 1, USERSPEC, SKIP_CHDIR };
...
static int parse_additional_groups(char const *groups, gid_t **pgids,
    ...
    if (g == ((void *)0)) {
      ...
      if (show_errors) {
        error(0, (*__errno_location()),
              dcgettext(((void *)0), "invalid group %s", 5), quote(tmp));
        continue;
      }
  ...
  if (ret == 0 && n_gids == 0) {
    if (show_errors)
      error(0, 0, dcgettext(((void *)0), "invalid group list %s", 5),
            quote(groups));
    ret = -1;
  }
...
void usage(int status) {
  if (status != 0)
    ...
    fputs_unlocked(dcgettext(((void *)0),
        ...
        ;
    printf(dcgettext(((void *)0),
                     "      --skip-chdir           do not change working "
                     "directory to %s\n",
                     5)
  ...
  if (chroot(newroot) != 0)
    ((!!sizeof(struct {
      _Static_assert(
          ...
          "*)0), \"cannot change root directory to %s\", 5), quotearg_style "
          "(shell_escape_always_quoting_style, newroot)), assume (false))"
          ")");
      int _gl_dummy;
    }))
         ? ((error(EXIT_CANCELED, (*__errno_location()),
                   dcgettext(((void *)0), "cannot change root directory to %s",
                             5),
  ...
  if (!skip_chdir && chdir("/"))
    ((!!sizeof(struct {
      _Static_assert(
          ...
          ", "
          "(error (EXIT_CANCELED, (*__errno_location ()), dcgettext (((void "
          "*)0), \"cannot chdir to root directory\", 5)), assume (false))"
          ")");
      int _gl_dummy;
    }))
         ? ((error(EXIT_CANCELED, (*__errno_location()),
                   dcgettext(((void *)0), "cannot chdir to root directory", 5)),
             ((0) ? (void)0 : __builtin_unreachable())))
         : ((error(EXIT_CANCELED, (*__errno_location()),
                   dcgettext(((void *)0), "cannot chdir to root directory", 5)),
             ((0) ? (void)0 : __builtin_unreachable()))));
    ...
    if ((pwd = getpwuid(uid))) {
      ...
      ((!!sizeof(struct {
        _Static_assert(EXIT_CANCELED,
                       ...
                       ", "
                       "(error (EXIT_CANCELED, (*__errno_location ()), "
                       "dcgettext (((void *)0), \"no group specified for "
                       "unknown uid: %d\", 5), (int) uid), assume (false))"
                       ")");
        int _gl_dummy;
      }))
           ? ((error(EXIT_CANCELED, (*__errno_location()),
                     dcgettext(((void *)0),
                               "no group specified for unknown uid: %d", 5),
                     (int)uid),
               ((0) ? (void)0 : __builtin_unreachable())))
           : ((error(EXIT_CANCELED, (*__errno_location()),
                     dcgettext(((void *)0),
      ...
      if (!n_gids)
        ((!!sizeof(struct {
          _Static_assert(EXIT_CANCELED,
                         ...
                         ", "
                         "(error (EXIT_CANCELED, (*__errno_location ()), "
                         "dcgettext (((void *)0), \"failed to get supplemental "
                         "groups\", 5)), assume (false))"
                         ")");
          int _gl_dummy;
        }))
             ? ((error(EXIT_CANCELED, (*__errno_location()),
                       dcgettext(((void *)0),
                                 "failed to get supplemental groups", 5)),
                 ((0) ? (void)0 : __builtin_unreachable())))
             : ((error(EXIT_CANCELED, (*__errno_location()),
                       dcgettext(((void *)0),
                                 "failed to get supplemental groups", 5)),
  ...
  if (((!uid_unset(uid)) || groups) && setgroups(n_gids, gids) != 0)
    ((!!sizeof(struct {
      _Static_assert(
          ...
          ", "
          "(error (EXIT_CANCELED, (*__errno_location ()), dcgettext (((void "
          "*)0), \"failed to set supplemental groups\", 5)), assume (false))"
          ")");
      int _gl_dummy;
    }))
         ? ((error(EXIT_CANCELED, (*__errno_location()),
                   dcgettext(((void *)0), "failed to set supplemental groups",
                             5)),
             ((0) ? (void)0 : __builtin_unreachable())))
         : ((error(EXIT_CANCELED, (*__errno_location()),
                   dcgettext(((void *)0), "failed to set supplemental groups",
  ...
  if ((!gid_unset(gid)) && setgid(gid))
    ((!!sizeof(struct {
      _Static_assert(
          ...
          ", "
          "(error (EXIT_CANCELED, (*__errno_location ()), dcgettext (((void "
          "*)0), \"failed to set group-ID\", 5)), assume (false))"
          ")");
      int _gl_dummy;
    }))
         ? ((error(EXIT_CANCELED, (*__errno_location()),
                   dcgettext(((void *)0), "failed to set group-ID", 5)),
             ((0) ? (void)0 : __builtin_unreachable())))
         : ((error(EXIT_CANCELED, (*__errno_location()),
                   dcgettext(((void *)0), "failed to set group-ID", 5)),
             ((0) ? (void)0 : __builtin_unreachable()))));
  ...
  if ((!uid_unset(uid)) && setuid(uid))
    ((!!sizeof(struct {
      _Static_assert(
          ...
          ", "
          "(error (EXIT_CANCELED, (*__errno_location ()), dcgettext (((void "
          "*)0), \"failed to set user-ID\", 5)), assume (false))"
          ")");
      int _gl_dummy;
    }))
         ? ((error(EXIT_CANCELED, (*__errno_location()),
                   dcgettext(((void *)0), "failed to set user-ID", 5)),
             ((0) ? (void)0 : __builtin_unreachable())))
         : ((error(EXIT_CANCELED, (*__errno_location()),
                   dcgettext(((void *)0), "failed to set user-ID", 5)),
             ((0) ? (void)0 : __builtin_unreachable()))));
