...
enum scale_type { scale_none, scale_auto, scale_SI, scale_IEC, scale_IEC_I };

static char const *const scale_from_args[] = {"none",  "auto",     "si", "iec",
                                              "iec-i", ((void *)0)
...
static char const *const scale_to_args[] = {"none", "si", "iec", "iec-i",
                                            ((void *)0)

};

static enum scale_type const scale_to_types[] = {scale_none, scale_SI,
                                                 scale_IEC, scale_IEC_I};
...
static char const *const round_args[] = {
    "up",      "down",     "from-zero", "towards-zero",
    "nearest", ((void *)0)
...
enum inval_type { inval_abort, inval_fail, inval_warn, inval_ignore };

static char const *const inval_args[] = {"abort", "fail", "warn", "ignore",
                                         ((void *)0)

};

static enum inval_type const inval_types[] = {inval_abort, inval_fail,
                                              inval_warn, inval_ignore};
...
static char const *suffix = ((void *)0);
...
static char const *format_str = ((void *)0);
...
static inline int default_scale_base(enum scale_type scale) {
  switch (scale) {
  case scale_IEC:
  case scale_IEC_I:
    return 1024;
...
static inline int suffix_power(const char suf) {
  switch (suf) {
  case 'K':
    return 1;
...
static long double powerld(long double base, unsigned int x) {
...
static long double expld(long double val, unsigned int base, unsigned int *x) {
  unsigned int power = 0;

  if (val >= -1.18973149535723176502126385303097021e+4932L &&
      val <= 1.18973149535723176502126385303097021e+4932L) {
...
static inline intmax_t simple_round_ceiling(long double val) {
  intmax_t intval = val;
  if (intval < val)
    intval++;
  return intval;
...
static inline intmax_t simple_round_floor(long double val) {
  return -simple_round_ceiling(-val);
}

static inline intmax_t simple_round_from_zero(long double val) {
  return val < 0 ? simple_round_floor(val) : simple_round_ceiling(val);
}

static inline intmax_t simple_round_to_zero(long double val) { return val; }

static inline intmax_t simple_round_nearest(long double val) {
  return val < 0 ? val - 0.5 : val + 0.5;
}

__attribute__((__const__)) static inline long double
...
static enum simple_strtod_error simple_strtod_int(char const *input_str,
                                                  char **endptr,
                                                  long double *value,
                                                  _Bool *negative) {
...
static enum simple_strtod_error simple_strtod_float(char const *input_str,
                                                    char **endptr,
                                                    long double *value,
                                                    size_t *precision) {
...
simple_strtod_human(char const *input_str, char **endptr, long double *value,
                    size_t *precision, enum scale_type allowed_scaling) {
  int power = 0;
  ...
  if (**endptr != '\0') {
    ...
    while (((*__ctype_b_loc())[(int)((to_uchar(**endptr)))] &
...
static void simple_strtod_fatal(enum simple_strtod_error err,
  ...
  if (inval_style != inval_ignore)
    error(conv_exit_code, 0, dcgettext(((void *)0), msgid, 5),
          quote(input_str));
}
      ...
      ((!!sizeof(struct {
        _Static_assert(
            1, "verify_expr ("
               ...
               "value '%Lf' for printing\", 5), val), assume (false))"
               ")");
        int _gl_dummy;
      }))
           ? ((error(1, 0,
                     dcgettext(((void *)0),
                               "failed to prepare value '%Lf' for printing", 5),
                     val),
    ...
    ((!!sizeof(struct {
      _Static_assert(
          1, "verify_expr ("
             "1"
             ", "
             "(error (1, 0, dcgettext (((void *)0), \"failed to prepare value "
             "'%Lf' for printing\", 5), val), assume (false))"
             ")");
      int _gl_dummy;
    }))
         ? ((error(1, 0,
  ...
  if (s_err != LONGINT_OK || *end || n == 0) {
    ...
    ((!!sizeof(struct {
      _Static_assert(1, "verify_expr ("
                        "1"
                        ", "
                        "(error (1, 0, dcgettext (((void *)0), \"invalid unit "
                        "size: %s\", 5), quote (n_string)), assume (false))"
                        ")");
      int _gl_dummy;
    }))
         ? ((error(1, 0, dcgettext(((void *)0), "invalid unit size: %s", 5),
                   quote(n_string)),
             ((0) ? (void)0 : __builtin_unreachable())))
         : ((error(1, 0, dcgettext(((void *)0), "invalid unit size: %s", 5),
                   quote(n_string)),
...
static void setup_padding_buffer(size_t min_size) {
...
void usage(int status) {
  if (status != 0)
    ...
    printf(dcgettext(((void *)0), "Usage: %s [OPTION]... [NUMBER]...\n", 5)

               ,
           program_name);
    fputs_unlocked(dcgettext(((void *)0),
                             "Reformat NUMBER(s), or the numbers from standard "
    ...
    fputs_unlocked(
        ...
        ;
    fputs_unlocked(dcgettext(((void *)0),
                             "  -d, --delimiter=X    use X instead of "
                             "whitespace for field delimiter\n",
                             5),
                   stdout)
    ...
    fputs_unlocked(
        ...
        ;
    fputs_unlocked(dcgettext(((void *)0),
                             "      --from-unit=N    specify the input unit "
                             "size (instead of the default 1)\n",
                             5),
                   stdout)
    ...
    fputs_unlocked(
        dcgettext(((void *)0),
                  "      --header[=N]     print (without converting) the first "
                  "N header lines;\n                         N defaults to 1 "
                  "if not specified\n",
                  5),
        stdout)
    ...
    fputs_unlocked(
        ...
        ;
    fputs_unlocked(dcgettext(((void *)0),
                             "      --to=UNIT        auto-scale output numbers "
        ...
        ;
    fputs_unlocked(dcgettext(((void *)0),
                             "      --to-unit=N      the output unit size "
    ...
    fputs_unlocked(dcgettext(((void *)0), "\nUNIT options:\n", 5), stdout)
        ...
        ;
    fputs_unlocked(dcgettext(((void *)0),
                             "  none       no auto-scaling is done; suffixes "
    ...
    fputs_unlocked(
        dcgettext(
            ...
            "from N'th to M'th field (inclusive)\n  -M   from first to M'th "
            "field (inclusive)\n  -    all fields\nMultiple fields/ranges can "
    ...
    printf(dcgettext(
               ...
               "-l  | %s --header --field 5 --to=iec\n  $ ls -lh | %s --header "
               "--field 5 --from=iec --padding=10\n  $ ls -lh | %s --header "
               "--field 5 --from=iec --format %%10f\n",
               5),
...
static void parse_format_string(char const *fmt) {
    ...
    if (!fmt[i])
      ((!!sizeof(struct {
        _Static_assert(1,
                       ...
                       "1"
                       ", "
                       "(error (1, 0, dcgettext (((void *)0), \"format %s has "
                       "no %% directive\", 5), quote (fmt)), assume (false))"
                       ")");
        int _gl_dummy;
      }))
           ? ((error(1, 0,
                     dcgettext(((void *)0), "format %s has no %% directive", 5),
                     quote(fmt)),
               ((0) ? (void)0 : __builtin_unreachable())))
           : ((error(1, 0,
                     dcgettext(((void *)0), "format %s has no %% directive", 5),
  ...
  if ((*__errno_location()) == 34 || pad < -0x7fffffffffffffffL)
    ((!!sizeof(struct {
      _Static_assert(1,
                     "verify_expr ("
                     "1"
                     ", "
                     "(error (1, 0, dcgettext (((void *)0), \"invalid format "
                     "%s (width overflow)\", 5), quote (fmt)), assume (false))"
                     ")");
      int _gl_dummy;
    }))
         ? ((error(1, 0,
                   dcgettext(((void *)0), "invalid format %s (width overflow)",
                             5),
                   quote(fmt)),
             ((0) ? (void)0 : __builtin_unreachable())))
         : ((error(1, 0,
  ...
  if (endptr != (fmt + i) && pad != 0) {
    if (debug && padding_width && !(zero_padding && pad > 0))
      error(0, 0,
            dcgettext(((void *)0), "--format padding overriding --padding", 5));
  ...
  if (fmt[i] == '\0')
    ((!!sizeof(struct {
      _Static_assert(1, "verify_expr ("
                        "1"
                        ", "
                        "(error (1, 0, dcgettext (((void *)0), \"format %s "
                        "ends in %%\", 5), quote (fmt)), assume (false))"
                        ")");
      int _gl_dummy;
    }))
         ? ((error(1, 0, dcgettext(((void *)0), "format %s ends in %%", 5),
                   quote(fmt)),
             ((0) ? (void)0 : __builtin_unreachable())))
         : ((error(1, 0, dcgettext(((void *)0), "format %s ends in %%", 5),
                   quote(fmt)),
  ...
  if (fmt[i] == '.') {
    ...
    if ((*__errno_location()) == 34 || user_precision < 0 ||
        (18446744073709551615UL) < user_precision ||
        ((*__ctype_b_loc())[(int)((fmt[i]))] & (unsigned short int)_ISblank) ||
        fmt[i] == '+') {
      ...
      ((!!sizeof(struct {
        _Static_assert(
            1, "verify_expr ("
               ...
               "format %s\", 5), quote (fmt)), assume (false))"
               ")");
        int _gl_dummy;
      }))
           ? ((error(
                   1, 0,
                   dcgettext(((void *)0), "invalid precision in format %s", 5),
                   quote(fmt)),
               ((0) ? (void)0 : __builtin_unreachable())))
           : ((error(
                   1, 0,
      ...
      ((!!sizeof(struct {
        _Static_assert(
            1, "verify_expr ("
               "1"
               ", "
               "(error (1, 0, dcgettext (((void *)0), \"format %s has too many "
               "%% directives\", 5), quote (fmt)), assume (false))"
               ")");
        int _gl_dummy;
      }))
           ? ((error(1, 0,
                     dcgettext(((void *)0),
                               "format %s has too many %% directives", 5),
                     quote(fmt)),
               ((0) ? (void)0 : __builtin_unreachable())))
           : ((error(1, 0,
                     dcgettext(((void *)0),
  ...
  do {
    if (dev_debug)
      fprintf(stderr,
              ...
              "  padding width: %ld\n  alignment: %s\n"
              "  prefix: %s\n  suffix: %s\n",
              quote_n(0, fmt), (grouping) ? "yes" : "no", padding_width,
  ...
  if (ptr && *ptr != '\0') {
    if (inval_style != inval_ignore)
      error(conv_exit_code, 0,
            dcgettext(((void *)0), "invalid suffix in input %s: %s", 5),
...
static int prepare_padded_number(const long double val, size_t precision) {
  ...
  double_to_human(val, precision_used, buf, sizeof(buf), scale_to, grouping,
                  round_style);
  if (suffix)
  ...
  if (padding_width && strlen(buf) < padding_width) {
    ...
    mbsalign(buf, padding_buffer, padding_buffer_size, &w, padding_alignment,
             MBA_UNIBYTE_ONLY);
...
static void print_padded_number(void) {
...
static int process_suffixed_number(char *text, long double *result,
  ...
  char *p = text;
  while (*p && ((*__ctype_b_loc())[(int)((to_uchar(*p)))] &
                (unsigned short int)_ISblank))
    ++p;
  ...
  if (e == SSE_OK_PRECISION_LOSS && debug)
    error(0, 0,
          dcgettext(((void *)0),
                    "large input value %s: possible precision loss", 5),
          quote(p));
...
process_field(char *text, uintmax_t field) {
  ...
  if (include_field(field)) {
    valid_number = process_suffixed_number(text, &val, &precision, field);
...
int main(int argc, char **argv) {
  ...
  while (1) {
    ...
    case FROM_OPTION:
      scale_from = ((scale_from_types)[__xargmatch_internal(
          "--from", optarg, scale_from_args, (void const *)(scale_from_types),
          sizeof *(scale_from_types), argmatch_die, 1)]);
      break;
    ...
    case TO_OPTION:
      scale_to = ((scale_to_types)[__xargmatch_internal(
          "--to", optarg, scale_to_args, (void const *)(scale_to_types),
          sizeof *(scale_to_types), argmatch_die, 1)]);
      break;
    ...
    case ROUND_OPTION:
      round_style = ((round_types)[__xargmatch_internal(
          "--round", optarg, round_args, (void const *)(round_types),
          sizeof *(round_types), argmatch_die, 1)]);
      break;
    ...
    case PADDING_OPTION:
      if (xstrtol(optarg, ((void *)0), 10, &padding_width, "") != LONGINT_OK ||
          padding_width == 0 || padding_width < -0x7fffffffffffffffL)
        ((!!sizeof(struct {
          _Static_assert(
              1, "verify_expr ("
                 "1"
                 ", "
                 "(error (1, 0, dcgettext (((void *)0), \"invalid padding "
                 "value %s\", 5), quote (optarg)), assume (false))"
                 ")");
          int _gl_dummy;
        }))
             ? ((error(1, 0,
                       dcgettext(((void *)0), "invalid padding value %s", 5),
                       quote(optarg)),
                 ((0) ? (void)0 : __builtin_unreachable())))
             : ((error(1, 0,
                       dcgettext(((void *)0), "invalid padding value %s", 5),
      ...
      if (n_frp)
        ((!!sizeof(struct {
          _Static_assert(1, "verify_expr ("
                            ...
                            "field specifications\", 5)), assume (false))"
                            ")");
          int _gl_dummy;
        }))
             ? ((error(1, 0,
                       dcgettext(((void *)0), "multiple field specifications",
                                 5)),
                 ((0) ? (void)0 : __builtin_unreachable())))
             : ((error(1, 0,
                       dcgettext(((void *)0), "multiple field specifications",
        ...
        ((!!sizeof(struct {
          _Static_assert(
              1, "verify_expr ("
                 "1"
                 ", "
                 "(error (1, 0, dcgettext (((void *)0), \"the delimiter must "
                 "be a single character\", 5)), assume (false))"
                 ")");
          int _gl_dummy;
        }))
             ? ((error(1, 0,
          ...
          ((!!sizeof(struct {
            _Static_assert(
                1, "verify_expr ("
                   "1"
                   ", "
                   "(error (1, 0, dcgettext (((void *)0), \"invalid header "
                   "value %s\", 5), quote (optarg)), assume (false))"
                   ")");
            int _gl_dummy;
          }))
               ? ((error(1, 0,
                         dcgettext(((void *)0), "invalid header value %s", 5),
                         quote(optarg)),
                   ((0) ? (void)0 : __builtin_unreachable())))
               : ((error(1, 0,
                         dcgettext(((void *)0), "invalid header value %s", 5),
    ...
    case INVALID_OPTION:
      inval_style = ((inval_types)[__xargmatch_internal(
          "--invalid", optarg, inval_args, (void const *)(inval_types),
          sizeof *(inval_types), argmatch_die, 1)]);
      break;
    ...
    case GETOPT_VERSION_CHAR:
      version_etc(stdout, "numfmt", "GNU coreutils", Version, ("Assaf Gordon"),
                  (char *)((void *)0));
      exit(0);
      break;
      ;
  ...
  if (format_str != ((void *)0) && grouping)
    ((!!sizeof(struct {
      _Static_assert(1,
                     ...
                     "1"
                     ", "
                     "(error (1, 0, dcgettext (((void *)0), \"--grouping "
                     "cannot be combined with --format\", 5)), assume (false))"
                     ")");
      int _gl_dummy;
    }))
         ? ((error(1, 0,
                   dcgettext(((void *)0),
                             "--grouping cannot be combined with --format", 5)),
             ((0) ? (void)0 : __builtin_unreachable())))
         : ((error(1, 0,
                   dcgettext(((void *)0),
                             "--grouping cannot be combined with --format", 5)),
  ...
  if (debug && !locale_ok)
    error(0, 0, dcgettext(((void *)0), "failed to set locale", 5));

  if (debug && scale_from == scale_none && scale_to == scale_none &&
      !grouping && (padding_width == 0) && (format_str == ((void *)0)))
    error(0, 0, dcgettext(((void *)0), "no conversion option specified", 5));
  ...
  if (grouping) {
    if (scale_to != scale_none)
      ((!!sizeof(struct {
        _Static_assert(1, "verify_expr ("
                          ...
                          ", "
                          "(error (1, 0, dcgettext (((void *)0), \"grouping "
                          "cannot be combined with --to\", 5)), assume (false))"
                          ")");
        int _gl_dummy;
      }))
           ? ((error(1, 0,
                     dcgettext(((void *)0),
                               "grouping cannot be combined with --to", 5)),
               ((0) ? (void)0 : __builtin_unreachable())))
           : ((error(1, 0,
                     dcgettext(((void *)0),
                               "grouping cannot be combined with --to", 5)),
    ...
    if (debug && (strlen(nl_langinfo(THOUSEP)) == 0))
      error(0, 0,
            dcgettext(((void *)0), "grouping has no effect in this locale", 5));
  }
  ...
  if (argc > optind) {
    if (debug && header)
      error(0, 0,
            dcgettext(((void *)0), "--header ignored with command-line input",
                      5));
    ...
    if (ferror_unlocked(stdin))
      error(0, (*__errno_location()),
            dcgettext(((void *)0), "error reading input", 5));
  }

  if (debug && !valid_numbers)
    error(0, 0,
          dcgettext(((void *)0), "failed to convert some of the input numbers",
                    5));

  int exit_status = 0;
  if (!valid_numbers && inval_style != inval_warn &&
