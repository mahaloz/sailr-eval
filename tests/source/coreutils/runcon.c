...
void usage(int status) {
  if (status != 0)
    ...
    printf(dcgettext(((void *)0),
                     ...
                     "USER] [-r ROLE] [-t TYPE] [-l RANGE] COMMAND [args]\n",
                     5)
    ...
    fputs_unlocked(dcgettext(((void *)0),
                             ...
                             "context.\nWith neither CONTEXT nor COMMAND, "
    ...
    fputs_unlocked(
        dcgettext(((void *)0),
                  ...
                  "--compute      compute process transition context before "
                  "modifying\n  -t, --type=TYPE    type (for same role as "
...
int main(int argc, char **argv) {
  ...
  while (1) {
      ...
      if (role)
        ((!!sizeof(struct {
          _Static_assert(1, "verify_expr ("
                            ...
                            "roles\", 5)), assume (false))"
                            ")");
          int _gl_dummy;
        }))
             ? ((error(1, 0, dcgettext(((void *)0), "multiple roles", 5)),
      ...
      if (type)
        ((!!sizeof(struct {
          _Static_assert(1, "verify_expr ("
                            ...
                            ", "
                            "(error (1, 0, dcgettext (((void *)0), \"multiple "
                            "types\", 5)), assume (false))"
                            ")");
          int _gl_dummy;
        }))
             ? ((error(1, 0, dcgettext(((void *)0), "multiple types", 5)),
                 ((0) ? (void)0 : __builtin_unreachable())))
             : ((error(1, 0, dcgettext(((void *)0), "multiple types", 5)),
                 ((0) ? (void)0 : __builtin_unreachable()))));
      type = optarg;
      ...
      if (user)
        ((!!sizeof(struct {
          _Static_assert(1, "verify_expr ("
                            ...
                            ", "
                            "(error (1, 0, dcgettext (((void *)0), \"multiple "
                            "users\", 5)), assume (false))"
                            ")");
          int _gl_dummy;
        }))
             ? ((error(1, 0, dcgettext(((void *)0), "multiple users", 5)),
                 ((0) ? (void)0 : __builtin_unreachable())))
             : ((error(1, 0, dcgettext(((void *)0), "multiple users", 5)),
                 ((0) ? (void)0 : __builtin_unreachable()))));
      user = optarg;
      ...
      if (range)
        ((!!sizeof(struct {
          _Static_assert(1, "verify_expr ("
                            ...
                            ", "
                            "(error (1, 0, dcgettext (((void *)0), \"multiple "
                            "levelranges\", 5)), assume (false))"
                            ")");
          int _gl_dummy;
        }))
             ? ((error(1, 0, dcgettext(((void *)0), "multiple levelranges", 5)),
                 ((0) ? (void)0 : __builtin_unreachable())))
             : ((error(1, 0, dcgettext(((void *)0), "multiple levelranges", 5)),
                 ((0) ? (void)0 : __builtin_unreachable()))));
      range = optarg;
    ...
    case GETOPT_VERSION_CHAR:
      version_etc(stdout, "runcon", "GNU coreutils", Version, ("Russell Coker"),
                  (char *)((void *)0));
      exit(0);
      break;
      ;
      ...
      ((!!sizeof(struct {
        _Static_assert(
            1, "verify_expr ("
               ...
               "\"failed to get current context\", 5)), assume (false))"
               ")");
        int _gl_dummy;
      }))
           ? ((error(
                   1, (*__errno_location()),
                   dcgettext(((void *)0), "failed to get current context", 5)),
               ((0) ? (void)0 : __builtin_unreachable())))
           : ((error(
                   1, (*__errno_location()),
                   dcgettext(((void *)0), "failed to get current context", 5)),
  ...
  if (!(user || role || type || range || compute_trans)) {
    if (optind >= argc) {
      error(0, 0,
            dcgettext(((void *)0),
                      "you must specify -c, -t, -u, -l, -r, or context", 5));
      usage(1);
    }
    context = argv[optind++];
  }
  ...
  if (optind >= argc) {
    error(0, 0, dcgettext(((void *)0), "no command specified", 5));
    usage(1);
  }
    ...
    ((!!sizeof(struct {
      _Static_assert(
          1, "verify_expr ("
             "1"
             ", "
             "(error (1, 0, dcgettext (((void *)0), \"%s may be used only on a "
             "SELinux kernel\", 5), program_name), assume (false))"
             ")");
      int _gl_dummy;
    }))
         ? ((error(1, 0,
                   dcgettext(((void *)0),
                             "%s may be used only on a SELinux kernel", 5),
                   program_name),
             ((0) ? (void)0 : __builtin_unreachable())))
         : ((error(1, 0,
                   dcgettext(((void *)0),
  ...
  if (context) {
    ...
    if (!con)
      ((!!sizeof(struct {
        _Static_assert(1, "verify_expr ("
                          ...
                          "(((void *)0), \"failed to create security context: "
                          "%s\", 5), quote (context)), assume (false))"
                          ")");
        int _gl_dummy;
      }))
           ? ((error(1, (*__errno_location()),
                     dcgettext(((void *)0),
                               "failed to create security context: %s", 5),
                     quote(context)),
               ((0) ? (void)0 : __builtin_unreachable())))
           : ((error(1, (*__errno_location()),
                     dcgettext(((void *)0),
    ...
    if (compute_trans) {
      ...
      if (rpl_getfilecon(argv[optind], &file_context) == -1)
        ((!!sizeof(struct {
          _Static_assert(1,
                         "verify_expr ("
                         "1"
                         ...
                         "*)0), \"failed to get security context of %s\", 5), "
          ...
          int _gl_dummy;
             ...
             ? ((error(1, (*__errno_location()),
                       dcgettext(((void *)0),
                                 "failed to get security context of %s", 5),
                       quotearg_style(shell_escape_always_quoting_style,
                                      argv[optind])),
                 ((0) ? (void)0 : __builtin_unreachable())))
             : ((error(1, (*__errno_location()),
        ...
        ((!!sizeof(struct {
          _Static_assert(
              1, "verify_expr ("
                 ...
                 ", "
                 "(error (1, (*__errno_location ()), dcgettext (((void *)0), "
                 "\"failed to compute a new context\", 5)), assume (false))"
                 ")");
          int _gl_dummy;
        }))
             ? ((error(1, (*__errno_location()),
                       dcgettext(((void *)0), "failed to compute a new context",
                                 5)),
                 ((0) ? (void)0 : __builtin_unreachable())))
             : ((error(1, (*__errno_location()),
                       dcgettext(((void *)0), "failed to compute a new context",
    ...
    if (!con)
      ((!!sizeof(struct {
        _Static_assert(1, "verify_expr ("
                          ...
                          "(error (1, (*__errno_location ()), dcgettext "
                          "(((void *)0), \"failed to create security context: "
                          "%s\", 5), quote (cur_context)), assume (false))"
                          ")");
        int _gl_dummy;
      }))
           ? ((error(1, (*__errno_location()),
    ...
    if (user && context_user_set(con, user))
      ((!!sizeof(struct {
        _Static_assert(
            ...
            ", "
            "(error (1, (*__errno_location ()), dcgettext (((void *)0), "
            "\"failed to set new user: %s\", 5), quote (user)), assume (false))"
            ")");
        int _gl_dummy;
      }))
           ? ((error(1, (*__errno_location()),
                     dcgettext(((void *)0), "failed to set new user: %s", 5),
                     quote(user)),
               ((0) ? (void)0 : __builtin_unreachable())))
           : ((error(1, (*__errno_location()),
                     dcgettext(((void *)0), "failed to set new user: %s", 5),
    ...
    if (type && context_type_set(con, type))
      ((!!sizeof(struct {
        _Static_assert(
            ...
            ", "
            "(error (1, (*__errno_location ()), dcgettext (((void *)0), "
            "\"failed to set new type: %s\", 5), quote (type)), assume (false))"
            ")");
        int _gl_dummy;
      }))
           ? ((error(1, (*__errno_location()),
                     dcgettext(((void *)0), "failed to set new type: %s", 5),
                     quote(type)),
               ((0) ? (void)0 : __builtin_unreachable())))
           : ((error(1, (*__errno_location()),
                     dcgettext(((void *)0), "failed to set new type: %s", 5),
    ...
    if (range && context_range_set(con, range))
      ((!!sizeof(struct {
        _Static_assert(1, "verify_expr ("
                          ...
                          ", "
                          "(error (1, (*__errno_location ()), dcgettext "
                          "(((void *)0), \"failed to set new range: %s\", 5), "
                          "quote (range)), assume (false))"
                          ")");
        int _gl_dummy;
      }))
           ? ((error(1, (*__errno_location()),
                     dcgettext(((void *)0), "failed to set new range: %s", 5),
                     quote(range)),
               ((0) ? (void)0 : __builtin_unreachable())))
           : ((error(1, (*__errno_location()),
                     dcgettext(((void *)0), "failed to set new range: %s", 5),
    ...
    if (role && context_role_set(con, role))
      ((!!sizeof(struct {
        _Static_assert(
            ...
            ", "
            "(error (1, (*__errno_location ()), dcgettext (((void *)0), "
            "\"failed to set new role: %s\", 5), quote (role)), assume (false))"
            ")");
        int _gl_dummy;
      }))
           ? ((error(1, (*__errno_location()),
                     dcgettext(((void *)0), "failed to set new role: %s", 5),
                     quote(role)),
               ((0) ? (void)0 : __builtin_unreachable())))
           : ((error(1, (*__errno_location()),
                     dcgettext(((void *)0), "failed to set new role: %s", 5),
  ...
  if (security_check_context(context_str(con)) < 0)
    ((!!sizeof(struct {
      _Static_assert(1, "verify_expr ("
                        ...
                        ", "
                        "(error (1, (*__errno_location ()), dcgettext (((void "
                        "*)0), \"invalid context: %s\", 5), quote (context_str "
                        "(con))), assume (false))"
                        ")");
      int _gl_dummy;
    }))
         ? ((error(1, (*__errno_location()),
                   dcgettext(((void *)0), "invalid context: %s", 5),
  ...
  if (setexeccon(context_str(con)) != 0)
    ((!!sizeof(struct {
      _Static_assert(1, "verify_expr ("
                        ...
                        ", "
                        "(error (1, (*__errno_location ()), dcgettext (((void "
                        "*)0), \"unable to set security context %s\", 5), "
                        "quote (context_str (con))), assume (false))"
                        ")");
      int _gl_dummy;
    }))
         ? ((error(
                 1, (*__errno_location()),
                 dcgettext(((void *)0), "unable to set security context %s", 5),
                 quote(context_str(con))),
             ((0) ? (void)0 : __builtin_unreachable())))
         : ((error(
                 1, (*__errno_location()),
