...
static struct option const longopts[] = {
    ...
    {"additional-suffix", 1, ((void *)0), ADDITIONAL_SUFFIX_OPTION},
    ...
    {"-io-blksize", 1, ((void *)0), IO_BLKSIZE_OPTION},
...
static void set_suffix_length(uintmax_t n_units, enum Split_type split_type) {
  ...
  if (split_type == type_chunk_bytes || split_type == type_chunk_lines ||
    ...
    if (numeric_suffix_start) {
      uintmax_t n_start;
      strtol_error e =
          xstrtoumax(numeric_suffix_start, ((void *)0), 10, &n_start, "");
  ...
  if (suffix_length) {
    if (suffix_length < suffix_length_needed) {
      ((!!sizeof(struct {
        _Static_assert(1, "verify_expr ("
                          "1"
                          ", "
                          "(error (1, 0, dcgettext (((void *)0), \"the suffix "
                          "length needs to be at least %\"\"l\" \"u\", 5), "
                          "suffix_length_needed), assume (false))"
                          ")");
        int _gl_dummy;
      }))
           ? ((error(1, 0,
    ...
    suffix_length =
        (((2) > (suffix_length_needed)) ? (2) : (suffix_length_needed));
}
...
void usage(int status) {
  if (status != 0)
    ...
    printf(dcgettext(((void *)0), "Usage: %s [OPTION]... [FILE [PREFIX]]\n", 5)
    ...
    fprintf(
        ...
        dcgettext(
            ...
            "SUFFIX to file names\n  -b, --bytes=SIZE        put SIZE bytes "
            "per output file\n  -C, --line-bytes=SIZE   put at most SIZE bytes "
            "of records per output file\n  -d                      use numeric "
            "suffixes starting at 0, not alphabetic\n      "
            "--numeric-suffixes[=FROM]  same as -d, but allow setting the "
            "start value\n  -x                      use hex suffixes starting "
            "at 0, not alphabetic\n      --hex-suffixes[=FROM]  same as -x, "
            "but allow setting the start value\n  -e, --elide-empty-files  do "
            "not generate empty output files with '-n'\n      --filter=COMMAND "
            "   write to shell COMMAND; file name is $FILE\n  -l, "
            "--lines=NUMBER      put NUMBER lines/records per output file\n  "
            "-n, --number=CHUNKS     generate CHUNKS output files; see "
            "explanation below\n  -t, --separator=SEP     use SEP instead of "
            "newline as the record separator;\n                            "
    ...
    fputs_unlocked(
        dcgettext(((void *)0),
                  "      --verbose           print a diagnostic just before "
    ...
    fputs_unlocked(
        dcgettext(
            ((void *)0),
            "\nCHUNKS may be:\n  N       split into N files based on size of "
            "input\n  K/N     output Kth of N to stdout\n  l/N     split into "
            "N files without splitting lines/records\n  l/K/N   output Kth of "
            "N to stdout without splitting lines/records\n  r/N     like 'l' "
            "but use round robin distribution\n  r/K/N   likewise but only "
  ...
  new_name:
    ...
    ((!!sizeof(struct {
      _Static_assert(1, "verify_expr ("
                        "1"
                        ", "
                        "(error (1, 0, dcgettext (((void *)0), \"output file "
                        "suffixes exhausted\", 5)), assume (false))"
                        ")");
      int _gl_dummy;
    }))
         ? ((error(1, 0,
                   dcgettext(((void *)0), "output file suffixes exhausted", 5)),
             ((0) ? (void)0 : __builtin_unreachable())))
         : ((error(1, 0,
                   dcgettext(((void *)0), "output file suffixes exhausted", 5)),
             ((0) ? (void)0 : __builtin_unreachable()))));
...
static int create(char const *name) {
  if (!filter_command) {
    if (verbose)
      fprintf(stdout, dcgettext(((void *)0), "creating file %s\n", 5),
              quotearg_style(shell_escape_always_quoting_style, name));

    int fd = open_safer(name, 01 | 0100 | 0,
      ...
      ((!!sizeof(struct {
        _Static_assert(
            1, "verify_expr ("
               "1"
               ", "
               "(error (1, 0, dcgettext (((void *)0), \"%s would overwrite "
               "input; aborting\", 5), quotearg_style "
               "(shell_escape_always_quoting_style, name)), assume (false))"
               ")");
        int _gl_dummy;
      }))
           ? ((error(1, 0,
                     dcgettext(((void *)0),
                               "%s would overwrite input; aborting", 5),
                     quotearg_style(shell_escape_always_quoting_style, name)),
               ((0) ? (void)0 : __builtin_unreachable())))
           : ((error(1, 0,
                     dcgettext(((void *)0),
               ...
               ((0) ? (void)0 : __builtin_unreachable()))));
    if (ftruncate(fd, 0) != 0 &&
        (((((out_stat_buf.st_mode)) & 0170000) == (0100000)) ||
         ((&out_stat_buf)->st_mode - (&out_stat_buf)->st_mode)))
      ((!!sizeof(struct {
        _Static_assert(
            1, "verify_expr ("
               "1"
    ...
    if (setenv("FILE", name, 1) != 0)
      ((!!sizeof(struct {
        _Static_assert(
            ...
            ", "
            "(error (1, (*__errno_location ()), dcgettext (((void *)0), "
            "\"failed to set FILE environment variable\", 5)), assume (false))"
            ")");
        int _gl_dummy;
      }))
           ? ((error(1, (*__errno_location()),
                     dcgettext(((void *)0),
                               "failed to set FILE environment variable", 5)),
               ((0) ? (void)0 : __builtin_unreachable())))
           : ((error(1, (*__errno_location()),
                     dcgettext(((void *)0),
                               "failed to set FILE environment variable", 5)),
               ((0) ? (void)0 : __builtin_unreachable()))));
    if (verbose)
      fprintf(stdout, dcgettext(((void *)0), "executing with FILE=%s\n", 5),
              quotearg_n_style_colon(0, shell_escape_quoting_style, name));
    if (pipe(fd_pair) != 0)
      ((!!sizeof(struct {
        _Static_assert(1,
                       ...
                       "*)0), \"failed to create pipe\", 5)), assume (false))"
                       ")");
        int _gl_dummy;
      }))
           ? ((error(1, (*__errno_location()),
                     dcgettext(((void *)0), "failed to create pipe", 5)),
               ((0) ? (void)0 : __builtin_unreachable())))
           : ((error(1, (*__errno_location()),
                     dcgettext(((void *)0), "failed to create pipe", 5)),
               ((0) ? (void)0 : __builtin_unreachable()))));
    ...
    if (child_pid == 0) {
          ...
          ((!!sizeof(struct {
            _Static_assert(
                1, "verify_expr ("
                   ...
                   ", "
                   "(error (1, (*__errno_location ()), dcgettext (((void *)0), "
                   "\"closing prior pipe\", 5)), assume (false))"
                   ")");
            int _gl_dummy;
          }))
               ? ((error(1, (*__errno_location()),
                         dcgettext(((void *)0), "closing prior pipe", 5)),
                   ((0) ? (void)0 : __builtin_unreachable())))
               : ((error(1, (*__errno_location()),
                         dcgettext(((void *)0), "closing prior pipe", 5)),
                   ((0) ? (void)0 : __builtin_unreachable()))));
      if (close(fd_pair[1]))
        ((!!sizeof(struct {
          _Static_assert(1,
                         ...
                         ", "
                         "(error (1, (*__errno_location ()), dcgettext (((void "
                         "*)0), \"closing output pipe\", 5)), assume (false))"
                         ")");
          int _gl_dummy;
        }))
             ? ((error(1, (*__errno_location()),
                       dcgettext(((void *)0), "closing output pipe", 5)),
                 ((0) ? (void)0 : __builtin_unreachable())))
             : ((error(1, (*__errno_location()),
                       dcgettext(((void *)0), "closing output pipe", 5)),
                 ((0) ? (void)0 : __builtin_unreachable()))));
          ...
          ((!!sizeof(struct {
            _Static_assert(
                1, "verify_expr ("
                   ...
                   ", "
                   "(error (1, (*__errno_location ()), dcgettext (((void *)0), "
                   "\"moving input pipe\", 5)), assume (false))"
                   ")");
            int _gl_dummy;
          }))
               ? ((error(1, (*__errno_location()),
                         dcgettext(((void *)0), "moving input pipe", 5)),
                   ((0) ? (void)0 : __builtin_unreachable())))
               : ((error(1, (*__errno_location()),
                         dcgettext(((void *)0), "moving input pipe", 5)),
                   ((0) ? (void)0 : __builtin_unreachable()))));
          ...
          ((!!sizeof(struct {
            _Static_assert(
                1, "verify_expr ("
                   ...
                   ", "
                   "(error (1, (*__errno_location ()), dcgettext (((void *)0), "
                   "\"closing input pipe\", 5)), assume (false))"
                   ")");
            int _gl_dummy;
          }))
               ? ((error(1, (*__errno_location()),
                         dcgettext(((void *)0), "closing input pipe", 5)),
                   ((0) ? (void)0 : __builtin_unreachable())))
               : ((error(1, (*__errno_location()),
                         dcgettext(((void *)0), "closing input pipe", 5)),
                   ((0) ? (void)0 : __builtin_unreachable()))));
      ...
      execl(shell_prog, last_component(shell_prog), "-c", filter_command,
            (char *)((void *)0));
      ((!!sizeof(struct {
        _Static_assert(1,
                       "verify_expr ("
                       ...
                       ", "
                       "(error (1, (*__errno_location ()), dcgettext (((void "
                       "*)0), \"failed to run command: \\\"%s -c %s\\\"\", 5), "
                       "shell_prog, filter_command), assume (false))"
                       ")");
        int _gl_dummy;
      }))
           ? ((error(1, (*__errno_location()),
                     dcgettext(((void *)0),
                               "failed to run command: \"%s -c %s\"", 5),
    ...
    if (child_pid == -1)
      ((!!sizeof(struct {
        _Static_assert(1,
                       ...
                       ", "
                       "(error (1, (*__errno_location ()), dcgettext (((void "
                       "*)0), \"fork system call failed\", 5)), assume (false))"
                       ")");
        int _gl_dummy;
      }))
           ? ((error(1, (*__errno_location()),
                     dcgettext(((void *)0), "fork system call failed", 5)),
               ((0) ? (void)0 : __builtin_unreachable())))
           : ((error(1, (*__errno_location()),
                     dcgettext(((void *)0), "fork system call failed", 5)),
               ((0) ? (void)0 : __builtin_unreachable()))));
      ...
      ((!!sizeof(struct {
        _Static_assert(
            1, "verify_expr ("
               ...
               ", "
               "(error (1, (*__errno_location ()), dcgettext (((void *)0), "
               "\"failed to close input pipe\", 5)), assume (false))"
               ")");
        int _gl_dummy;
      }))
           ? ((error(1, (*__errno_location()),
                     dcgettext(((void *)0), "failed to close input pipe", 5)),
               ((0) ? (void)0 : __builtin_unreachable())))
           : ((error(1, (*__errno_location()),
                     dcgettext(((void *)0), "failed to close input pipe", 5)),
               ((0) ? (void)0 : __builtin_unreachable()))));
    ...
    if (n_open_pipes == open_pipes_alloc)
      open_pipes =
          x2nrealloc(open_pipes, &open_pipes_alloc, sizeof *open_pipes);
  ...
  if (fp != ((void *)0) && rpl_fclose(fp) != 0 &&
    ...
    ((!!sizeof(struct {
      _Static_assert(
          ...
          "(0, shell_escape_quoting_style, name)), assume (false))"
          ")");
      int _gl_dummy;
    }))
      ...
      ((!!sizeof(struct {
        _Static_assert(
            1, "verify_expr ("
               ...
               ", "
               "(error (1, (*__errno_location ()), dcgettext (((void *)0), "
               "\"waiting for child process\", 5)), assume (false))"
               ")");
        int _gl_dummy;
      }))
           ? ((error(1, (*__errno_location()),
                     dcgettext(((void *)0), "waiting for child process", 5)),
               ((0) ? (void)0 : __builtin_unreachable())))
           : ((error(1, (*__errno_location()),
                     dcgettext(((void *)0), "waiting for child process", 5)),
               ((0) ? (void)0 : __builtin_unreachable()))));
    if ((((signed char)(((wstatus)&0x7f) + 1) >> 1) > 0)) {
      ...
      if (sig != 13) {
        ...
        error(sig + 128, 0,
              ...
              dcgettext(((void *)0), "with FILE=%s, signal %s from command: %s",
                        5),
              quotearg_n_style_colon(0, shell_escape_quoting_style, name),
              signame, filter_command);
      }
      ...
      if (ex != 0)
        error(
            ex, 0,
            dcgettext(((void *)0), "with FILE=%s, exit %d from command: %s", 5),
            quotearg_n_style_colon(0, shell_escape_quoting_style, name), ex,
            filter_command);
    } else {
      ...
      ((!!sizeof(struct {
        _Static_assert(
            1, "verify_expr ("
               "1"
               ", "
               "(error (1, 0, dcgettext (((void *)0), \"unknown status from "
               "command (0x%X)\", 5), wstatus + 0u), assume (false))"
               ")");
        int _gl_dummy;
      }))
           ? ((error(1, 0,
                     dcgettext(((void *)0),
                               "unknown status from command (0x%X)", 5),
                     wstatus + 0u),
               ((0) ? (void)0 : __builtin_unreachable())))
           : ((error(1, 0,
                     dcgettext(((void *)0),
...
static void bytes_split(uintmax_t n_bytes, char *buf, size_t bufsize,
                        size_t initial_read, uintmax_t max_files) {
  size_t n_read;
  ...
  do {
    if (initial_read != (18446744073709551615UL)) {
      ...
      if (!filter_ok && lseek(0, to_write, 1) != -1) {
        to_write = n_bytes;
        new_file_flag = 1;
      }
...
static void lines_split(uintmax_t n_lines, char *buf, size_t bufsize) {
  size_t n_read;
  char *bp, *bp_out, *eob;
...
static void line_bytes_split(uintmax_t n_bytes, char *buf, size_t bufsize) {
  size_t n_read;
  uintmax_t n_out = 0;
  size_t n_hold = 0;
  char *hold = ((void *)0);
...
static void lines_chunk_split(uintmax_t k, uintmax_t n, char *buf,
                              size_t bufsize, size_t initial_read,
                              off_t file_size) {

  ((void)sizeof((n && k <= n && n <= file_size) ? 1 : 0), __extension__({
     if (n && k <= n && n <= file_size)
       ;
     else
       __assert_fail("n && k <= n && n <= file_size", "src/split.c", 867,
                     __extension__ __PRETTY_FUNCTION__);
   }));
  ...
  while (n_written < file_size) {
    ...
    if (n_read == 0)
      break;
    n_read = (((n_read) < (file_size - n_written)) ? (n_read)
                                                   : (file_size - n_written));
    chunk_truncated = 0;
    eob = buf + n_read;
    ...
    while (bp != eob) {
      ...
      off_t skip =
          (((n_read) <
            ((((0) > (chunk_end - n_written)) ? (0) : (chunk_end - n_written))))
               ? (n_read)
               : ((((0) > (chunk_end - n_written)) ? (0)
                                                   : (chunk_end - n_written))));
        ...
        ((!!sizeof(struct {
          _Static_assert(
              1, "verify_expr ("
                 ...
                 "(error (1, (*__errno_location ()), \"%s\", "
                 "quotearg_n_style_colon (0, shell_escape_quoting_style, "
                 "files[i_check].of_name)), assume (false))"
                 ")");
          int _gl_dummy;
        }))
             ? ((error(1, (*__errno_location()), "%s",
                       quotearg_n_style_colon(0, shell_escape_quoting_style,
                                              files[i_check].of_name)),
                 ((0) ? (void)0 : __builtin_unreachable())))
             : ((error(1, (*__errno_location()), "%s",
                       quotearg_n_style_colon(0, shell_escape_quoting_style,
                                              files[i_check].of_name)),
        ...
        ((!!sizeof(struct {
          _Static_assert(
              1, "verify_expr ("
                 ...
                 "(error (1, (*__errno_location ()), \"%s\", "
                 "quotearg_n_style_colon (0, shell_escape_quoting_style, "
                 "files[i_reopen].of_name)), assume (false))"
                 ")");
          int _gl_dummy;
        }))
             ? ((error(1, (*__errno_location()), "%s",
                       quotearg_n_style_colon(0, shell_escape_quoting_style,
                                              files[i_reopen].of_name)),
                 ((0) ? (void)0 : __builtin_unreachable())))
             : ((error(1, (*__errno_location()), "%s",
                       quotearg_n_style_colon(0, shell_escape_quoting_style,
                                              files[i_reopen].of_name)),
...
static void lines_rr(uintmax_t k, uintmax_t n, char *buf, size_t bufsize,
                     of_t **filesp) {
            ...
            ((!!sizeof(struct {
              ...
              int _gl_dummy;
                 ...
                 : ((error(1, (*__errno_location()), "%s",
                   ...
                   fwrite_unlocked(bp, to_write, 1, stdout) != 1) {
            ...
            ((!!sizeof(struct {
              _Static_assert(
                  1, "verify_expr ("
                     ...
                     "(error (1, (*__errno_location ()), \"%s\", "
                     "quotearg_n_style_colon (0, shell_escape_quoting_style, "
                     "files[i_file].of_name)), assume (false))"
                     ")");
              int _gl_dummy;
            }))
                 ? ((error(1, (*__errno_location()), "%s",
                           quotearg_n_style_colon(0, shell_escape_quoting_style,
                                                  files[i_file].of_name)),
                     ((0) ? (void)0 : __builtin_unreachable())))
                 : ((error(1, (*__errno_location()), "%s",
                           quotearg_n_style_colon(0, shell_escape_quoting_style,
                                                  files[i_file].of_name)),
...
static void parse_chunk(uintmax_t *k_units, uintmax_t *n_units, char *slash) {
  *n_units =
      xdectoumax(slash + 1, 1, (18446744073709551615UL), "",

                 dcgettext(((void *)0), "invalid number of chunks", 5), 0);
  if (slash != optarg) {
    *slash = '\0';
    *k_units = xdectoumax(optarg, 1, *n_units, "",

                          dcgettext(((void *)0), "invalid chunk number", 5), 0);
  }
}
...
int main(int argc, char **argv) {
  ...
  while (1) {
    ...
    c = getopt_long(argc, argv, "0123456789C:a:b:del:n:t:ux", longopts,
                    ((void *)0));
    if (c == -1)
      break;
    ...
    case 'a':
      suffix_length =
          xdectoumax(optarg, 0, (18446744073709551615UL) / sizeof(size_t), "",
                     dcgettext(((void *)0), "invalid suffix length", 5), 0);
      break;
    ...
    case ADDITIONAL_SUFFIX_OPTION:
      if (last_component(optarg) != optarg) {
        error(0, 0,
              ...
              dcgettext(((void *)0),
                        "invalid suffix %s, contains directory separator", 5),
              quote(optarg));
        usage(1);
      }
    ...
    case 'b':
      if (split_type != type_undef)
        do {
          error(0, 0,
                dcgettext(((void *)0), "cannot split in more than one way", 5));
          usage(1);
        } while (0);
      ...
      n_units = xdectoumax(
          ...
          dcgettext(((void *)0), "invalid number of bytes", 5), 0);
      break;
    ...
    case 'l':
      ...
      n_units =
          xdectoumax(optarg, 1, (18446744073709551615UL), "",

                     dcgettext(((void *)0), "invalid number of lines", 5), 0);
      break;
               ...
               : (((off_t)(!(!((off_t)0 < (off_t)-1))
                               ...
                               : ((((off_t)1 << ((sizeof(off_t) * 8) - 2)) -
                                   1) *
                                      2 +
                                  1))))),
          multipliers, dcgettext(((void *)0), "invalid number of bytes", 5), 0);
      break;
    ...
    case 'n':
      ...
      while (((*__ctype_b_loc())[(int)((to_uchar(*optarg)))] &
      ...
      if ((slash = strchr(optarg, '/')))
        ...
        n_units = xdectoumax(
            optarg, 1, (18446744073709551615UL), "",
      ...
      if (!neweol)
        ((!!sizeof(struct {
          _Static_assert(1, "verify_expr ("
                            "1"
                            ", "
                            "(error (1, 0, dcgettext (((void *)0), \"empty "
                            "record separator\", 5)), assume (false))"
                            ")");
          int _gl_dummy;
        }))
             ? ((error(1, 0,
                       dcgettext(((void *)0), "empty record separator", 5)),
                 ((0) ? (void)0 : __builtin_unreachable())))
             : ((error(1, 0,
                       dcgettext(((void *)0), "empty record separator", 5)),
                 ((0) ? (void)0 : __builtin_unreachable()))));
          ...
          ((!!sizeof(struct {
            _Static_assert(
                1, "verify_expr ("
                   "1"
                   ", "
                   "(error (1, 0, dcgettext (((void *)0), \"multi-character "
                   "separator %s\", 5), quote (optarg)), assume (false))"
                   ")");
            int _gl_dummy;
          }))
               ? ((error(1, 0,
                         dcgettext(((void *)0), "multi-character separator %s",
                                   5),
                         quote(optarg)),
                   ((0) ? (void)0 : __builtin_unreachable())))
               : ((error(1, 0,
        ...
        ((!!sizeof(struct {
          _Static_assert(
              1, "verify_expr ("
                 "1"
                 ", "
                 "(error (1, 0, dcgettext (((void *)0), \"multiple separator "
                 "characters specified\", 5)), assume (false))"
                 ")");
          int _gl_dummy;
        }))
             ? ((error(1, 0,
                       dcgettext(((void *)0),
                                 "multiple separator characters specified", 5)),
                 ((0) ? (void)0 : __builtin_unreachable())))
             : ((error(1, 0,
                       dcgettext(((void *)0),
                                 "multiple separator characters specified", 5)),
    ...
    case '9':
      ...
      if (!((void)(&(n_units) == (uintmax_t *)((void *)0)),
            ((!!sizeof(struct {
              _Static_assert(
                  !(!((uintmax_t)0 < (uintmax_t)-1)),
                  "verify_expr ("
                  "! TYPE_SIGNED (uintmax_t)"
                  ", "
                  "(((uintmax_t) -1 / 10 < (n_units) || (uintmax_t) ((n_units) "
                  "* 10 + (c - '0')) < (n_units)) ? false : (((n_units) = "
                  "(n_units) * 10 + (c - '0')), true))"
                  ")");
              int _gl_dummy;
            }))
        ...
        ((!!sizeof(struct {
          _Static_assert(1, "verify_expr ("
                            "1"
                            ", "
                            "(error (1, 0, dcgettext (((void *)0), \"line "
                            "count option -%s%c... is too large\", 5), "
                            "umaxtostr (n_units, buffer), c), assume (false))"
                            ")");
          int _gl_dummy;
        }))
             ? ((error(1, 0,
                       dcgettext(((void *)0),
                                 "line count option -%s%c... is too large", 5),
        ...
        if (strlen(optarg) != strspn(optarg, suffix_alphabet)) {
          error(0, 0,
                (c == 'd')
                    ...
                    dcgettext(((void *)0),
                              "%s: invalid start value for numerical suffix", 5)
                    :
    ...
    case IO_BLKSIZE_OPTION:
      in_blk_size = xdectoumax(
          ...
          ((((9223372036854775807L)) < ((18446744073709551615UL)))
               ...
               : ((18446744073709551615UL))) -
              1,
          multipliers, dcgettext(((void *)0), "invalid IO block size", 5), 0);
      break;
    ...
    case GETOPT_VERSION_CHAR:
      version_etc(stdout, "split", "GNU coreutils", Version,
                  ("Torbjorn Granlund"), ("Richard M. Stallman"),
                  (char *)((void *)0));
      exit(0);
      break;
      ;
  ...
  if (n_units == 0) {
    error(0, 0, "%s: %s", dcgettext(((void *)0), "invalid number of lines", 5),
          quote("0"));
    usage(1);
  }
  ...
  if (!(strcmp(infile, "-") == 0) && fd_reopen(0, infile, 00, 0) < 0)
    ((!!sizeof(struct {
      _Static_assert(
          1, "verify_expr ("
             "1"
             ", "
             "(error (1, (*__errno_location ()), dcgettext (((void *)0), "
             "\"cannot open %s for reading\", 5), quotearg_style "
             "(shell_escape_always_quoting_style, infile)), assume (false))"
             ")");
      int _gl_dummy;
    }))
         ? ((error(1, (*__errno_location()),
  ...
  if (split_type == type_chunk_bytes || split_type == type_chunk_lines) {
    file_size = input_file_size(0, &in_stat_buf, buf, in_blk_size);
    if (file_size < 0)
      ((!!sizeof(struct {
        _Static_assert(
            1, "verify_expr ("
               ...
               ", "
               "(error (1, (*__errno_location ()), dcgettext (((void *)0), "
               "\"%s: cannot determine file size\", 5), quotearg_n_style_colon "
               "(0, shell_escape_quoting_style, infile)), assume (false))"
               ")");
        int _gl_dummy;
      }))
           ? ((error(
                   1, (*__errno_location()),
                   dcgettext(((void *)0), "%s: cannot determine file size", 5),
                   quotearg_n_style_colon(0, shell_escape_quoting_style,
                                          infile)),
               ((0) ? (void)0 : __builtin_unreachable())))
           : ((error(
               ...
               ((0) ? (void)0 : __builtin_unreachable()))));
    initial_read =
        (((file_size) < (in_blk_size)) ? (file_size) : (in_blk_size));
    ...
    if (((off_t)(!(!((off_t)0 < (off_t)-1))
      ...
      ((!!sizeof(struct {
        _Static_assert(1, "verify_expr ("
                          "1"
                          ", "
                          "(error (1, 75, \"%s: %s\", dcgettext (((void *)0), "
                          "\"invalid number of chunks\", 5), quote (umaxtostr "
                          "(n_units, buffer))), assume (false))"
                          ")");
        int _gl_dummy;
      }))
           ? ((error(1, 75, "%s: %s",
                     dcgettext(((void *)0), "invalid number of chunks", 5),
