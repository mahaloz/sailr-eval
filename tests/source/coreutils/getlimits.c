...
void usage(int status) {
  if (status != 0)
    ...
    printf(dcgettext(((void *)0), "Usage: %s\n", 5)

               ,
           program_name);

    fputs_unlocked(dcgettext(((void *)0),
                             "Output platform dependent limits in a format "
...
static void print_DBL(double x) {
             ...
             (-100 < ((-307)) && (308) < 100         ? 3
              ...
              : -1000000 < ((-307)) && (308) < 1000000
                  ...
                  : (((((sizeof(int) * 8) -
                     ...
                     (!((__typeof__(int))0 < (__typeof__(int))-1))))) +
            1)];
  dtoastr(buf, sizeof buf, FTOASTR_LEFT_JUSTIFY, 0, x);
  puts(buf);
}
...
int main(int argc, char **argv) {
  ...
  parse_long_options(argc, argv, "getlimits", "GNU coreutils", "9.1", usage,
                     ("Padraig Brady"), (char const *)((void *)0));
  sprintf(limit + 1,
          "%"
          "l"
          "u",
  ...
  printf("LONG"
         "_OFLOW=%s\n",
         decimal_absval_add_one(limit));
  if ((-0x7fffffffffffffffL - 1L)) {
    sprintf(limit + 1,
            "%"
            "l"
            "d",
            (intmax_t)(-0x7fffffffffffffffL - 1L));
    printf("LONG"
           "_MIN=%s\n",
           limit + 1);
    printf("LONG"
  ...
  sprintf(limit + 1,
          ...
          "l"
          "u",
          (uintmax_t)(0x7fffffffffffffffL * 2UL + 1UL));
  printf("ULONG"
         "_MAX=%s\n",
         limit + 1);
  printf("ULONG"
  ...
  sprintf(limit + 1,
          ...
          "l"
          "u",
          (uintmax_t)(18446744073709551615UL));
  printf("SIZE"
         "_MAX=%s\n",
         limit + 1);
  printf("SIZE"
  ...
  printf("SSIZE"
         ...
         decimal_absval_add_one(limit));
  if (((ssize_t) ~(
          (ssize_t)(!(!((ssize_t)0 < (ssize_t)-1))
                        ? (ssize_t)-1
                        : ((((ssize_t)1 << ((sizeof(ssize_t) * 8) - 2)) - 1) *
                               2 +
                           1))))) {
    sprintf(
        limit + 1,
  ...
  sprintf(limit + 1,
          ...
          "l"
          "u",
          (uintmax_t)(9223372036854775807L));
  printf("INTMAX"
         "_MAX=%s\n",
         limit + 1);
  printf("INTMAX"
  ...
  if ((-9223372036854775807L - 1)) {
    sprintf(limit + 1,
            ...
            "l"
            "d",
            (intmax_t)(-9223372036854775807L - 1));
    printf("INTMAX"
           "_MIN=%s\n",
           limit + 1);
    printf("INTMAX"
  ...
  printf("FLT"
         "_MIN=");
  print_FLT(1.17549435082228750796873653722224568e-38F);
  printf("FLT"
         "_MAX=");
  print_FLT(3.40282346638528859811704183484516925e+38F);
  ;
  printf("DBL"
         "_MIN=");
  print_DBL(((double)2.22507385850720138309023271733240406e-308L));
  printf("DBL"
         "_MAX=");
  print_DBL(((double)1.79769313486231570814527423731704357e+308L));
  ;
  printf("LDBL"
         "_MIN=");
  print_LDBL(3.36210314311209350626267781732175260e-4932L);
  printf("LDBL"
         "_MAX=");
  print_LDBL(1.18973149535723176502126385303097021e+4932L);
  ;
