  ...
  if (status != 0)
    ...
    printf(
        dcgettext(
            ...
            "seconds.  SUFFIX may be 's' for seconds (the default),\n'm' for "
            "minutes, 'h' for hours or 'd' for days.  NUMBER need not be "
            "an\ninteger.  Given two or more arguments, pause for the amount "
...
int main(int argc, char **argv) {
  ...
  parse_gnu_standard_options_only(argc, argv, "sleep", "GNU coreutils", Version,
                                  1, usage, ("Jim Meyering"), ("Paul Eggert"),
                                  (char const *)((void *)0));
