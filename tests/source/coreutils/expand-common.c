...
extern void parse_tab_stops(char const *stops) __attribute__((__nonnull__));
...
static char *stdin_argv[] = {(char *)"-", ((void *)0)
    ...
    if ((18446744073709551615UL) < column_width)
      ((!!sizeof(struct {
        _Static_assert(1, "verify_expr ("
                          "1"
                          ", "
                          "(error (1, 0, dcgettext (((void *)0), \"tabs are "
                          "too far apart\", 5)), assume (false))"
                          ")");
        int _gl_dummy;
      }))
           ? ((error(1, 0, dcgettext(((void *)0), "tabs are too far apart", 5)),
...
extern void parse_tab_stops(char const *stops) {
  ...
  for (; *stops; stops++) {
    if (*stops == ',' || ((*__ctype_b_loc())[(int)((to_uchar(*stops)))] &
      ...
      if (have_tabval) {
        error(0, 0,
              dcgettext(((void *)0), "'/' specifier not at start of number: %s",
                        5),
              quote(stops));
        ok = 0;
      }
      ...
      if (!((void)(&(tabval) == (uintmax_t *)((void *)0)),
            ((!!sizeof(struct {
              _Static_assert(
                  ...
                  ", "
                  "(((uintmax_t) -1 / 10 < (tabval) || (uintmax_t) ((tabval) * "
                  "10 + (*stops - '0')) < (tabval)) ? false : (((tabval) = "
                  "(tabval) * 10 + (*stops - '0')), true))"
                  ")");
              int _gl_dummy;
            }))
        ...
        error(0, 0, dcgettext(((void *)0), "tab stop is too large %s", 5),
              quote(bad_num));
        free(bad_num);
        ok = 0;
      ...
      error(0, 0,
            dcgettext(((void *)0), "tab size contains invalid character(s): %s",
                      5),
            quote(stops));
      ok = 0;
      break;
    ...
    if (tabs[i] == 0)
      ((!!sizeof(struct {
        _Static_assert(1, "verify_expr ("
                          "1"
                          ", "
                          "(error (1, 0, dcgettext (((void *)0), \"tab size "
                          "cannot be 0\", 5)), assume (false))"
                          ")");
        int _gl_dummy;
      }))
           ? ((error(1, 0, dcgettext(((void *)0), "tab size cannot be 0", 5)),
               ((0) ? (void)0 : __builtin_unreachable())))
           : ((error(1, 0, dcgettext(((void *)0), "tab size cannot be 0", 5)),
               ((0) ? (void)0 : __builtin_unreachable()))));
    if (tabs[i] <= prev_tab)
      ((!!sizeof(struct {
        _Static_assert(1, "verify_expr ("
                          "1"
                          ", "
                          "(error (1, 0, dcgettext (((void *)0), \"tab sizes "
                          "must be ascending\", 5)), assume (false))"
                          ")");
        int _gl_dummy;
      }))
           ? ((error(1, 0,
                     dcgettext(((void *)0), "tab sizes must be ascending", 5)),
               ((0) ? (void)0 : __builtin_unreachable())))
           : ((error(1, 0,
                     dcgettext(((void *)0), "tab sizes must be ascending", 5)),
               ((0) ? (void)0 : __builtin_unreachable()))));
  ...
  if (increment_size && extend_size)
    ((!!sizeof(struct {
      _Static_assert(1, "verify_expr ("
                        "1"
                        ", "
                        "(error (1, 0, dcgettext (((void *)0), \"'/' specifier "
                        "is mutually exclusive with '+'\", 5)), assume (false))"
                        ")");
      int _gl_dummy;
    }))
         ? ((error(1, 0,
...
extern void finalize_tab_stops(void) {
  ...
  if (first_free_tab == 0)
    tab_size = max_column_width = extend_size      ? extend_size
...
extern FILE *next_file(FILE *fp) {
  ...
  if (fp) {
    ...
    ((void)sizeof((prev_file) ? 1 : 0), __extension__({
       if (prev_file)
         ;
       else
         __assert_fail("prev_file", "src/expand-common.c", 340,
    ...
    if (err) {
      error(0, err, "%s",
            quotearg_n_style_colon(0, shell_escape_quoting_style, prev_file));
      exit_status = 1;
    }
  }
...
extern void emit_tab_list_info(void) {
  ...
  fputs_unlocked(
      dcgettext(
          ((void *)0),
          "                     The last specified position can be prefixed "
          "with '/'\n                     to specify a tab size to use after "
          "the last\n                     explicitly specified tab stop.  Also "
