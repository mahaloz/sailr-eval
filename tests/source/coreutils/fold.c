...
int main(int argc, char **argv) {
  ...
  while ((optc = getopt_long(argc, argv, shortopts, longopts, ((void *)0))) !=
    ...
    case 'w':
      width =
          xdectoumax(optarg, 1, (18446744073709551615UL) - 8 - 1, "",

                     dcgettext(((void *)0), "invalid number of columns", 5), 0);
      break;
    ...
    case GETOPT_VERSION_CHAR:
      version_etc(stdout, "fold", "GNU coreutils", Version, ("David MacKenzie"),
                  (char *)((void *)0));
      exit(0);
      break;
      ;
