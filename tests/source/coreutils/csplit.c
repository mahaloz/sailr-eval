...
enum { SUPPRESS_MATCHED_OPTION = 0x7f + 1 };
...
static _Noreturn void cleanup_fatal(void) {
  cleanup();
  exit(1);
}

extern void xalloc_die(void) {
  error(0, 0, "%s", dcgettext(((void *)0), "memory exhausted", 5));
  cleanup_fatal();
}
...
static idx_t read_input(char *dest, idx_t max_n_bytes) {
  ...
  if (bytes_read == ((size_t)-1)) {
    error(0, (*__errno_location()), dcgettext(((void *)0), "read error", 5));
    cleanup_fatal();
  }
...
static void keep_new_line(struct buffer_record *b, char *line_start,
                          idx_t line_len) {
  struct line *l;
...
static __attribute__((__malloc__(free_buffer, 1))) struct buffer_record *
get_new_buffer(idx_t min_size) {
  struct buffer_record *new_buffer = xmalloc(sizeof *new_buffer);
  new_buffer->bytes_alloc = 0;
  new_buffer->buffer =
      xpalloc(((void *)0), &new_buffer->bytes_alloc, min_size, -1, 1);
  ...
  if (head == ((void *)0) && !load_buffer())
    ((!!sizeof(struct {
      _Static_assert(1, "verify_expr ("
                        ...
                        "*)0), \"input disappeared\", 5)), assume (false))"
                        ")");
      int _gl_dummy;
    }))
         ? ((error(1, (*__errno_location()),
                   dcgettext(((void *)0), "input disappeared", 5)),
...
static void write_to_file(intmax_t last_line, _Bool ignore, int argnum) {
  ...
  if (first_line > last_line) {
    error(0, 0, dcgettext(((void *)0), "%s: line number out of range", 5),
...
static void handle_line_error(const struct control *p, intmax_t repetition) {
  ...
  fprintf(stderr, dcgettext(((void *)0), "%s: %s: line number out of range", 5),
          program_name, quote(imaxtostr(p->lines_required, buf)));
  if (repetition)
    fprintf(stderr, dcgettext(((void *)0), " on repetition %s\n", 5),
...
static void regexp_error(struct control *p, intmax_t repetition, _Bool ignore) {
  fprintf(stderr, dcgettext(((void *)0), "%s: %s: match not found", 5),
...
static void process_regexp(struct control *p, intmax_t repetition) {
  ...
  if (p->offset >= 0) {
    while (1) {
      ...
      if (ret == -2) {
        error(0, 0,
              dcgettext(((void *)0), "error in regular expression search", 5));
        cleanup_fatal();
      }
      if (ret == -1) {
        line = remove_line();
...
static void create_output_file(void) {
  ...
  if (!fopen_ok) {
    error(
        0, fopen_errno, "%s",
        quotearg_n_style_colon(0, shell_escape_quoting_style, output_filename));
    cleanup_fatal();
  }
  bytes_written = 0;
}
...
static void delete_all_files(_Bool in_signal_handler) {
  ...
  for (int i = files_created; 0 <= --i;) {
    ...
    if (unlink(name) != 0 && (*__errno_location()) != 2 && !in_signal_handler)
...
static void close_output_file(void) {
  if (output_stream) {
    if (ferror_unlocked(output_stream)) {
      error(0, 0, dcgettext(((void *)0), "write error for %s", 5),
...
static void save_line_to_file(const struct cstring *line) {
  ...
  if (l != line->len) {
    error(0, (*__errno_location()),
          dcgettext(((void *)0), "write error for %s", 5),
          quotearg_style(shell_escape_always_quoting_style, output_filename));
    output_stream = ((void *)0);
    cleanup_fatal();
  }
...
static void check_for_offset(struct control *p, char const *str,
                             char const *num) {
    ...
    ((!!sizeof(struct {
      _Static_assert(
          1, "verify_expr ("
             "1"
             ", "
             "(error (1, 0, dcgettext (((void *)0), \"%s: integer expected "
             "after delimiter\", 5), quote (str)), assume (false))"
             ")");
      int _gl_dummy;
    }))
         ? ((error(1, 0,
                   dcgettext(((void *)0),
                             "%s: integer expected after delimiter", 5),
                   quote(str)),
             ((0) ? (void)0 : __builtin_unreachable())))
         : ((error(1, 0,
                   dcgettext(((void *)0),
    ...
    ((!!sizeof(struct {
      _Static_assert(
          1, "verify_expr ("
             "1"
             ", "
             "(error (1, 0, dcgettext (((void *)0), \"%s: '}' is required in "
             "repeat count\", 5), quote (str)), assume (false))"
             ")");
      int _gl_dummy;
    }))
         ? ((error(1, 0,
                   dcgettext(((void *)0), "%s: '}' is required in repeat count",
                             5),
                   quote(str)),
             ((0) ? (void)0 : __builtin_unreachable())))
         : ((error(1, 0,
  ...
  *end = '\0';
  ...
  if (str + 1 == end - 1 && *(str + 1) == '*')
    ...
    if (xstrtoumax(str + 1, ((void *)0), 10, &val, "") != LONGINT_OK ||
        (9223372036854775807L) < val) {
      ((!!sizeof(struct {
        _Static_assert(1, "verify_expr ("
                          "1"
                          ", "
                          "(error (1, 0, dcgettext (((void *)0), \"%s}: "
                          "integer required between '{' and '}'\", 5), quote "
                          "(global_argv[argnum])), assume (false))"
                          ")");
        int _gl_dummy;
      }))
           ? ((error(1, 0,
                     dcgettext(((void *)0),
                               "%s}: integer required between '{' and '}'", 5),
                     quote(global_argv[argnum])),
               ((0) ? (void)0 : __builtin_unreachable())))
           : ((error(1, 0,
                     dcgettext(((void *)0),
...
static struct control *extract_regexp(int argnum, _Bool ignore,
    ...
    ((!!sizeof(struct {
      _Static_assert(
          1, "verify_expr ("
             "1"
             ", "
             "(error (1, 0, dcgettext (((void *)0), \"%s: closing delimiter "
             "'%c' missing\", 5), str, delim), assume (false))"
             ")");
      int _gl_dummy;
    }))
         ? ((error(1, 0,
                   dcgettext(((void *)0), "%s: closing delimiter '%c' missing",
                             5),
                   str, delim),
             ((0) ? (void)0 : __builtin_unreachable())))
         : ((error(1, 0,
  ...
  if (err) {
    error(0, 0, dcgettext(((void *)0), "%s: invalid regular expression: %s", 5),
          quote(str), err);
    cleanup_fatal();
  }
      ...
      if (xstrtoumax(argv[i], ((void *)0), 10, &val, "") != LONGINT_OK ||
        ...
        ((!!sizeof(struct {
          _Static_assert(1,
                         ...
                         "1"
                         ", "
                         "(error (1, 0, dcgettext (((void *)0), \"%s: invalid "
                         "pattern\", 5), quote (argv[i])), assume (false))"
                         ")");
          int _gl_dummy;
        }))
             ? ((error(1, 0, dcgettext(((void *)0), "%s: invalid pattern", 5),
                       quote(argv[i])),
                 ((0) ? (void)0 : __builtin_unreachable())))
             : ((error(1, 0, dcgettext(((void *)0), "%s: invalid pattern", 5),
                       quote(argv[i])),
        ...
        ((!!sizeof(struct {
          _Static_assert(
              1, "verify_expr ("
                 "1"
                 ", "
                 "(error (1, 0, dcgettext (((void *)0), \"%s: line number must "
                 "be greater than zero\", 5), argv[i]), assume (false))"
                 ")");
          int _gl_dummy;
        }))
             ? ((error(1, 0,
        ...
        ((!!sizeof(struct {
          _Static_assert(
              1, "verify_expr ("
                 "1"
                 ", "
                 "(error (1, 0, dcgettext (((void *)0), \"line number %s is "
                 "smaller than preceding line number, %s\", 5), quote "
                 "(argv[i]), imaxtostr (last_val, buf)), assume (false))"
                 ")");
          int _gl_dummy;
        }))
             ? ((error(1, 0,
                       dcgettext(((void *)0),
                                 "line number %s is smaller than preceding "
                                 "line number, %s",
                                 5),
...
static void check_format_conv_type(char *format, int flags) {
  ...
  case 0:
    ((!!sizeof(struct {
      _Static_assert(1, "verify_expr ("
                        ...
                        "conversion specifier in suffix\", 5)), assume (false))"
                        ")");
      int _gl_dummy;
    }))
         ? ((error(1, 0,
                   dcgettext(((void *)0),
                             "missing conversion specifier in suffix", 5)),
             ((0) ? (void)0 : __builtin_unreachable())))
         : ((error(1, 0,
                   dcgettext(((void *)0),
                             "missing conversion specifier in suffix", 5)),
      ...
      ((!!sizeof(struct {
        _Static_assert(
            1, "verify_expr ("
               "1"
               ", "
               "(error (1, 0, dcgettext (((void *)0), \"invalid conversion "
               "specifier in suffix: %c\", 5), ch), assume (false))"
               ")");
        int _gl_dummy;
      }))
           ? ((error(1, 0,
                     dcgettext(((void *)0),
                               "invalid conversion specifier in suffix: %c", 5),
                     ch),
               ((0) ? (void)0 : __builtin_unreachable())))
           : ((error(1, 0,
                     dcgettext(((void *)0),
      ...
      ((!!sizeof(struct {
        _Static_assert(
            1, "verify_expr ("
               ...
               ", "
               "(error (1, 0, dcgettext (((void *)0), \"invalid conversion "
               "specifier in suffix: \\\\%.3o\", 5), ch), assume (false))"
               ")");
        int _gl_dummy;
      }))
           ? ((error(1, 0,
  ...
  if (flags & ~compatible_flags)
   ...
   1
   , "verify_expr (" "1" ", " "(error (1, 0, dcgettext (((void *)0), \"invalid flags in conversion specification: %%%c%c\", 5), (flags & ~ compatible_flags & FLAG_ALTERNATIVE ? '   1
   , 0, 
   dcgettext (((void *)0), 
   "invalid flags in conversion specification: %%%c%c"
   , 5)
   , (flags & ~ compatible_flags & FLAG_ALTERNATIVE ? '   0
...
max_out (char *format)
{
          ...
          if (percent)
            ((!!sizeof(struct {
              _Static_assert(
                  ...
                  "conversion specifications in suffix\", 5)), assume (false))"
                  ")");
              int _gl_dummy;
            }))
                 ? ((error(
        ...
        ((!!sizeof(struct {
          _Static_assert(
              1, "verify_expr ("
                 ...
                 ", "
                 "(error (1, 0, dcgettext (((void *)0), \"missing %% "
                 "conversion specification in suffix\", 5)), assume (false))"
                 ")");
          int _gl_dummy;
        }))
             ? ((error(1, 0,
                       dcgettext(
                           ((void *)0),
                           "missing %% conversion specification in suffix", 5)),
                 ((0) ? (void)0 : __builtin_unreachable())))
             : ((error(1, 0,
                       dcgettext(
                           ((void *)0),
      ...
      int maxlen = snprintf(((void *)0), 0, format, 0x7fffffff);
      if (maxlen < 0)
        xalloc_die();
      return maxlen;
}
...
main (int argc, char **argv)
{
      ...
      while ((optc = getopt_long(argc, argv, "f:b:kn:sqz", longopts,
                                 ((void *)0))) != -1)
        switch (optc) {
        case 'f':
          prefix = optarg;
        ...
        case 'n':
          digits = xdectoimax(optarg, 0,
                              (((0x7fffffff) < ((9223372036854775807L)))
                                   ? (0x7fffffff)
                                   : ((9223372036854775807L))),
                              "",

                              dcgettext(((void *)0), "invalid number", 5), 0);
          break;
        ...
        case GETOPT_VERSION_CHAR:
          version_etc(stdout, "csplit", "GNU coreutils", Version,
                      ("Stuart Kemp"), ("David MacKenzie"),
                      (char *)((void *)0));
          exit(0);
          break;
          ;
      ...
      idx_t max_digit_string_len =
          (suffix
               ...
               : ((((((((sizeof(int) * 8) -
                       ...
                       484) /
                      485) +
                     (!((__typeof__(int))0 < (__typeof__(int))-1)))) > (digits))
                      ? ((((((sizeof(int) * 8) -
                             (!((__typeof__(int))0 < (__typeof__(int))-1))) *
                                146 +
                            484) /
                      ...
                      : (digits)));
      idx_t filename_size;
      if (__builtin_add_overflow(prefix_len, max_digit_string_len + 1,
                                 &filename_size))
        xalloc_die();
...
usage (int status)
{
      if (status != 0)
        ...
        printf(
            dcgettext(((void *)0), "Usage: %s [OPTION]... FILE PATTERN...\n", 5)
        ...
        fputs_unlocked(
            dcgettext(((void *)0),
                      ...
                      "'xx00', 'xx01', ...,\nand output byte counts of each "
        ...
        fputs_unlocked(
            dcgettext(((void *)0),
                      ...
                      "not remove output files on errors\n",
                      5),
            stdout)

            ;
        fputs_unlocked(dcgettext(((void *)0),
                                 "      --suppress-matched     suppress the "
        ...
        fputs_unlocked(
            dcgettext(((void *)0),
                      ...
                      "digits instead of 2\n  -s, --quiet, --silent      do "
                      "not print counts of output file sizes\n  -z, "
        ...
        fputs_unlocked(
            dcgettext(
                ...
                "not including specified line number\n  /REGEXP/[OFFSET]   "
                "copy up to but not including a matching line\n  "
                "%REGEXP%[OFFSET]   skip to, but not including a matching "
                "line\n  {INTEGER}          repeat the previous pattern "
                "specified number of times\n  {*}                repeat the "
                "previous pattern as many times as possible\n\nA line OFFSET "
                "is an integer optionally preceded by '+' or '-'\n",
                5),
            stdout);
