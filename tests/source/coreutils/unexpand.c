...
enum { CONVERT_FIRST_ONLY_OPTION = 0x7f + 1 };
...
void usage(int status) {
  if (status != 0)
    ...
    printf(dcgettext(((void *)0), "Usage: %s [OPTION]... [FILE]...\n", 5)
           ...
           program_name);
    fputs_unlocked(dcgettext(((void *)0),
                             "Convert blanks in each FILE to tabs, writing to "
                             "standard output.\n",
                             5),
                   stdout)
    ...
    fputs_unlocked(
        dcgettext(((void *)0),
                  ...
                  "initial blanks\n      --first-only  convert only leading "
                  "sequences of blanks (overrides -a)\n  -t, --tabs=N     have "
                  "tabs N characters apart instead of 8 (enables -a)\n",
                  5),
        stdout)
  ...
  while (1) {
    ...
    do {
      ...
      if (convert) {
        ...
        _Bool blank =
            !!((*__ctype_b_loc())[(int)((c))] & (unsigned short int)_ISblank);
            ...
            if (next_tab_column < column)
              ((!!sizeof(struct {
                _Static_assert(1,
                               ...
                               "1"
                               ", "
                               "(error (1, 0, dcgettext (((void *)0), \"input "
                               "line is too long\", 5)), assume (false))"
                               ")");
                int _gl_dummy;
              }))
                   ? ((error(
                           1, 0,
                           dcgettext(((void *)0), "input line is too long", 5)),
...
int main(int argc, char **argv) {
  ...
  while ((c = getopt_long(argc, argv, ",0123456789at:", longopts,
    ...
    case GETOPT_VERSION_CHAR:
      version_etc(stdout, "unexpand", "GNU coreutils", Version,
    ...
    default:
      ...
      if (!((void)(&(tabval) == (uintmax_t *)((void *)0)),
            ((!!sizeof(struct {
              _Static_assert(!(!((uintmax_t)0 < (uintmax_t)-1)),
                             "verify_expr ("
                             "! TYPE_SIGNED (uintmax_t)"
                             ", "
                             "(((uintmax_t) -1 / 10 < (tabval) || (uintmax_t) "
                             "((tabval) * 10 + (c - '0')) < (tabval)) ? false "
                             ": (((tabval) = (tabval) * 10 + (c - '0')), true))"
                             ")");
              int _gl_dummy;
            }))
                 ? ((((uintmax_t)-1 / 10 < (tabval) ||
                      (uintmax_t)((tabval)*10 + (c - '0')) < (tabval))
                         ? 0
                         : (((tabval) = (tabval)*10 + (c - '0')), 1)))
                 : ((((uintmax_t)-1 / 10 < (tabval) ||
                      (uintmax_t)((tabval)*10 + (c - '0')) < (tabval))
                         ? 0
                         : (((tabval) = (tabval)*10 + (c - '0')), 1))))))
        ((!!sizeof(struct {
          _Static_assert(1, "verify_expr ("
                            "1"
                            ", "
                            "(error (1, 0, dcgettext (((void *)0), \"tab stop "
                            "value is too large\", 5)), assume (false))"
                            ")");
          int _gl_dummy;
        }))
             ? ((error(
                     1, 0,
                     dcgettext(((void *)0), "tab stop value is too large", 5)),
                 ((0) ? (void)0 : __builtin_unreachable())))
             : ((error(
                     1, 0,
                     dcgettext(((void *)0), "tab stop value is too large", 5)),
