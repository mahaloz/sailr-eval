...
void usage(int status) {
  if (status != 0)
    ...
    printf(dcgettext(((void *)0),
                     "Usage: %s [OPTION] [FILE]\nWrite totally ordered list "
                     "consistent with the partial ordering in FILE.\n",
                     5)
...
static _Noreturn void tsort(char const *file) {
  ...
  if (!is_stdin && !freopen_safer(file, "r", stdin))
    ((!!sizeof(struct {
      _Static_assert(
          ...
          "(0, shell_escape_quoting_style, file)), assume (false))"
          ")");
      int _gl_dummy;
    }))
  ...
  while (1) {
    ...
    ((void)sizeof((len != 0) ? 1 : 0), __extension__({
       if (len != 0)
         ;
       else
         __assert_fail("len != 0", "src/tsort.c", 458,
                       __extension__ __PRETTY_FUNCTION__);
     }));
    ...
    ((!!sizeof(struct {
      _Static_assert(
          1, "verify_expr ("
             "1"
             ", "
             "(error (1, 0, dcgettext (((void *)0), \"%s: input contains an "
             "odd number of tokens\", 5), quotearg_n_style_colon (0, "
      ...
      int _gl_dummy;
         ...
         ? ((error(1, 0,
                   dcgettext(((void *)0),
                             "%s: input contains an odd number of tokens", 5),
                   quotearg_n_style_colon(0, shell_escape_quoting_style, file)),
             ((0) ? (void)0 : __builtin_unreachable())))
         : ((error(1, 0,
                   dcgettext(((void *)0),
  ...
  while (n_strings > 0) {
    ...
    if (n_strings > 0) {
      ...
      error(0, 0, dcgettext(((void *)0), "%s: input contains a loop:", 5),
            quotearg_n_style_colon(0, shell_escape_quoting_style, file));
      ok = 0;
    ...
    ((!!sizeof(struct {
      _Static_assert(
          1, "verify_expr ("
             "1"
             ", "
             "(error (1, (*__errno_location ()), \"%s\", is_stdin ? dcgettext "
             "(((void *)0), \"standard input\", 5) : quotearg_n_style_colon "
             "(0, shell_escape_quoting_style, file)), assume (false))"
             ")");
      int _gl_dummy;
    }))
         ? ((error(1, (*__errno_location()), "%s",
                   is_stdin ? dcgettext(((void *)0), "standard input", 5)
...
int main(int argc, char **argv) {
  ...
  parse_gnu_standard_options_only(argc, argv, "tsort", "GNU coreutils", Version,
                                  1, usage, ("Mark Kettenis"),
                                  (char const *)((void *)0));
