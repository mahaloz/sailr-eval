  ...
  if (status != 0)
    ...
    printf(
        dcgettext(((void *)0),
                  ...
                  "specified, print name and value pairs for them all.\n\n",
                  5)
...
int main(int argc, char **argv) {
  ...
  while ((optc = getopt_long(argc, argv, "+iu:0", longopts, ((void *)0))) !=
         -1) {
    switch (optc) {
    case '0':
    ...
    case GETOPT_VERSION_CHAR:
      version_etc(stdout, "printenv", "GNU coreutils", Version,
                  ("David MacKenzie"), ("Richard Mlynarik"),
                  (char *)((void *)0));
      exit(0);
      break;
      ;
