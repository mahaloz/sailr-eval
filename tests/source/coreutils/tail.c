...
char const *argmatch_to_argument(void const *value, char const *const *arglist,
                                 void const *vallist, size_t valsize)
    __attribute__((__pure__));
double cl_strtod(char const *, char **__restrict__)
    __attribute__((__nonnull__(1)));
long double cl_strtold(char const *, char **__restrict__)
    __attribute__((__nonnull__(1)));
...
extern int __poll_alias(struct pollfd *__fds, nfds_t __nfds,
                        int __timeout) __asm__(""
                                               "poll");
extern int __poll_chk(struct pollfd *__fds, nfds_t __nfds, int __timeout,
                      long unsigned int __fdslen)
    __attribute__((__access__(__write_only__, 1, 2)));
extern int __poll_chk_warn(struct pollfd *__fds, nfds_t __nfds, int __timeout,
                           long unsigned int __fdslen) __asm__(""
                                                               "__poll_chk")

    __attribute__((__warning__(
        "poll called with fds buffer too small file nfds entries")));

extern __inline __attribute__((__always_inline__))
__attribute__((__gnu_inline__)) __attribute__((__artificial__))
__attribute__((__access__(__write_only__, 1, 2))) int
poll(struct pollfd *__fds, nfds_t __nfds, int __timeout) {
  return ((((__typeof(__nfds))0 < (__typeof(__nfds))-1 ||
            (__builtin_constant_p(__nfds) && (__nfds) > 0)) &&
           __builtin_constant_p(
               (((long unsigned int)(__nfds)) <=
                (__builtin_object_size(__fds, 2 > 1)) / (sizeof(*__fds)))) &&
           (((long unsigned int)(__nfds)) <=
            (__builtin_object_size(__fds, 2 > 1)) / (sizeof(*__fds))))
              ? __poll_alias(__fds, __nfds, __timeout)
              : ((((__typeof(__nfds))0 < (__typeof(__nfds))-1 ||
                   (__builtin_constant_p(__nfds) && (__nfds) > 0)) &&
                  __builtin_constant_p((((long unsigned int)(__nfds)) <=
                                        (__builtin_object_size(__fds, 2 > 1)) /
                                            (sizeof(*__fds)))) &&
                  !(((long unsigned int)(__nfds)) <=
                    (__builtin_object_size(__fds, 2 > 1)) / (sizeof(*__fds))))
                     ? __poll_chk_warn(__fds, __nfds, __timeout,
                                       __builtin_object_size(__fds, 2 > 1))
                     : __poll_chk(__fds, __nfds, __timeout,
                                  __builtin_object_size(__fds, 2 > 1))))
...
extern int __ppoll_chk(struct pollfd *__fds, nfds_t __nfds,
                       ...
                       long unsigned int __fdslen)
    __attribute__((__access__(__write_only__, 1, 2)));
extern int __ppoll_chk_warn(struct pollfd *__fds, nfds_t __nfds,
                            const struct timespec *__timeout,
...
ppoll(struct pollfd *__fds, nfds_t __nfds, const struct timespec *__timeout,
  ...
  return ((((__typeof(__nfds))0 < (__typeof(__nfds))-1 ||
           ...
           (((long unsigned int)(__nfds)) <=
            (__builtin_object_size(__fds, 2 > 1)) / (sizeof(*__fds))))
              ? __ppoll_alias(__fds, __nfds, __timeout, __ss)
              : ((((__typeof(__nfds))0 < (__typeof(__nfds))-1 ||
                   (__builtin_constant_p(__nfds) && (__nfds) > 0)) &&
                  __builtin_constant_p((((long unsigned int)(__nfds)) <=
                                        (__builtin_object_size(__fds, 2 > 1)) /
                  ...
                  !(((long unsigned int)(__nfds)) <=
                    (__builtin_object_size(__fds, 2 > 1)) / (sizeof(*__fds))))
                     ? __ppoll_chk_warn(__fds, __nfds, __timeout, __ss,
                                        __builtin_object_size(__fds, 2 > 1))
                     : __ppoll_chk(__fds, __nfds, __timeout, __ss,
                                   __builtin_object_size(__fds, 2 > 1))))

      ;
}

static inline int is_local_fs_type(unsigned long int magic) {
  switch (magic) {
  case 0x5A3C69F0:
    return 1;
  case 0x61636673:
...
static char const *const follow_mode_string[] = {"descriptor", "name",
                                                 ((void *)0)
...
enum header_mode { multiple_files, always, never };

static uintmax_t max_n_unchanged_stats_between_opens = 5;
...
static struct option const long_options[] = {
    ...
    {"-disable-inotify", 0, ((void *)0), DISABLE_INOTIFY_OPTION},
    {"pid", 1, ((void *)0), PID_OPTION},
    {"-presume-input-pipe", 0, ((void *)0), PRESUME_INPUT_PIPE_OPTION},
    {"quiet", 0, ((void *)0), 'q'},
...
void usage(int status) {
  if (status != 0)
    ...
    fputs_unlocked(
        dcgettext(((void *)0),
                  "  -c, --bytes=[+]NUM       output the last NUM bytes; or "
                  "use -c +NUM to\n                             output "
    ...
    printf(
        dcgettext(
            ...
            "                       with --follow=name, reopen a FILE which "
    ...
    fputs_unlocked(
        dcgettext(((void *)0),
                  "      --pid=PID            with -f, terminate after process "
                  "ID, PID dies\n  -q, --quiet, --silent    never output "
                  "headers giving file names\n      --retry              keep "
                  "trying to open a file if it is inaccessible\n",
                  5),
        stdout)
    ...
    fputs_unlocked(
        dcgettext(((void *)0),
                  "  -s, --sleep-interval=N   with -f, sleep for approximately "
                  "N seconds\n                             (default 1.0) "
                  "between iterations;\n                             with "
    ...
    fputs_unlocked(
        dcgettext(
            ...
            "tail will continue to track\nits end.  This default behavior is "
            "not desirable when you really want to\ntrack the actual name of "
            "the file, not the file descriptor (e.g., log\nrotation).  Use "
            "--follow=name in that case.  That causes tail to track the\nnamed "
...
static void die_pipe(void) {
  raise(13);
  exit(1);
}

static void check_output_alive(void) {
  if (!monitor_output)
    return;
  ...
  if (poll(&pfd, 1, 0) >= 0 && (pfd.revents & (0x008 | 0x010)))
    die_pipe();
}
...
static void record_open_fd(struct File_spec *f, int fd, off_t size,
                           struct stat const *st, int blocking) {
  f->fd = fd;
  f->size = size;
...
static void close_fd(int fd, char const *filename) {
  if (fd != -1 && fd != 0 && close(fd)) {
    error(0, (*__errno_location()),
          dcgettext(((void *)0), "closing %s (fd=%d)", 5),
  ...
  if (n_bytes > 0 && fwrite_unlocked(buffer, 1, n_bytes, stdout) < n_bytes) {
    ...
    ((!!sizeof(struct {
      _Static_assert(1, "verify_expr ("
                        ...
                        "*)0), \"error writing %s\", 5), quotearg_style "
                        "(shell_escape_always_quoting_style, \"standard "
                        "output\")), assume (false))"
                        ")");
      int _gl_dummy;
    }))
...
static uintmax_t dump_remainder(_Bool want_header, char const *pretty_filename,
      ...
      if ((*__errno_location()) != 11)
        ((!!sizeof(struct {
          _Static_assert(1,
                         ...
                         ", "
                         "(error (1, (*__errno_location ()), dcgettext (((void "
                         "*)0), \"error reading %s\", 5), quotearg_style "
                         "(shell_escape_always_quoting_style, "
                         "pretty_filename)), assume (false))"
                         ")");
          int _gl_dummy;
        }))
             ? ((error(1, (*__errno_location()),
...
static off_t xlseek(int fd, off_t offset, int whence, char const *filename) {
  ...
  case 0:
    error(0, (*__errno_location()),
          dcgettext(((void *)0), "%s: cannot seek to offset %s", 5),
          quotearg_n_style_colon(0, shell_escape_quoting_style, filename), s);
    break;
  case 1:
    error(0, (*__errno_location()),
          dcgettext(((void *)0), "%s: cannot seek to relative offset %s", 5),
          quotearg_n_style_colon(0, shell_escape_quoting_style, filename), s);
    break;
  case 2:
    error(
        0, (*__errno_location()),
        dcgettext(((void *)0), "%s: cannot seek to end-relative offset %s", 5),
        quotearg_n_style_colon(0, shell_escape_quoting_style, filename), s);
    break;
  default:
    abort();
  ...
  *read_pos = pos + bytes_read;
  ...
  do {
    ...
    if (pos == start_pos) {
      ...
      *read_pos = start_pos + dump_remainder(0, pretty_filename, fd, end_pos);
      return 1;
    }
    pos -= 8192;
    xlseek(fd, pos, 0, pretty_filename);
...
fremote(int fd, char const *name) {
  ...
  if (err != 0) {
    ...
    default:
      ...
      ((void)sizeof((!"unexpected return value from is_local_fs_type") ? 1 : 0),
       __extension__({
         if (!"unexpected return value from is_local_fs_type")
           ;
         else
           __assert_fail("!\"unexpected return value from is_local_fs_type\"",
                         "src/tail.c", 972, __extension__ __PRETTY_FUNCTION__);
       }));
    }
  }
...
static void recheck(struct File_spec *f, _Bool blocking) {
  ...
  ((void)sizeof((valid_file_spec(f)) ? 1 : 0), __extension__({
     if (valid_file_spec(f))
       ;
     else
       __assert_fail("valid_file_spec (f)", "src/tail.c", 994,
  ...
  if (!disable_inotify && !lstat(f->name, &new_stats) &&
    ...
    error(0, 0,
          dcgettext(((void *)0),
                    "%s has been replaced with an untailable symbolic link", 5),
    ...
    if (!f->tailable) {
      if (was_tailable) {
        ...
        error(
            0, f->errnum,
            dcgettext(((void *)0), "%s has become inaccessible", 5),
            quotearg_style(shell_escape_always_quoting_style, pretty_name(f)));
      } else {
      }
      ...
      error(0, (*__errno_location()), "%s",
            quotearg_n_style_colon(0, shell_escape_quoting_style,
                                   pretty_name(f)));
  } else if (!(((((new_stats.st_mode)) & 0170000) == (0100000)) ||
               ((((new_stats.st_mode)) & 0170000) == (0010000)) ||
               ((((new_stats.st_mode)) & 0170000) == (0140000)) ||
               ((((new_stats.st_mode)) & 0170000) == (0020000)))) {
    ok = 0;
    f->errnum = -1;
    f->tailable = 0;
    ...
    if (was_tailable || prev_errnum != f->errnum)
      error(0, 0,
            dcgettext(((void *)0),
                      "%s has been replaced with an untailable file%s", 5),
            quotearg_style(shell_escape_always_quoting_style, pretty_name(f)),
            f->ignore ? dcgettext(((void *)0), "; giving up on this name", 5)
                      : "");
    ...
    error(0, 0,
          dcgettext(((void *)0),
                    "%s has been replaced with an untailable remote file", 5),
          quotearg_style(shell_escape_always_quoting_style, pretty_name(f)));
    f->ignore = 1;
    f->remote = 1;
  } else {
  ...
  if (!ok) {
    ...
    ((void)sizeof((f->fd == -1) ? 1 : 0), __extension__({
       if (f->fd == -1)
         ;
       else
         __assert_fail("f->fd == -1", "src/tail.c", 1071,
                       __extension__ __PRETTY_FUNCTION__);
     }));
    error(0, 0, dcgettext(((void *)0), "%s has become accessible", 5),
          quotearg_style(shell_escape_always_quoting_style, pretty_name(f)));
  } else if (f->fd == -1) {
    ...
    error(0, 0,
          ...
          dcgettext(((void *)0), "%s has appeared;  following new file", 5),
          quotearg_style(shell_escape_always_quoting_style, pretty_name(f)));
    ...
    error(
        ...
        dcgettext(((void *)0), "%s has been replaced;  following new file", 5),
        quotearg_style(shell_escape_always_quoting_style, pretty_name(f)));
...
static void tail_forever(struct File_spec *f, size_t n_files,
  ...
  while (1) {
    ...
    for (i = 0; i < n_files; i++) {
            ...
            ((!!sizeof(struct {
              _Static_assert(
                  1, "verify_expr ("
                     ...
                     ", "
                     "(error (1, (*__errno_location ()), dcgettext (((void "
                     "*)0), \"%s: cannot change nonblocking mode\", 5), "
                     "quotearg_n_style_colon (0, shell_escape_quoting_style, "
                     "name)), assume (false))"
                     ")");
              int _gl_dummy;
                 ...
                 ? ((error(1, (*__errno_location()),
                           dcgettext(((void *)0),
                                     "%s: cannot change nonblocking mode", 5),
                           quotearg_n_style_colon(0, shell_escape_quoting_style,
                                                  name)),
                     ((0) ? (void)0 : __builtin_unreachable())))
                 : ((error(1, (*__errno_location()),
      ...
      if (!f[i].blocking) {
        ...
        if (((((mode)) & 0170000) == (0100000)) && stats.st_size < f[i].size) {
          error(0, 0, dcgettext(((void *)0), "%s: file truncated", 5),
                quotearg_n_style_colon(0, shell_escape_quoting_style, name));
    ...
    if (!any_live_files(f, n_files)) {
      error(0, 0, dcgettext(((void *)0), "no files remaining", 5));
      break;
    }
        ...
        ((!!sizeof(struct {
          _Static_assert(
              1, "verify_expr ("
                 ...
                 "\"cannot read realtime clock\", 5)), assume (false))"
                 ")");
          int _gl_dummy;
        }))
             ? ((error(1, (*__errno_location()),
...
any_non_regular_fifo(const struct File_spec *f, size_t n_files) {
  for (size_t i = 0; i < n_files; i++)
    if (0 <= f[i].fd && !((((f[i].mode)) & 0170000) == (0100000)) &&
...
static size_t wd_hasher(const void *entry, size_t tabsize) {
...
static void check_fspec(struct File_spec *fspec,
  ...
  if (((((fspec->mode)) & 0170000) == (0100000)) &&
      stats.st_size < fspec->size) {
    error(0, 0, dcgettext(((void *)0), "%s: file truncated", 5),
          quotearg_n_style_colon(0, shell_escape_quoting_style, name));
    xlseek(fspec->fd, 0, 0, name);
    fspec->size = 0;
  } else if (((((fspec->mode)) & 0170000) == (0100000)) &&
             stats.st_size == fspec->size &&
...
static void tail_forever_inotify(int wd, struct File_spec *f, size_t n_files,
                                 double sleep_interval,
                                 Hash_table **wd_to_namep) {
  ...
  wd_to_name = hash_initialize(n_files, ((void *)0), wd_hasher, wd_comparator,
                               ((void *)0));
  if (!wd_to_name)
    xalloc_die();
  *wd_to_namep = wd_to_name;
    ...
    if (!f[i].ignore) {
      ...
      if (follow_mode == Follow_name) {
        ...
        if (f[i].parent_wd < 0) {
          if ((*__errno_location()) != 28)
            error(0, (*__errno_location()),
                  dcgettext(((void *)0), "cannot watch parent directory of %s",
                            5),
                  quotearg_style(shell_escape_always_quoting_style, f[i].name));
          else
            error(0, 0,
                  dcgettext(((void *)0), "inotify resources exhausted", 5));
      ...
      if (f[i].wd < 0) {
        ...
        if ((*__errno_location()) == 28 || (*__errno_location()) == 12) {
          ...
          error(0, 0, dcgettext(((void *)0), "inotify resources exhausted", 5));
          break;
        } else if ((*__errno_location()) != f[i].errnum)
          error(0, (*__errno_location()),
                dcgettext(((void *)0), "cannot watch %s", 5),
                quotearg_style(shell_escape_always_quoting_style, f[i].name));
        continue;
      }
    ...
    if (!f[i].ignore) {
      ...
      if (follow_mode == Follow_name)
        ...
        if (stat(f[i].name, &stats) == 0 &&
          ...
          error(0, (*__errno_location()),
                dcgettext(((void *)0), "%s was replaced", 5),
                quotearg_style(shell_escape_always_quoting_style,
                               pretty_name(&(f[i]))));
          return;
        }
  ...
  while (1) {
    ...
    if (follow_mode == Follow_name && !reopen_inaccessible_files &&
        hash_get_n_entries(wd_to_name) == 0)
      ((!!sizeof(struct {
        _Static_assert(1, "verify_expr ("
                          "1"
                          ", "
                          "(error (1, 0, dcgettext (((void *)0), \"no files "
                          "remaining\", 5)), assume (false))"
                          ")");
        int _gl_dummy;
      }))
           ? ((error(1, 0, dcgettext(((void *)0), "no files remaining", 5)),
               ((0) ? (void)0 : __builtin_unreachable())))
           : ((error(1, 0, dcgettext(((void *)0), "no files remaining", 5)),
               ((0) ? (void)0 : __builtin_unreachable()))));
      ...
      do {
        ...
        if (pid) {
          ...
          if (writer_is_dead || sleep_interval <= 0)
            delay = 0;
          else if (sleep_interval < 0x7fffffff / 1000 - 1) {
      ...
      if (file_change < 0)
        ((!!sizeof(struct {
          _Static_assert(1, "verify_expr ("
                            ...
                            ", "
                            "(error (1, (*__errno_location ()), dcgettext "
                            "(((void *)0), \"error waiting for inotify and "
                            "output events\", 5)), assume (false))"
                            ")");
          int _gl_dummy;
        }))
             ? ((error(1, (*__errno_location()),
        ...
        ((!!sizeof(struct {
          _Static_assert(
              1, "verify_expr ("
                 ...
                 ", "
                 "(error (1, (*__errno_location ()), dcgettext (((void *)0), "
                 "\"error reading inotify event\", 5)), assume (false))"
                 ")");
          int _gl_dummy;
        }))
             ? ((error(
      ...
      for (i = 0; i < n_files; i++) {
        if (ev->wd == f[i].parent_wd) {
          error(0, 0,
                ...
                dcgettext(((void *)0),
                          "directory containing watched file was removed", 5));
          return;
        }
      }
    }
    ...
    if (ev->len) {
      ...
      if (!deleting && new_wd < 0) {
        if ((*__errno_location()) == 28 || (*__errno_location()) == 12) {
          ...
          error(0, (*__errno_location()),
                dcgettext(((void *)0), "cannot watch %s", 5),
                quotearg_style(shell_escape_always_quoting_style, f[j].name));
        }
      }
...
tail_bytes(char const *pretty_filename, int fd, uintmax_t n_bytes,
  ...
  if (from_start) {
    ...
    if (end_pos <= (off_t)((0 < (stats).st_blksize &&
                            (stats).st_blksize <= ((size_t)-1) / 8 + 1)
                               ? (stats).st_blksize
                               : 512))
...
tail_lines(char const *pretty_filename, int fd, uintmax_t n_lines,
  ...
  if (from_start) {
    ...
    if (t)
      return t < 0;
    *read_pos +=
        dump_remainder(0, pretty_filename, fd, (18446744073709551615UL));
  } else {
    off_t start_pos = -1;
    off_t end_pos;

    if (!presume_input_pipe && ((((stats.st_mode)) & 0170000) == (0100000))

        && (start_pos = lseek(fd, 0, 1)) != -1 &&
        start_pos < (end_pos = lseek(fd, 0, 2))) {
      *read_pos = end_pos;
      if (end_pos != 0 && !file_lines(pretty_filename, fd, n_lines, start_pos,
                                      end_pos, read_pos))
        return 0;
    } else {
...
tail(char const *filename, int fd, uintmax_t n_units, uintmax_t *read_pos) {
  *read_pos = 0;
  if (count_lines)
      ...
      if (fstat(fd, &stats) < 0) {
        ...
        error(
            ...
            quotearg_style(shell_escape_always_quoting_style, pretty_name(f)));
                   ...
                   ((((stats.st_mode)) & 0170000) == (0010000)) ||
                   ((((stats.st_mode)) & 0170000) == (0140000)) ||
                   ((((stats.st_mode)) & 0170000) == (0020000)))) {
        ok = 0;
        f->errnum = -1;
        f->tailable = 0;
        f->ignore = !reopen_inaccessible_files;
        error(0, 0,
              dcgettext(((void *)0),
                        "%s: cannot follow end of this type of file%s", 5),
              quotearg_n_style_colon(0, shell_escape_quoting_style,
                                     pretty_name(f)),
              f->ignore ? dcgettext(((void *)0), "; giving up on this name", 5)
                        : "");
    ...
    ((!!sizeof(struct {
      _Static_assert(
          1, "verify_expr ("
             "1"
             ", "
             "(error (1, (*__errno_location ()), \"%s: %s\", dcgettext (((void "
             "*)0), \"invalid number\", 5), quote (argv[1])), assume (false))"
             ")");
      int _gl_dummy;
    }))
...
static void parse_options(int argc, char **argv, uintmax_t *n_units,
                          enum header_mode *header_mode,
                          double *sleep_interval) {
  int c;

  while ((c = getopt_long(argc, argv, "c:n:fFqs:vz0123456789", long_options,
                          ((void *)0))) != -1) {
    switch (c) {
    case 'F':
      forever = 1;
    ...
    case 'n':
      ...
      *n_units = xdectoumax(
          optarg, 0, (18446744073709551615UL), "bkKmMGTPEZY0",
          count_lines ? dcgettext(((void *)0), "invalid number of lines", 5)

                      : dcgettext(((void *)0), "invalid number of bytes", 5),
          0);
      break;
    ...
    case LONG_FOLLOW_OPTION:
      ...
      if (optarg == ((void *)0))
        ...
        follow_mode = ((follow_mode_map)[__xargmatch_internal(
            "--follow", optarg, follow_mode_string,
            (void const *)(follow_mode_map), sizeof *(follow_mode_map),
            argmatch_die, 1)]);
      break;
    ...
    case MAX_UNCHANGED_STATS_OPTION:
      ...
      max_n_unchanged_stats_between_opens = xdectoumax(
          optarg, 0, (18446744073709551615UL), "",
    ...
    case PID_OPTION:
      pid = xdectoumax(
          optarg, 0,
          ((pid_t)(!(!((pid_t)0 < (pid_t)-1))
                       ? (pid_t)-1
                       : ((((pid_t)1 << ((sizeof(pid_t) * 8) - 2)) - 1) * 2 +
                          1))),
          "", dcgettext(((void *)0), "invalid PID", 5), 0);
      break;
        ...
        ((!!sizeof(struct {
          _Static_assert(
              1, "verify_expr ("
                 "1"
                 ", "
                 "(error (1, 0, dcgettext (((void *)0), \"invalid number of "
                 "seconds: %s\", 5), quote (optarg)), assume (false))"
                 ")");
          int _gl_dummy;
        }))
             ? ((error(
                     1, 0,
                     dcgettext(((void *)0), "invalid number of seconds: %s", 5),
                     quote(optarg)),
                 ((0) ? (void)0 : __builtin_unreachable())))
             : ((error(
                     1, 0,
    ...
    case GETOPT_VERSION_CHAR:
      version_etc(stdout, "tail", "GNU coreutils", Version, ("Paul Rubin"),
                  ("David MacKenzie"), ("Ian Lance Taylor"), ("Jim Meyering"),
                  (char *)((void *)0));
      exit(0);
      break;
      ;
    ...
    case '9':
      ((!!sizeof(struct {
        _Static_assert(1, "verify_expr ("
                          "1"
                          ", "
                          "(error (1, 0, dcgettext (((void *)0), \"option used "
                          "in invalid context -- %c\", 5), c), assume (false))"
                          ")");
        int _gl_dummy;
      }))
           ? ((error(1, 0,
                     dcgettext(((void *)0),
                               "option used in invalid context -- %c", 5),
                     c),
               ((0) ? (void)0 : __builtin_unreachable())))
           : ((error(1, 0,
                     dcgettext(((void *)0),
  ...
  if (pid && !forever)
    ...
    error(0, 0,
          dcgettext(((void *)0),
                    "warning: --pid=PID is not supported on this system", 5));
    pid = 0;
  }
}
...
static size_t ignore_fifo_and_pipe(struct File_spec *f, size_t n_files) {
  ...
  for (size_t i = 0; i < n_files; i++) {
    ...
    _Bool is_a_fifo_or_pipe =
        ((strcmp(f[i].name, "-") == 0) && !f[i].ignore && 0 <= f[i].fd &&
         (((((f[i].mode)) & 0170000) == (0010000))
...
int main(int argc, char **argv) {
      ...
      ((!!sizeof(struct {
        _Static_assert(
            1, "verify_expr ("
               "1"
               ", "
               "(error (1, 0, dcgettext (((void *)0), \"cannot follow %s by "
               "name\", 5), quotearg_style (shell_escape_always_quoting_style, "
               "\"-\")), assume (false))"
               ")");
        int _gl_dummy;
      }))
           ? ((error(1, 0,
                     dcgettext(((void *)0), "cannot follow %s by name", 5),
                     quotearg_style(shell_escape_always_quoting_style, "-")),
               ((0) ? (void)0 : __builtin_unreachable())))
           : ((error(1, 0,
                     dcgettext(((void *)0), "cannot follow %s by name", 5),
  ...
  if (forever && ignore_fifo_and_pipe(F, n_files)) {
    ...
    if (fstat(1, &out_stat) < 0)
      ((!!sizeof(struct {
        _Static_assert(1,
                       ...
                       ", "
                       "(error (1, (*__errno_location ()), dcgettext (((void "
                       "*)0), \"standard output\", 5)), assume (false))"
                       ")");
        int _gl_dummy;
      }))
           ? ((error(1, (*__errno_location()),
                     dcgettext(((void *)0), "standard output", 5)),
               ((0) ? (void)0 : __builtin_unreachable())))
           : ((error(1, (*__errno_location()),
                     dcgettext(((void *)0), "standard output", 5)),
               ((0) ? (void)0 : __builtin_unreachable()))));
    ...
    if (!disable_inotify) {
      ...
      error(0, (*__errno_location()),
            dcgettext(((void *)0),
                      "inotify cannot be used, reverting to polling", 5));
    }
