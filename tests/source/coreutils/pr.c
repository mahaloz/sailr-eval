...
static void getoptnum(char const *n_str, int min, int *num, char const *errfmt);
...
enum { COLUMNS_OPTION = 0x7f + 1, PAGES_OPTION };
...
static void integer_overflow(void) {
  ((!!sizeof(struct {
    _Static_assert(1, "verify_expr ("
                      "1"
                      ", "
                      "(error (1, 0, dcgettext (((void *)0), \"integer "
                      "overflow\", 5)), assume (false))"
                      ")");
    int _gl_dummy;
  }))
       ? ((error(1, 0, dcgettext(((void *)0), "integer overflow", 5)),
           ((0) ? (void)0 : __builtin_unreachable())))
       : ((error(1, 0, dcgettext(((void *)0), "integer overflow", 5)),
           ((0) ? (void)0 : __builtin_unreachable()))));
}

__attribute__((__pure__)) static unsigned int cols_ready_to_print(void) {
  COLUMN *q;
  unsigned int i;
  unsigned int n;
...
static void parse_column_count(char const *s) {
  getoptnum(s, 1, &columns,
            dcgettext(((void *)0), "invalid number of columns", 5));
  explicit_columns = 1;
}
...
int main(int argc, char **argv) {
  ...
  n_files = 0;
  file_names = (argc > 1 ? xnmalloc(argc - 1, sizeof(char *)) : ((void *)0));
  ...
  while (1) {
    ...
    if (((unsigned int)(c) - '0' <= 9)) {
      ...
      if (n_digits + 1 >= n_alloc)
        column_count_string =
            ((!!sizeof(struct {
              _Static_assert(sizeof *(column_count_string) == 1,
                             "verify_expr ("
                             "sizeof *(column_count_string) == 1"
                             ", "
      ...
      if (!optarg)
        ((!!sizeof(struct {
          _Static_assert(1, "verify_expr ("
                            ...
                            "\"'--pages=FIRST_PAGE[:LAST_PAGE]' missing "
                            "argument\", 5)), assume (false))"
                            ")");
          int _gl_dummy;
        }))
             ? ((error(1, 0,
        ...
        ((!!sizeof(struct {
          _Static_assert(1,
                         ...
                         "1"
                         ", "
                         "(error (1, 0, dcgettext (((void *)0), \"invalid page "
                         "range %s\", 5), quote (optarg)), assume (false))"
                         ")");
          int _gl_dummy;
        }))
             ? ((error(1, 0, dcgettext(((void *)0), "invalid page range %s", 5),
                       quote(optarg)),
                 ((0) ? (void)0 : __builtin_unreachable())))
             : ((error(1, 0, dcgettext(((void *)0), "invalid page range %s", 5),
                       quote(optarg)),
    ...
    case 'l':
      getoptnum(optarg, 1, &lines_per_page,
                ...
                dcgettext(((void *)0),
                          "'-l PAGE_LENGTH' invalid number of lines", 5));
      break;
    case 'm':
      parallel_files = 1;
      storing_columns = 0;
    ...
    case 'N':
      skip_count = 0;
      getoptnum(optarg, (-0x7fffffff - 1), &start_line_num,

                dcgettext(((void *)0),
                          "'-N NUMBER' invalid starting line number", 5));
      break;
    case 'o':
      getoptnum(optarg, 0, &chars_per_margin,

                dcgettext(((void *)0), "'-o MARGIN' invalid line offset", 5));
      break;
    case 'r':
    ...
    case 'w':
      ...
      old_w = 1;
      {
        ...
        getoptnum(optarg, 1, &tmp_cpl,
                  ...
                  dcgettext(((void *)0),
                            "'-w PAGE_WIDTH' invalid number of characters", 5));
        if (!truncate_lines)
    ...
    case GETOPT_VERSION_CHAR:
      version_etc(stdout, "pr", "GNU coreutils", Version, ("Pete TerMaat"),
                  ("Roland Huebner"), (char *)((void *)0));
      exit(0);
      break;
      ;
    default:
  ...
  if (!date_format)
    date_format =
        (getenv("POSIXLY_CORRECT") && !hard_locale(2) ? "%b %e %H:%M %Y"
                                                      : "%Y-%m-%d %H:%M");
    ...
    ((!!sizeof(struct {
      _Static_assert(
          1, "verify_expr ("
             "1"
             ", "
             "(error (1, 0, dcgettext (((void *)0), \"cannot specify number of "
             "columns when printing in parallel\", 5)), assume (false))"
             ")");
      int _gl_dummy;
    }))
         ? ((error(1, 0,
                   dcgettext(((void *)0),
                             "cannot specify number of columns when printing "
                             "in parallel",
                             5)),
             ((0) ? (void)0 : __builtin_unreachable())))
         : ((error(1, 0,
    ...
    ((!!sizeof(struct {
      _Static_assert(
          1, "verify_expr ("
             "1"
             ", "
             "(error (1, 0, dcgettext (((void *)0), \"cannot specify both "
             "printing across and printing in parallel\", 5)), assume (false))"
             ")");
      int _gl_dummy;
    }))
         ? ((error(1, 0,
                   dcgettext(((void *)0),
                             "cannot specify both printing across and printing "
                             "in parallel",
                             5)),
             ((0) ? (void)0 : __builtin_unreachable())))
         : ((error(1, 0,
...
static void getoptarg(char *arg, char switch_char, char *character,
  ...
  if (*arg) {
    ...
    if (xstrtol(arg, ((void *)0), 10, &tmp_long, "") != LONGINT_OK ||
        tmp_long <= 0 || 0x7fffffff < tmp_long) {
      error(0, 0x7fffffff < tmp_long ? 75 : (*__errno_location()),
...
static void init_parameters(int number_of_files) {
  ...
  if (numbered_lines) {
    ...
    if (number_separator == '\t')
      number_width =
          (chars_per_number + ((chars_per_default_tab) -
                               ((chars_per_number) % (chars_per_default_tab))));
    else
  ...
  if (__builtin_sub_overflow(chars_per_line - chars_used_by_number, sep_chars,
                             &useful_chars))
    useful_chars = 0;
  ...
  if (chars_per_column < 1)
    ((!!sizeof(struct {
      _Static_assert(1, "verify_expr ("
                        "1"
                        ", "
                        "(error (1, 0, dcgettext (((void *)0), \"page width "
                        "too narrow\", 5)), assume (false))"
                        ")");
      int _gl_dummy;
    }))
         ? ((error(1, 0, dcgettext(((void *)0), "page width too narrow", 5)),
             ((0) ? (void)0 : __builtin_unreachable())))
         : ((error(1, 0, dcgettext(((void *)0), "page width too narrow", 5)),
             ((0) ? (void)0 : __builtin_unreachable()))));
  ...
  if (numbered_lines) {
    ...
    number_buff = xmalloc(
        (((chars_per_number) >
          ((((((sizeof(line_number) * 8) -
               (!((__typeof__(line_number))0 < (__typeof__(line_number))-1))) *
                  146 +
              484) /
             485) +
            (!((__typeof__(line_number))0 < (__typeof__(line_number))-1)))))
             ? (chars_per_number)
             : ((((((sizeof(line_number) * 8) -
                    (!((__typeof__(line_number))0 <
                       (__typeof__(line_number))-1))) *
                       146 +
                   484) /
                  485) +
                 (!((__typeof__(line_number))0 <
  ...
  free(clump_buff);
  clump_buff =
      xmalloc((((8) > (chars_per_input_tab)) ? (8) : (chars_per_input_tab)));
}
static _Bool
...
init_fps(int number_of_files, char **av) {
  ...
  if (parallel_files) {
    ...
    if (number_of_files > 0) {
      ...
      p->name = dcgettext(((void *)0), "standard input", 5);
      p->fp = stdin;
      have_read_stdin = 1;
      p->status = OPEN;
  ...
  if (err)
    ((!!sizeof(struct {
      _Static_assert(1, "verify_expr ("
                        "1"
                        ", "
                        "(error (1, err, \"%s\", quotearg_n_style_colon (0, "
                        "shell_escape_quoting_style, p->name)), assume (false))"
                        ")");
      int _gl_dummy;
    }))
         ? ((error(1, err, "%s",
...
static void init_header(char const *filename, int desc) {
  ...
  if (localtime_rz(localtz, &t.tv_sec, &tm)) {
    size_t bufsize = nstrftime(((void *)0), (18446744073709551615UL),
    ...
    buf = xmalloc(sizeof secbuf +
                  (((10) > (((((((sizeof(int) * 8) - (!((__typeof__(int))0 <
                                                        (__typeof__(int))-1))) *
                                    146 +
                                484) /
                               485) +
  ...
  header_width_available = (chars_per_line - gnu_mbswidth(date_text, 0) -
...
static void init_store_cols(void) {
  ...
  if (__builtin_mul_overflow(lines_per_body, columns, &total_lines) ||
      ...
      __builtin_mul_overflow(total_lines, chars_per_column_1,
                             &chars_if_truncate))
    integer_overflow();
...
static void store_char(char c) {
  if (buff_current >= buff_allocated) {
    ...
    buff = ((!!sizeof(struct {
      _Static_assert(sizeof *(buff) == 1, "verify_expr ("
                                          "sizeof *(buff) == 1"
                                          ", "
                                          "x2realloc (buff, &buff_allocated)"
                                          ")");
      int _gl_dummy;
    }))
                ? (x2realloc(buff, &buff_allocated))
...
static void add_line_number(COLUMN *p) {
...

  {
    ...
    if (number_separator == '\t')
      output_position =
          ((output_position) + ((chars_per_output_tab) -
                                ((output_position) % (chars_per_output_tab))));
  }
...
static void print_white_space(void) {
  ...
  while (goal - h_old > 1 &&
         (h_new = ((h_old) + ((chars_per_output_tab) -
                              ((h_old) % (chars_per_output_tab))))) <= goal) {
...
static void print_char(char c) {
  if (tabify_output) {
    ...
    if (!((*__ctype_b_loc())[(int)((to_uchar(c)))] &
...
static void print_header(void) {
  char page_text
      [256 + (((((sizeof(page_number) * 8) - (!((__typeof__(page_number))0 <
                                                (__typeof__(page_number))-1))) *
                    146 +
                484) /
               485) +
              (!((__typeof__(page_number))0 < (__typeof__(page_number))-1)))];
  int available_width;
  int lhs_spaces;
  int rhs_spaces;
  ...
  if (page_number == 0)
    ((!!sizeof(struct {
      _Static_assert(1, "verify_expr ("
                        "1"
                        ", "
                        "(error (1, 0, dcgettext (((void *)0), \"page number "
                        "overflow\", 5)), assume (false))"
                        ")");
      int _gl_dummy;
    }))
         ? ((error(1, 0, dcgettext(((void *)0), "page number overflow", 5)),
             ((0) ? (void)0 : __builtin_unreachable())))
         : ((error(1, 0, dcgettext(((void *)0), "page number overflow", 5)),
             ((0) ? (void)0 : __builtin_unreachable()))));
  ...
  printf("\n\n%*s%s%*s%s%*s%s\n\n\n", chars_per_margin, "", date_text,
         lhs_spaces, " ", file_text, rhs_spaces, " ", page_text);
  ...
  if (status != 0)
    ...
    fputs_unlocked(
        dcgettext(((void *)0),
                  ...
                  "               unless -a is used. Balance number of lines "
    ...
    fputs_unlocked(
        dcgettext(((void *)0),
                  ...
                  "page length to PAGE_LENGTH (66) lines\n                    "
    ...
    fputs_unlocked(
        dcgettext(((void *)0),
                  "  -m, --merge       print all files in parallel, one in "
    ...
    fputs_unlocked(
        dcgettext(((void *)0),
                  ...
                  "                  is the <TAB> character without -w and "
                  "\'no char\' with -w.\n                    -s[CHAR] turns "
                  "off line truncation of all 3 column\n                    "
