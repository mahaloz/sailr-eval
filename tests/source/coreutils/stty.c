...
enum output_type { changed, all, recoverable };
...
__attribute__((__format__(printf, 1, 2))) static void wrapf(char const *message,
                                                            ...) {
  va_list args;
  char *buf;
  int buflen;
...
void usage(int status) {
  if (status != 0)
    ...
    fputs_unlocked(
        dcgettext(((void *)0),
                  "   eof CHAR      CHAR will send an end of file (terminate "
    ...
    fputs_unlocked(
        dcgettext(((void *)0),
                  ...
                  "CHAR     CHAR will erase the current line\n",
                  5),
        stdout)
    ...
    fputs_unlocked(dcgettext(((void *)0),
                             "\nSpecial settings:\n   N             set the "
                             "input and output speeds to N bauds\n",
                             5),
                   stdout)
    ...
    printf(dcgettext(((void *)0),
               ...
               ,
           tcsetattr_options == 1 ? dcgettext(((void *)0), "on", 5)
                                  : dcgettext(((void *)0), "off", 5));
    fputs_unlocked(dcgettext(((void *)0),
    ...
    fputs_unlocked(
        dcgettext(((void *)0), " * line N        use line discipline N\n", 5),
        stdout)
    ...
    fputs_unlocked(
        dcgettext(
            ((void *)0),
            "   min N         with -icanon, set N characters minimum for a "
    ...
    fputs_unlocked(
        dcgettext(((void *)0),
                  "\nInput settings:\n   [-]brkint     breaks cause an "
                  "interrupt signal\n   [-]icrnl      translate carriage "
                  "return to newline\n   [-]ignbrk     ignore break "
    ...
    fputs_unlocked(dcgettext(((void *)0),
                             " * [-]imaxbel    beep and do not flush a full "
    ...
    fputs_unlocked(dcgettext(((void *)0),
                             " * [-]ixany      let any character restart "
    ...
    fputs_unlocked(dcgettext(((void *)0),
                             " * [-]ofill      use fill (padding) characters "
    ...
    fputs_unlocked(dcgettext(((void *)0),
                             " * [-]onocr      do not print carriage returns "
                             "in the first column\n",
                             5),
                   stdout)
    ...
    fputs_unlocked(
        dcgettext(((void *)0), "   [-]opost      postprocess output\n", 5),
        stdout)
    ...
    fputs_unlocked(dcgettext(((void *)0),
                             "\nLocal settings:\n   [-]crterase   echo erase "
                             "characters as backspace-space-backspace\n",
                             5),
                   stdout)
    ...
    fputs_unlocked(
        dcgettext(((void *)0),
                  ...
                  "echoe settings\n * -crtkill      kill all line by obeying "
                  "the echoctl and echok settings\n",
                  5),
        stdout)
    ...
    fputs_unlocked(
        dcgettext(((void *)0), "   [-]echo       echo input characters\n", 5),
        stdout)

        ;

    fputs_unlocked(
        dcgettext(((void *)0), " * [-]echoctl    same as [-]ctlecho\n", 5),
        stdout)
    ...
    fputs_unlocked(
        dcgettext(((void *)0),
                  ...
                  "a newline after a kill character\n",
                  5),
        stdout)
    ...
    fputs_unlocked(
        dcgettext(((void *)0), " * [-]echoke     same as [-]crtkill\n", 5),
        stdout)

        ;

    fputs_unlocked(dcgettext(((void *)0),
                             "   [-]echonl     echo newline even if not "
    ...
    fputs_unlocked(dcgettext(((void *)0),
                             " * [-]echoprt    echo erased characters "
    ...
    fputs_unlocked(dcgettext(((void *)0),
                             " * [-]extproc    enable \"LINEMODE\"; useful "
    ...
    fputs_unlocked(
        dcgettext(((void *)0), " * [-]flusho     discard output\n", 5), stdout)
    ...
    fputs_unlocked(
        dcgettext(((void *)0), " * [-]prterase   same as [-]echoprt\n", 5),
        stdout)

        ;

    fputs_unlocked(dcgettext(((void *)0),
                             " * [-]tostop     stop background jobs that try "
    ...
    fputs_unlocked(
        dcgettext(((void *)0), " * [-]LCASE      same as [-]lcase\n", 5),
        stdout)
    ...
    fputs_unlocked(
        ...
        ;
    printf(dcgettext(((void *)0), "   crt           same as %s\n", 5)
    ...
    fputs_unlocked(
        dcgettext(((void *)0), " * [-]decctlq    same as [-]ixany\n", 5),
        stdout)
    ...
    fputs_unlocked(
        dcgettext(((void *)0),
                  "   ek            erase and kill characters to their default "
    ...
    fputs_unlocked(
        dcgettext(((void *)0),
                  ...
                  "deviations from stty sane.  In\nsettings, CHAR is taken "
                  "literally, or coded as in ^c, 0x37, 0177 or\n127; special "
...
static void apply_settings(_Bool checking, char const *device_name,
  ...
  for (int k = 1; k < n_settings; k++) {
    ...
    if (!match_found && reversed) {
      error(0, 0, dcgettext(((void *)0), "invalid argument %s", 5),
            quote(arg - 1));
      usage(1);
    }
    if (!match_found) {
        ...
        if ((strcmp(arg, control_info[i].name) == 0)) {
          do {
            if (k == n_settings - 1 || !settings[k + 1]) {
              error(0, 0, dcgettext(((void *)0), "missing argument to %s", 5),
                    quote(arg));
              usage(1);
            }
          } while (0);
    ...
    if (!match_found || not_set_attr) {
      if ((strcmp(arg, "ispeed") == 0)) {
        ...
        *require_set_attr = 1;
        ...
        if (checking)
          continue;
        set_window_size(integer_arg(settings[k], 0x7fffffff), -1, device_name);
      } else if ((strcmp(arg, "cols") == 0) || (strcmp(arg, "columns") == 0)) {
        do {
          if (k == n_settings - 1 || !settings[k + 1]) {
            error(0, 0, dcgettext(((void *)0), "missing argument to %s", 5),
                  quote(arg));
        ...
        if (checking)
          continue;
        set_window_size(-1, integer_arg(settings[k], 0x7fffffff), device_name);
        ...
        ++k;
        mode->c_line = value =
            integer_arg(settings[k], (0x7fffffffffffffffL * 2UL + 1UL));
        if (mode->c_line != value)
          error(0, 0, dcgettext(((void *)0), "invalid line discipline %s", 5),
                quote(settings[k]));
        *require_set_attr = 1;
      }
...
int main(int argc, char **argv) {
  ...
  opterr = 0;
  while ((optc = getopt_long(argc - argi, argv + argi, "-agF:", longopts,
                             ((void *)0))) != -1) {
    switch (optc) {
    case 'a':
      verbose_output = 1;
      ...
      if (file_name)
        ((!!sizeof(struct {
          _Static_assert(1, "verify_expr ("
                            "1"
                            ", "
                            "(error (1, 0, dcgettext (((void *)0), \"only one "
                            "device may be specified\", 5)), assume (false))"
                            ")");
          int _gl_dummy;
        }))
             ? ((error(1, 0,
                       dcgettext(((void *)0),
                                 "only one device may be specified", 5)),
    ...
    case GETOPT_VERSION_CHAR:
      version_etc(stdout, "stty", "GNU coreutils", Version, ("David MacKenzie"),
                  (char *)((void *)0));
      exit(0);
      break;
      ;
  ...
  if (verbose_output && recoverable_output)
    ((!!sizeof(struct {
      _Static_assert(1, "verify_expr ("
                        "1"
                        ", "
                        "(error (1, 0, dcgettext (((void *)0), \"the options "
                        "for verbose and stty-readable output styles are\\n\" "
                        "\"mutually exclusive\", 5)), assume (false))"
                        ")");
      int _gl_dummy;
    }))
         ? ((error(1, 0,
                   dcgettext(((void *)0),
                             "the options for verbose and stty-readable output "
                             "styles are\n"
                             "mutually exclusive",
                             5)),
             ((0) ? (void)0 : __builtin_unreachable())))
    ...
    ((!!sizeof(struct {
      _Static_assert(
          1, "verify_expr ("
             "1"
             ", "
             "(error (1, 0, dcgettext (((void *)0), \"when specifying an "
             "output style, modes may not be set\", 5)), assume (false))"
             ")");
      int _gl_dummy;
    }))
         ? ((error(1, 0,
  ...
  device_name =
      file_name ? file_name : dcgettext(((void *)0), "standard input", 5);

  if (!noargs && !verbose_output && !recoverable_output) {
    static struct termios check_mode;
    apply_settings(1, device_name, argv, argc, &check_mode, &speed_was_set,
                   &require_set_attr);
  }
    ...
    if ((fdflags = rpl_fcntl(0, 3)) == -1 ||
      ...
      ((!!sizeof(struct {
        _Static_assert(
            ...
            "1"
            ", "
            "(error (1, (*__errno_location ()), dcgettext (((void *)0), \"%s: "
            "couldn't reset non-blocking mode\", 5), quotearg_n_style_colon "
            "(0, shell_escape_quoting_style, device_name)), assume (false))"
            ")");
        int _gl_dummy;
      }))
           ? ((error(1, (*__errno_location()),
                     dcgettext(((void *)0),
                               "%s: couldn't reset non-blocking mode", 5),
                     quotearg_n_style_colon(0, shell_escape_quoting_style,
                                            device_name)),
               ((0) ? (void)0 : __builtin_unreachable())))
           : ((error(1, (*__errno_location()),
  ...
  speed_was_set = 0;
  require_set_attr = 0;
  apply_settings(0, device_name, argv, argc, &mode, &speed_was_set,
                 &require_set_attr);
...

      {
        ((!!sizeof(struct {
          _Static_assert(
              ...
              "1"
              ", "
              "(error (1, 0, dcgettext (((void *)0), \"%s: unable to perform "
              "all requested operations\", 5), quotearg_n_style_colon (0, "
          ...
          int _gl_dummy;
             ...
             ? ((error(1, 0,
                       dcgettext(
                           ((void *)0),
                           "%s: unable to perform all requested operations", 5),
                       quotearg_n_style_colon(0, shell_escape_quoting_style,
                                              device_name)),
                 ((0) ? (void)0 : __builtin_unreachable())))
             : ((error(1, 0,
...
set_mode(struct mode_info const *info, _Bool reversed, struct termios *mode) {
  ...
  if (bitsp == ((void *)0)) {
    ...
    if ((strcmp(info->name, "evenp") == 0) ||
        (strcmp(info->name, "parity") == 0)) {
      if (reversed)
        mode->c_cflag = (mode->c_cflag & ~0000400 & ~0000060) | 0000060;
      else
        mode->c_cflag =
            (mode->c_cflag & ~0001000 & ~0000060) | 0000400 | 0000040;
    } else if ((strcmp(info->name, "oddp") == 0)) {
      if (reversed)
        mode->c_cflag = (mode->c_cflag & ~0000400 & ~0000060) | 0000060;
      else
        mode->c_cflag =
            (mode->c_cflag & ~0000060) | 0000040 | 0001000 | 0000400;
    ...
    } else if ((strcmp(info->name, "raw") == 0) ||
               (strcmp(info->name, "cooked") == 0)) {
      ...
      ((!!sizeof(struct {
        _Static_assert(
            1, "verify_expr ("
               "1"
               ", "
               "(error (1, 0, dcgettext (((void *)0), \"%s: no size "
               "information for this device\", 5), quotearg_n_style_colon (0, "
               "shell_escape_quoting_style, device_name)), assume (false))"
               ")");
        int _gl_dummy;
      }))
           ? ((error(1, 0,
                     dcgettext(((void *)0),
                               "%s: no size information for this device", 5),
                     quotearg_n_style_colon(0, shell_escape_quoting_style,
                                            device_name)),
               ((0) ? (void)0 : __builtin_unreachable())))
           : ((error(1, 0,
...
__attribute__((__pure__)) static tcflag_t *
  ...
  for (i = 0; mode_info[i].name != ((void *)0); ++i) {
    ...
    ((void)sizeof((bitsp) ? 1 : 0), __extension__({
       if (bitsp)
         ...
         __assert_fail("bitsp", "src/stty.c", 1953,
...
static void display_recoverable(struct termios *mode) {
  printf("%lx:%lx:%lx:%lx", (unsigned long int)mode->c_iflag,
         (unsigned long int)mode->c_oflag, (unsigned long int)mode->c_cflag,
...
static int strtoul_cc_t(char const *s, int base, char **p, cc_t *result,
                        char delim) {
  unsigned long ul;
...
static struct speed_map const speeds[] = {{"0", 0000000, 0},
                                          {"50", 0000001, 50},
                                          {"75", 0000002, 75},
                                          {"110", 0000003, 110},
                                          {"134", 0000004, 134},
...
__attribute__((__pure__)) static speed_t string_to_baud(char const *arg) {
...
__attribute__((__pure__)) static unsigned long int
...
static unsigned long int integer_arg(char const *s, unsigned long int maxval) {
  return xnumtoumax(s, 0, 0, maxval, "bB",
                    dcgettext(((void *)0), "invalid integer argument", 5), 0);
}
