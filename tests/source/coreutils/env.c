...
void usage(int status) {
  if (status != 0)
    ...
    fputs_unlocked(
        ...
        ;
    fputs_unlocked(dcgettext(((void *)0),
                             "      --block-signal[=SIG]    block delivery of "
                             "SIG signal(s) to COMMAND\n",
                             5),
                   stdout)

        ;
    fputs_unlocked(dcgettext(((void *)0),
                             "      --default-signal[=SIG]  reset handling of "
                             "SIG signal(s) to the default\n",
                             5),
                   stdout)
    ...
    fputs_unlocked(dcgettext(((void *)0),
                             ...
                             "SIG signal(s) to do nothing\n",
                             5),
                   stdout)

        ;
    fputs_unlocked(dcgettext(((void *)0),
                             "      --list-signal-handling  list non default "
                             "signal handling to stderr\n",
                             5),
                   stdout)

        ;
    fputs_unlocked(dcgettext(((void *)0),
                             "  -v, --debug          print verbose information "
    ...
    fputs_unlocked(
        dcgettext(((void *)0),
                  "\nSIG may be a signal name like 'PIPE', or a signal number "
    ...
    if (unsetenv(usvars[i]))
      ((!!sizeof(struct {
        _Static_assert(
            ...
            "EXIT_CANCELED"
            ", "
            "(error (EXIT_CANCELED, (*__errno_location ()), dcgettext (((void "
            "*)0), \"cannot unset %s\", 5), quote (usvars[i])), assume (false))"
            ")");
        int _gl_dummy;
      }))
           ? ((error(EXIT_CANCELED, (*__errno_location()),
                     dcgettext(((void *)0), "cannot unset %s", 5),
                     quote(usvars[i])),
...
__attribute__((__pure__)) static char const *scan_varname(char const *str) {
        ...
        if (dq)
          ((!!sizeof(struct {
            _Static_assert(EXIT_CANCELED,
                           ...
                           "EXIT_CANCELED"
                           ", "
                           "(error (EXIT_CANCELED, 0, dcgettext (((void *)0), "
                           "\"'\\\\c' must not appear in double-quoted -S "
                           "string\", 5)), assume (false))"
                           ")");
            int _gl_dummy;
          }))
      ...
      case '\0':
        ((!!sizeof(struct {
          _Static_assert(
              ...
              "EXIT_CANCELED"
              ", "
              "(error (EXIT_CANCELED, 0, dcgettext (((void *)0), \"invalid "
              "backslash at end of string in -S\", 5)), assume (false))"
              ")");
          int _gl_dummy;
        }))
             ? ((error(EXIT_CANCELED, 0,
      ...
      default:
        ((!!sizeof(struct {
          _Static_assert(
              ...
              ", "
              "(error (EXIT_CANCELED, 0, dcgettext (((void *)0), \"invalid "
              "sequence '\\\\%c' in -S\", 5), newc), assume (false))"
              ")");
          int _gl_dummy;
        }))
             ? ((error(
                     EXIT_CANCELED, 0,
                     dcgettext(((void *)0), "invalid sequence '\\%c' in -S", 5),
                     newc),
                 ((0) ? (void)0 : __builtin_unreachable())))
             : ((error(
                     EXIT_CANCELED, 0,
        ...
        if (!n)
          ((!!sizeof(struct {
            _Static_assert(EXIT_CANCELED,
                           ...
                           ", "
                           "(error (EXIT_CANCELED, 0, dcgettext (((void *)0), "
                           "\"only ${VARNAME} expansion is supported, error "
                           "at: %s\", 5), str), assume (false))"
                           ")");
            int _gl_dummy;
          }))
               ? ((error(EXIT_CANCELED, 0,
                         dcgettext(((void *)0),
                                   "only ${VARNAME} expansion is supported, "
                                   "error at: %s",
                                   5),
                         str),
                   ((0) ? (void)0 : __builtin_unreachable())))
  ...
  if (dq || sq)
    ((!!sizeof(struct {
      _Static_assert(EXIT_CANCELED,
                     ...
                     "EXIT_CANCELED"
                     ", "
                     "(error (EXIT_CANCELED, 0, dcgettext (((void *)0), \"no "
                     "terminating quote in -S string\", 5)), assume (false))"
                     ")");
      int _gl_dummy;
    }))
         ? ((error(EXIT_CANCELED, 0,
                   dcgettext(((void *)0), "no terminating quote in -S string",
                             5)),
             ((0) ? (void)0 : __builtin_unreachable())))
         : ((error(EXIT_CANCELED, 0,
                   dcgettext(((void *)0), "no terminating quote in -S string",
...
static void parse_split_string(char const *str, int *orig_optind,
...
static void parse_signal_action_params(char const *optarg, _Bool set_default) {
  char signame[(
      sizeof "SIGRTMAX" +
      (((((sizeof(int) * 8) - (!((__typeof__(int))0 < (__typeof__(int))-1))) *
             146 +
         484) /
        485) +
  ...
  while (opt_sig) {
    ...
    if (signum == 0)
      error(0, 0, dcgettext(((void *)0), "%s: invalid signal", 5),
            quote(opt_sig));
    if (signum <= 0)
      usage(exit_failure);
...
static void reset_signal_handlers(void) {
  for (int i = 1; i <= ((64 + 1) - 1); i++) {
    ...
    _Bool ignore_errors =
        (signals[i] == DEFAULT_NOERR || signals[i] == IGNORE_NOERR);

    _Bool set_to_default =
        (signals[i] == DEFAULT || signals[i] == DEFAULT_NOERR);
    ...
    if (sig_err && !ignore_errors)
      ((!!sizeof(struct {
        _Static_assert(EXIT_CANCELED,
                       ...
                       ", "
                       "(error (EXIT_CANCELED, (*__errno_location ()), "
                       "dcgettext (((void *)0), \"failed to get signal action "
                       "for signal %d\", 5), i), assume (false))"
                       ")");
        int _gl_dummy;
      }))
           ? ((error(EXIT_CANCELED, (*__errno_location()),
                     dcgettext(((void *)0),
                               "failed to get signal action for signal %d", 5),
                     i),
               ((0) ? (void)0 : __builtin_unreachable())))
           : ((error(EXIT_CANCELED, (*__errno_location()),
                     dcgettext(((void *)0),
    ...
    if (!sig_err) {
      act.__sigaction_handler.sa_handler =
          set_to_default ? ((__sighandler_t)0) : ((__sighandler_t)1);
      sig_err = sigaction(i, &act, ((void *)0));
      if (sig_err && !ignore_errors)
        ((!!sizeof(struct {
          _Static_assert(EXIT_CANCELED,
                         "verify_expr ("
                         ...
                         ", "
                         "(error (EXIT_CANCELED, (*__errno_location ()), "
                         "dcgettext (((void *)0), \"failed to set signal "
                         "action for signal %d\", 5), i), assume (false))"
                         ")");
          int _gl_dummy;
        }))
             ? ((error(EXIT_CANCELED, (*__errno_location()),
    ...
    if (dev_debug) {
      ...
      do {
        if (dev_debug)
          fprintf(stderr, "Reset signal %s (%d) to %s%s\n", signame, i,
...
static void parse_block_signal_params(char const *optarg, _Bool block) {
  char signame[(
      sizeof "SIGRTMAX" +
      (((((sizeof(int) * 8) - (!((__typeof__(int))0 < (__typeof__(int))-1))) *
             146 +
...
static void set_signal_proc_mask(void) {
  ...
  if (sigprocmask(0, ((void *)0), &set))
    ((!!sizeof(struct {
      _Static_assert(
          ...
          ", "
          "(error (EXIT_CANCELED, (*__errno_location ()), dcgettext (((void "
          "*)0), \"failed to get signal process mask\", 5)), assume (false))"
          ")");
      int _gl_dummy;
    }))
         ? ((error(EXIT_CANCELED, (*__errno_location()),
                   dcgettext(((void *)0), "failed to get signal process mask",
                             5)),
             ((0) ? (void)0 : __builtin_unreachable())))
         : ((error(EXIT_CANCELED, (*__errno_location()),
                   dcgettext(((void *)0), "failed to get signal process mask",
  ...
  for (int i = 1; i <= ((64 + 1) - 1); i++) {
    ...
    if (dev_debug && debug_act) {
      ...
      do {
        if (dev_debug)
          fprintf(stderr, "signal %s (%d) mask set to %s\n", signame, i,
                  debug_act);
      } while (0);
    }
  }
  ...
  if (sigprocmask(2, &set, ((void *)0)))
    ((!!sizeof(struct {
      _Static_assert(
          ...
          ", "
          "(error (EXIT_CANCELED, (*__errno_location ()), dcgettext (((void "
          "*)0), \"failed to set signal process mask\", 5)), assume (false))"
          ")");
      int _gl_dummy;
    }))
         ? ((error(EXIT_CANCELED, (*__errno_location()),
                   dcgettext(((void *)0), "failed to set signal process mask",
                             5)),
             ((0) ? (void)0 : __builtin_unreachable())))
         : ((error(EXIT_CANCELED, (*__errno_location()),
                   dcgettext(((void *)0), "failed to set signal process mask",
...
static void list_signal_handling(void) {
  ...
  for (int i = 1; i <= ((64 + 1) - 1); i++) {
    ...
    char const *ignored =
        act.__sigaction_handler.sa_handler == ((__sighandler_t)1) ? "IGNORE"
                                                                  : "";
...
int main(int argc, char **argv) {
  ...
  while ((optc = getopt_long(argc, argv, shortopts, longopts, ((void *)0))) !=
         -1) {
    switch (optc) {
    case 'i':
    ...
    case '\r':
      ...
      error(0, 0, dcgettext(((void *)0), "invalid option -- '%c'", 5), optc);
      error(0, 0,
            dcgettext(((void *)0), "use -[v]S to pass options in shebang lines",
                      5));
      usage(EXIT_CANCELED);
    ...
    case GETOPT_VERSION_CHAR:
      version_etc(stdout, "env", "GNU coreutils", Version, ("Richard Mlynarik"),
                  ("David MacKenzie"), ("Assaf Gordon"), (char *)((void *)0));
      exit(0);
      break;
      ;
    default:
      ...
      *eq = '\0';
      ((!!sizeof(struct {
        _Static_assert(EXIT_CANCELED,
                       ...
                       ", "
                       "(error (EXIT_CANCELED, (*__errno_location ()), "
                       "dcgettext (((void *)0), \"cannot set %s\", 5), quote "
                       "(argv[optind])), assume (false))"
                       ")");
        int _gl_dummy;
      }))
           ? ((error(EXIT_CANCELED, (*__errno_location()),
                     dcgettext(((void *)0), "cannot set %s", 5),
                     quote(argv[optind])),
               ((0) ? (void)0 : __builtin_unreachable())))
           : ((error(EXIT_CANCELED, (*__errno_location()),
                     dcgettext(((void *)0), "cannot set %s", 5),
  ...
  if (opt_nul_terminate_output && program_specified) {
    error(0, 0,
          dcgettext(((void *)0), "cannot specify --null (-0) with command", 5));
    usage(EXIT_CANCELED);
  }

  if (newdir && !program_specified) {
    error(0, 0,
          dcgettext(((void *)0), "must specify command with --chdir (-C)", 5));
    usage(EXIT_CANCELED);
  }
    ...
    if (chdir(newdir) != 0)
      ((!!sizeof(struct {
        _Static_assert(
            ...
            ", "
            "(error (EXIT_CANCELED, (*__errno_location ()), dcgettext (((void "
            "*)0), \"cannot change directory to %s\", 5), quotearg_style "
            "(shell_escape_always_quoting_style, newdir)), assume (false))"
            ")");
        int _gl_dummy;
      }))
           ? ((error(EXIT_CANCELED, (*__errno_location()),
                     dcgettext(((void *)0), "cannot change directory to %s", 5),
                     quotearg_style(shell_escape_always_quoting_style, newdir)),
               ((0) ? (void)0 : __builtin_unreachable())))
           : ((error(EXIT_CANCELED, (*__errno_location()),
                     dcgettext(((void *)0), "cannot change directory to %s", 5),
  ...
  if (exit_status == EXIT_ENOENT && strpbrk(argv[optind], " \t\n\v\f\r"))
    error(0, 0,
          dcgettext(((void *)0), "use -[v]S to pass options in shebang lines",
                    5));
