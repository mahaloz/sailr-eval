...
static void users(char const *filename, int options) {
  size_t n_users;
  ...
  if (status != 0)
    ...
    printf(
        dcgettext(((void *)0),
                  ...
                  "FILE is not specified, use %s.  %s as FILE is common.\n\n",
                  5)
...
int main(int argc, char **argv) {
  ...
  parse_gnu_standard_options_only(
      argc, argv, "users", "GNU coreutils", Version, 1, usage,
      ("Joseph Arceneaux"), ("David MacKenzie"), (char const *)((void *)0));
