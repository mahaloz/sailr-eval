...
void usage(int status) {
  if (status != 0)
    ...
    printf(dcgettext(((void *)0), "Usage: %s [OPTION]...\n", 5), program_name);
    fputs_unlocked(
        dcgettext(
            ((void *)0),
...
static void file_name_prepend(struct file_name *p, char const *s,
                              size_t s_len) {
  ...
  if (dirp == ((void *)0))
    ((!!sizeof(struct {
      _Static_assert(1, "verify_expr ("
                        ...
                        "*)0), \"cannot open directory %s\", 5), quote "
                        "(nth_parent (parent_height))), assume (false))"
                        ")");
      int _gl_dummy;
    }))
         ? ((error(1, (*__errno_location()),
                   dcgettext(((void *)0), "cannot open directory %s", 5),
  ...
  if ((0 <= fd ? fchdir(fd) : chdir("..")) < 0)
    ((!!sizeof(struct {
      _Static_assert(1, "verify_expr ("
                        ...
                        ", "
                        "(error (1, (*__errno_location ()), dcgettext (((void "
                        "*)0), \"failed to chdir to %s\", 5), quote "
                        "(nth_parent (parent_height))), assume (false))"
                        ")");
      int _gl_dummy;
    }))
         ? ((error(1, (*__errno_location()),
                   dcgettext(((void *)0), "failed to chdir to %s", 5),
                   quote(nth_parent(parent_height))),
             ((0) ? (void)0 : __builtin_unreachable())))
         : ((error(1, (*__errno_location()),
                   dcgettext(((void *)0), "failed to chdir to %s", 5),
  ...
  if ((0 <= fd ? fstat(fd, &parent_sb) : stat(".", &parent_sb)) < 0)
    ((!!sizeof(struct {
      _Static_assert(1, "verify_expr ("
                        ...
                        ", "
                        "(error (1, (*__errno_location ()), dcgettext (((void "
                        "*)0), \"failed to stat %s\", 5), quote (nth_parent "
                        "(parent_height))), assume (false))"
                        ")");
      int _gl_dummy;
    }))
         ? ((error(1, (*__errno_location()),
  ...
  if (dirp == ((void *)0) || closedir(dirp) != 0) {
    ...
    ((!!sizeof(struct {
      _Static_assert(1, "verify_expr ("
                        ...
                        ", "
                        "(error (1, (*__errno_location ()), dcgettext (((void "
                        "*)0), \"reading directory %s\", 5), quote (nth_parent "
                        "(parent_height))), assume (false))"
                        ")");
      int _gl_dummy;
    }))
         ? ((error(1, (*__errno_location()),
                   dcgettext(((void *)0), "reading directory %s", 5),
                   quote(nth_parent(parent_height))),
             ((0) ? (void)0 : __builtin_unreachable())))
         : ((error(1, (*__errno_location()),
                   dcgettext(((void *)0), "reading directory %s", 5),
  ...
  if (!found)
    ((!!sizeof(struct {
      _Static_assert(1, "verify_expr ("
                        "1"
                        ", "
                        "(error (1, 0, dcgettext (((void *)0), \"couldn't find "
                        "directory entry in %s with matching i-node\", 5), "
                        "quote (nth_parent (parent_height))), assume (false))"
                        ")");
      int _gl_dummy;
    }))
         ? ((error(
...
static void robust_getcwd(struct file_name *file_name) {
  ...
  while (1) {
    ...
    if (((dot_sb).st_ino == (*root_dev_ino).st_ino &&
...
int main(int argc, char **argv) {
  ...
  if (optind < argc)
    error(0, 0, dcgettext(((void *)0), "ignoring non-option arguments", 5));
